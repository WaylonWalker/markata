---
content: "None\n\n\n!! class <h2 id='MarkataConfigError' class='admonition-title'
  style='margin:0;padding:.5rem 1rem;'>MarkataConfigError <em class='small'>class</em></h2>\n
  \   raise when markata is unable to configure correctly\n???+ source \"MarkataConfigError
  <em class='small'>source</em>\"\n\n```python\n\n        class MarkataConfigError(ValueError):\n
  \           \"\"\"\n            raise when markata is unable to configure correctly\n
  \           \"\"\"\n```\n\n\n!! class <h2 id='MissingFrontMatter' class='admonition-title'
  style='margin:0;padding:.5rem 1rem;'>MissingFrontMatter <em class='small'>class</em></h2>\n\n???+
  source \"MissingFrontMatter <em class='small'>source</em>\"\n\n```python\n\n        class
  MissingFrontMatter(NameError):\n            ...\n```\n"
date: 0001-01-01
...
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Errors.Py</title>\n<meta
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  property=\"twitter:description\"/><meta content=\"Errors.Py | Markata\" name=\"og:title\"
  property=\"og:title\"/><meta content=\"Errors.Py | Markata\" name=\"twitter:title\"
  property=\"twitter:title\"/><meta content=\"https://markata.dev//markata/errors-og.png\"
  name=\"og:image\" property=\"og:image\"/><meta content=\"https://markata.dev//markata/errors-og.png\"
  ...
  name=\"twitter:creator\" property=\"twitter:creator\"/><meta content=\"Errors.Py\"
  name=\"title\" property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\"
  property=\"generator\"/><link href=\"https://markata.dev//markata/errors/\" rel=\"canonical\"/><meta
  content=\"https://markata.dev//markata/errors/\" name=\"og:url\" property=\"og:url\"/></head>\n<body><nav>\n<a
  ...
  round\"></div>\n</label>\n</div>\n<section class=\"title\">\n<h1 id=\"title\">\n
  \           Errors.Py \n            \n        </h1>\n</section>\n<main><p>None</p>\n<p>!!
  class </p><h2 class=\"admonition-title\" id=\"MarkataConfigError\" style=\"margin:0;padding:.5rem
  1rem;\">MarkataConfigError <em class=\"small\">class</em></h2>\nraise when markata
  is unable to configure correctly\n<div class=\"admonition source is-collapsible
  collapsible-open\">\n<p class=\"admonition-title\">\"MarkataConfigError <em class=\"small\">source</em>\"</p>\n</div>\n<pre
  ...
  class=\"sd\">            raise when markata is unable to configure correctly</span>\n<span
  class=\"sd\">            \"\"\"</span>\n</pre></div>\n\n</pre>\n<p>!! class </p><h2
  class=\"admonition-title\" id=\"MissingFrontMatter\" style=\"margin:0;padding:.5rem
  1rem;\">MissingFrontMatter <em class=\"small\">class</em></h2>\n<div class=\"admonition
  source is-collapsible collapsible-open\">\n<p class=\"admonition-title\">\"MissingFrontMatter
  ...
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"></path></g></svg></button>\n</div>\n
  \       \n<div class=\"highlight\"><pre><span></span>        <span class=\"k\">class</span>
  <span class=\"nc\">MissingFrontMatter</span><span class=\"p\">(</span><span class=\"ne\">NameError</span><span
  class=\"p\">):</span>\n            <span class=\"o\">...</span>\n</pre></div>\n\n</pre>\n</main>\n<footer>\xA9
  2024</footer>\n</body></html>"
published: true
slug: markata/errors
...
!! class <h2 id='MarkataConfigError' class='admonition-title' style='margin:0;padding:.5rem 1rem;'>MarkataConfigError <em class='small'>class</em></h2>
    raise when markata is unable to configure correctly
...
!! class <h2 id='MissingFrontMatter' class='admonition-title' style='margin:0;padding:.5rem 1rem;'>MissingFrontMatter <em class='small'>class</em></h2>
