---
content: "---\n\nNone\n\n---\n\n!!! function\n    <h2 id=\"find_port\" class=\"admonition-title\"
  style=\"margin: 0; padding: .5rem 1rem;\">find_port <em class=\"small\">function</em></h2>\n\n
  \   Find a port not in ues starting at given port\n\n???+ source \"find_port <em
  class='small'>source</em>\"\n    ```python\n    def find_port(port: int = 8000)
  -> int:\n        \"\"\"Find a port not in ues starting at given port\"\"\"\n        import
  socket\n\n        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:\n
  \           if s.connect_ex((\"localhost\", port)) == 0:\n                return
  find_port(port=port + 1)\n            return port\n    ```\n!!! function\n    <h2
  id=\"serve\" class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">serve
  <em class=\"small\">function</em></h2>\n\n    Serve the site locally.\n\n???+ source
  \"serve <em class='small'>source</em>\"\n    ```python\n    def serve():\n            \"\"\"\n
  \           Serve the site locally.\n            \"\"\"\n            run_server()\n
  \   ```"
date: 2025-05-05
...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>server.py</title>\n<meta charset=\"UTF-8\"
    ...
    name=\"description\" content=\"None !!! function find_port  function ???+ source
    \"find_port  source \" ```python def find_port(port: int = 8000) -> int: \"\"\"Find
    a port not in ues starting at\u2026\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    type=\"image/png\" />\n\n<link rel=\"stylesheet\" href=\"/post.css\" />\n<link
    rel=\"stylesheet\" href=\"/app.css\" />\n<script src=\"/theme.js\"></script>\n\n\n
    \       <meta property=\"og:author_email\" content=\"waylon@waylonwalker.com\"
    />\n\n    <head>\n        <script src=\"https://unpkg.com/@tailwindcss/browser@4\"></script>\n<title>server.py</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"None !!! function find_port  function
    ???+ source \"find_port  source \" ```python def find_port(port: int = 8000) ->
    int: \"\"\"Find a port not in ues starting at\u2026\" />\n <link href=\"/favicon.ico\"
    ...
    id=\"find_port\" class=\"admonition-title\" style=\"margin: 0; padding: .5rem
    1rem;\">find_port <em class=\"small\">function</em></h2>\n<p>Find a port not in
    ues starting at given port</p>\n</div>\n<div class=\"admonition source is-collapsible
    collapsible-open\">\n<p class=\"admonition-title\">find_port <em class='small'>source</em></p>\n<pre
    ...
    class=\"w\"> </span><span class=\"nf\">find_port</span><span class=\"p\">(</span><span
    ...
    class=\"w\">    </span><span class=\"sd\">&quot;&quot;&quot;Find a port not in
    ...
    class=\"n\">AF_INET</span><span class=\"p\">,</span> <span class=\"n\">socket</span><span
    ...
    class=\"n\">connect_ex</span><span class=\"p\">((</span><span class=\"s2\">&quot;localhost&quot;</span><span
    class=\"p\">,</span> <span class=\"n\">port</span><span class=\"p\">))</span>
    <span class=\"o\">==</span> <span class=\"mi\">0</span><span class=\"p\">:</span>\n
    \           <span class=\"k\">return</span> <span class=\"n\">find_port</span><span
    class=\"p\">(</span><span class=\"n\">port</span><span class=\"o\">=</span><span
    class=\"n\">port</span> <span class=\"o\">+</span> <span class=\"mi\">1</span><span
    class=\"p\">)</span>\n        <span class=\"k\">return</span> <span class=\"n\">port</span>\n</pre></div>\n\n</pre>\n\n</div>\n<div
    class=\"admonition function\">\n<p class=\"admonition-title\">Function</p>\n<h2
    id=\"serve\" class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">serve
    <em class=\"small\">function</em></h2>\n<p>Serve the site locally.</p>\n</div>\n<div
    ...
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">def</span><span
    class=\"w\"> </span><span class=\"nf\">serve</span><span class=\"p\">():</span>\n<span
