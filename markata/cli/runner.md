...
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Runner.Py</title>\n<meta
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  content=\"Runner.Py | Markata\" name=\"og:title\" property=\"og:title\"/><meta content=\"Runner.Py
  | Markata\" name=\"twitter:title\" property=\"twitter:title\"/><meta content=\"https://markata.dev//markata/cli/runner-og.png\"
  name=\"og:image\" property=\"og:image\"/><meta content=\"https://markata.dev//markata/cli/runner-og.png\"
  ...
  name=\"twitter:creator\" property=\"twitter:creator\"/><meta content=\"Runner.Py\"
  name=\"title\" property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\"
  property=\"generator\"/><link href=\"https://markata.dev//markata/cli/runner/\"
  rel=\"canonical\"/><meta content=\"https://markata.dev//markata/cli/runner/\" name=\"og:url\"
  ...
  round\"></div>\n</label>\n</div>\n<section class=\"title\">\n<h1 id=\"title\">\n
  \           Runner.Py \n            \n        </h1>\n</section>\n<main><p>None</p>\n<p>!!
  class </p><h2 class=\"admonition-title\" id=\"Runner\" style=\"margin:0;padding:.5rem
  ...
  class=\"sd\">\"\"\"Display Footer\"\"\"</span>\n\n            <span class=\"n\">_status</span>
  <span class=\"o\">=</span> <span class=\"s2\">\"waiting\"</span>\n            <span
  class=\"n\">status</span> <span class=\"o\">=</span> <span class=\"s2\">\"starting\"</span>\n
  \           <span class=\"n\">last_error</span> <span class=\"o\">=</span> <span
  class=\"s2\">\"\"</span>\n            <span class=\"n\">title</span> <span class=\"o\">=</span>
  <span class=\"s2\">\"runner\"</span>\n            <span class=\"n\">border</span>
  <span class=\"o\">=</span> <span class=\"s2\">\"green\"</span>\n\n            <span
  class=\"n\">_dirhash</span> <span class=\"o\">=</span> <span class=\"s2\">\"\"</span>\n
  ...
  \               <span class=\"s2\">\"Runs the build only if one is not already running.\"</span>\n
  ...
  class=\"p\">)</span> <span class=\"o\">-&gt;</span> <span class=\"kc\">None</span><span
  class=\"p\">:</span>\n                <span class=\"s2\">\"Runs the build and sets
  the proc\"</span>\n                <span class=\"bp\">self</span><span class=\"o\">.</span><span
  ...
  class=\"p\">,</span>\n                    <span class=\"n\">stderr</span><span class=\"o\">=</span><span
  class=\"n\">subprocess</span><span class=\"o\">.</span><span class=\"n\">PIPE</span><span
  class=\"p\">,</span>\n                <span class=\"p\">)</span>\n\n            <span
  class=\"nd\">@property</span>\n            <span class=\"k\">def</span> <span class=\"nf\">status_message</span><span
  class=\"p\">(</span><span class=\"bp\">self</span><span class=\"p\">)</span> <span
  class=\"o\">-&gt;</span> <span class=\"nb\">str</span><span class=\"p\">:</span>\n
  \               <span class=\"s2\">\"returns the status message to display\"</span>\n
  \               <span class=\"n\">num_lines</span> <span class=\"o\">=</span> <span
  ...
  class=\"n\">height</span> <span class=\"o\">-</span> <span class=\"mi\">4</span>\n
  \               <span class=\"n\">last_error</span> <span class=\"o\">=</span> <span
  class=\"s2\">\"</span><span class=\"se\">\\n</span><span class=\"s2\">\"</span><span
  class=\"o\">.</span><span class=\"n\">join</span><span class=\"p\">(</span><span
  class=\"bp\">self</span><span class=\"o\">.</span><span class=\"n\">last_error</span><span
  class=\"o\">.</span><span class=\"n\">split</span><span class=\"p\">(</span><span
  class=\"s2\">\"</span><span class=\"se\">\\n</span><span class=\"s2\">\"</span><span
  class=\"p\">)[</span><span class=\"o\">-</span><span class=\"n\">num_lines</span><span
  class=\"p\">:])</span>\n                <span class=\"k\">if</span> <span class=\"bp\">self</span><span
  ...
  <span class=\"o\">=</span> <span class=\"s2\">\"runner running\"</span>\n                    <span
  ...
  class=\"o\">.</span><span class=\"n\">title</span> <span class=\"o\">=</span> <span
  class=\"s2\">\"runner failed\"</span>\n                    <span class=\"bp\">self</span><span
  class=\"o\">.</span><span class=\"n\">border</span> <span class=\"o\">=</span> <span
  class=\"s2\">\"red\"</span>\n                <span class=\"bp\">self</span><span
  class=\"o\">.</span><span class=\"n\">title</span> <span class=\"o\">=</span> <span
  ...
  class=\"w\"> </span><span class=\"o\">-</span><span class=\"w\"> </span><span class=\"bp\">self</span><span
  class=\"o\">.</span><span class=\"n\">time</span><span class=\"p\">)</span><span
  ...
  class=\"si\">{</span><span class=\"n\">last_error</span><span class=\"si\">}</span><span
  class=\"s2\">\"</span>\n                <span class=\"p\">)</span>\n\n            <span
  ...
  <span class=\"bp\">self</span><span class=\"o\">.</span><span class=\"n\">proc</span><span
  class=\"p\">:</span>\n                        <span class=\"bp\">self</span><span
  class=\"o\">.</span><span class=\"n\">last_error</span> <span class=\"o\">=</span>
  <span class=\"bp\">self</span><span class=\"o\">.</span><span class=\"n\">proc</span><span
  ...
  <span class=\"bp\">self</span><span class=\"o\">.</span><span class=\"n\">m</span><span
  class=\"o\">.</span><span class=\"n\">content_dir_hash</span>\n                <span
  class=\"bp\">self</span><span class=\"o\">.</span><span class=\"n\">_run</span><span
  class=\"p\">()</span>\n                <span class=\"n\">atexit</span><span class=\"o\">.</span><span
  class=\"n\">register</span><span class=\"p\">(</span><span class=\"bp\">self</span><span
  class=\"o\">.</span><span class=\"n\">kill</span><span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n<p>!!
  method </p><h2 class=\"admonition-title\" id=\"kill\" style=\"margin:0;padding:.5rem
  1rem;\">kill <em class=\"small\">method</em></h2>\n<div class=\"admonition source
  ...
  method </p><h2 class=\"admonition-title\" id=\"run\" style=\"margin:0;padding:.5rem
  1rem;\">run <em class=\"small\">method</em></h2>\nRuns the build only if one is
  not already running.\n<div class=\"admonition source is-collapsible collapsible-open\">\n<p
  class=\"admonition-title\">\"run <em class=\"small\">source</em>\"</p>\n</div>\n<pre
  class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
  xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  ...
  class=\"p\">:</span>\n                    <span class=\"bp\">self</span><span class=\"o\">.</span><span
  class=\"n\">_run</span><span class=\"p\">()</span>\n</pre></div>\n\n</pre>\n<p>!!
  method </p><h2 class=\"admonition-title\" id=\"_run\" style=\"margin:0;padding:.5rem
  1rem;\">_run <em class=\"small\">method</em></h2>\nRuns the build and sets the proc\n<div
  ...
  class=\"n\">subprocess</span><span class=\"o\">.</span><span class=\"n\">PIPE</span><span
  class=\"p\">,</span>\n                <span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n<p>!!
  method </p><h2 class=\"admonition-title\" id=\"status_message\" style=\"margin:0;padding:.5rem
  ...
  class=\"p\">:</span>\n                <span class=\"s2\">\"returns the status message
  to display\"</span>\n                <span class=\"n\">num_lines</span> <span class=\"o\">=</span>
  <span class=\"bp\">self</span><span class=\"o\">.</span><span class=\"n\">m</span><span
  class=\"o\">.</span><span class=\"n\">console</span><span class=\"o\">.</span><span
  class=\"n\">height</span> <span class=\"o\">-</span> <span class=\"mi\">4</span>\n
  \               <span class=\"n\">last_error</span> <span class=\"o\">=</span> <span
  ...
  class=\"n\">Text</span><span class=\"p\">(</span><span class=\"bp\">self</span><span
  class=\"o\">.</span><span class=\"n\">status_message</span><span class=\"p\">),</span>\n
  \                           <span class=\"n\">border_style</span><span class=\"o\">=</span><span
  class=\"bp\">self</span><span class=\"o\">.</span><span class=\"n\">border</span><span
  class=\"p\">,</span>\n                            <span class=\"n\">title</span><span
  class=\"o\">=</span><span class=\"bp\">self</span><span class=\"o\">.</span><span
  class=\"n\">title</span><span class=\"p\">,</span>\n                            <span
  ...
  class=\"o\">=</span><span class=\"kc\">True</span><span class=\"p\">,</span>\n                <span
  class=\"p\">)</span>\n</pre></div>\n\n</pre>\n<p>!! function </p><h2 class=\"admonition-title\"
  id=\"get_runner\" style=\"margin:0;padding:.5rem 1rem;\">get_runner <em class=\"small\">function</em></h2>\n<div
