...
content: "---\n\nThe LifeCycle is a core component for the internal workings of Markata.
  ...
  \   <h2 id=\"LifeCycle\" class=\"admonition-title\" style=\"margin: 0; padding:
  .5rem 1rem;\">LifeCycle <em class=\"small\">class</em></h2>\n\n    LifeCycle currently
  supports the following steps.\n\n    * config_model - load configuration models
  ...
  - load configuration models from plugins\n        * post_model - load post models
  from plugins\n        * create_models - merge models from all plugins into markata.Post
  ...
  self.value == other\n            return NotImplemented\n    ```\n\n\n\n!!! method\n
  \   <h2 id=\"__lt__\" class=\"admonition-title\" style=\"margin: 0; padding: .5rem
...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>lifecycle.py</title>\n<meta
    ...
    the internal workings of Markata.  It\nsets fourth the hooks available, the methods
    to run them on the Markata\ninstance, an\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>lifecycle.py</title>\n<meta charset=\"UTF-8\"
    ...
    workings of Markata.  It\nsets fourth the hooks available, the methods to run
    them on the Markata\ninstance, an\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    type=\"image/png\" />\n\n<link rel=\"stylesheet\" href=\"/post.css\" />\n<link
    rel=\"stylesheet\" href=\"/app.css\" />\n<script src=\"/theme.js\"></script>\n\n\n
    \       <meta property=\"og:author_email\" content=\"waylon@waylonwalker.com\"
