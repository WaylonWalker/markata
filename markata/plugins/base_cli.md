...
content: "---\n\nThe `markata.plugins.base_cli` plugin provides Markata's core command-line
  ...
  \"post.date\"        Sort posts by attribute\n--reverse                 Reverse
  ...
  \   ```\n!!! function\n    <h2 id=\"pdb_run\" class=\"admonition-title\" style=\"margin:
  0; padding: .5rem 1rem;\">pdb_run <em class=\"small\">function</em></h2>\n\n    Wraps
  a function call with a post_mortem pdb debugger.\n\n???+ source \"pdb_run <em class='small'>source</em>\"\n
  \   ```python\n    def pdb_run(func: Callable) -> None:\n        \"\"\"\n        Wraps
  a function call with a post_mortem pdb debugger.\n        \"\"\"\n        try:\n
  \           func()\n        except Exception:\n            extype, value, tb = sys.exc_info()\n
  \           traceback.print_exc()\n            pdb.post_mortem(tb)\n    ```\n!!!
  function\n    <h2 id=\"plugins\" class=\"admonition-title\" style=\"margin: 0; padding:
  .5rem 1rem;\">plugins <em class=\"small\">function</em></h2>\n\n    create new things
  from templates\n\n???+ source \"plugins <em class='small'>source</em>\"\n    ```python\n
  \   def plugins():\n            \"create new things from templates\"\n    ```\n!!!
  function\n    <h2 id=\"config\" class=\"admonition-title\" style=\"margin: 0; padding:
  .5rem 1rem;\">config <em class=\"small\">function</em></h2>\n\n    configuration
  management\n\n???+ source \"config <em class='small'>source</em>\"\n    ```python\n
  \   def config():\n            \"configuration management\"\n    ```\n!!! function\n
  \   <h2 id=\"new\" class=\"admonition-title\" style=\"margin: 0; padding: .5rem
  1rem;\">new <em class=\"small\">function</em></h2>\n\n    create new things from
  templates\n\n???+ source \"new <em class='small'>source</em>\"\n    ```python\n
  \   def new():\n            \"create new things from templates\"\n    ```\n!!! function\n
  \   <h2 id=\"blog\" class=\"admonition-title\" style=\"margin: 0; padding: .5rem
  ...
  \               \"git+https://github.com/WaylonWalker/markata-post-template\",\n
  \           )\n            run_copy(url, Path(\".\"))\n    ```\n!!! function\n    <h2
  id=\"plugin\" class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">plugin
  <em class=\"small\">function</em></h2>\n\n    Create a new plugin using the template
  at\n    https://github.com/WaylonWalker/markata-plugin-template.\n\n???+ source
  \"plugin <em class='small'>source</em>\"\n    ```python\n    def plugin() -> None:\n
  ...
  \               \"git+https://github.com/WaylonWalker/markata-plugin-template\",\n
  \           )\n            run_copy(url, Path(\".\"))\n    ```\n!!! function\n    <h2
  id=\"build\" class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">build
  <em class=\"small\">function</em></h2>\n\n    Markata's primary way of building
  your site for production.\n    By default, running `markta build` will render your
  markdown to\n    the `./markout` directory.\n\n    ``` bash\n    markata build\n
...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>base_cli.py</title>\n<meta charset=\"UTF-8\"
    ...
    name=\"description\" content=\"The   plugin provides Markata's core command-line
    interface functionality, including essential commands like  ,  , and  . Installation
    ...
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"The   plugin provides Markata's core
    command-line interface functionality, including essential commands like  ,  ,
    and  . Installation This plugin is built-in\u2026\" />\n <link href=\"/favicon.ico\"
