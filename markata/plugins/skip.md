...
content: "---\n\nPost Skipping and Caching Plugin\n\n---\n\n!!! function\n    <h2
  ...
  \"load <em class='small'>source</em>\"\n    ```python\n    def load(markata: \"Markata\")
  -> None:\n        \"\"\"Runs after posts are loaded to check if they should be skipped.\"\"\"\n
  \       raw_should_skip = os.environ.get(\"MARKATA_SKIP\", \"true\")\n        should_skip
  = raw_should_skip.lower() in [\"true\", \"1\", \"t\", \"y\", \"yes\", \"on\"]\n
  \       if not should_skip:\n            return\n        for post in markata.posts:\n
  \           if hasattr(post, \"raw\"):\n                key = markata.make_hash(\"skip\",
  ...
  for processed posts.\"\"\"\n        # for post in markata.posts:\n        raw_should_skip
  = os.environ.get(\"MARKATA_SKIP\", \"true\")\n        should_skip = raw_should_skip.lower()
...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>skip.py</title>\n<meta charset=\"UTF-8\"
    ...
    name=\"description\" content=\"Post Skipping and Caching Plugin !!! function post_model
    \ function ???+ source \"post_model  source \" !!! function load  function ???+
    ...
    function post_model  function ???+ source \"post_model  source \" !!! function
    load  function ???+ source \"load  source \"\u2026\" />\n <link href=\"/favicon.ico\"
    ...
    \   <span class=\"n\">raw_should_skip</span> <span class=\"o\">=</span> <span
    class=\"n\">os</span><span class=\"o\">.</span><span class=\"n\">environ</span><span
    class=\"o\">.</span><span class=\"n\">get</span><span class=\"p\">(</span><span
    class=\"s2\">&quot;MARKATA_SKIP&quot;</span><span class=\"p\">,</span> <span class=\"s2\">&quot;true&quot;</span><span
    class=\"p\">)</span>\n    <span class=\"n\">should_skip</span> <span class=\"o\">=</span>
    <span class=\"n\">raw_should_skip</span><span class=\"o\">.</span><span class=\"n\">lower</span><span
    class=\"p\">()</span> <span class=\"ow\">in</span> <span class=\"p\">[</span><span
    class=\"s2\">&quot;true&quot;</span><span class=\"p\">,</span> <span class=\"s2\">&quot;1&quot;</span><span
    class=\"p\">,</span> <span class=\"s2\">&quot;t&quot;</span><span class=\"p\">,</span>
    <span class=\"s2\">&quot;y&quot;</span><span class=\"p\">,</span> <span class=\"s2\">&quot;yes&quot;</span><span
    class=\"p\">,</span> <span class=\"s2\">&quot;on&quot;</span><span class=\"p\">]</span>\n
    \   <span class=\"k\">if</span> <span class=\"ow\">not</span> <span class=\"n\">should_skip</span><span
    ...
    class=\"p\">(</span><span class=\"s2\">&quot;skip&quot;</span><span class=\"p\">,</span>
    <span class=\"n\">post</span><span class=\"o\">.</span><span class=\"n\">raw</span><span
    ...
    class=\"n\">skip</span> <span class=\"o\">=</span> <span class=\"kc\">True</span>\n
    \   <span class=\"n\">console</span><span class=\"o\">.</span><span class=\"n\">log</span><span
    ...
    class=\"p\">(</span><span class=\"s1\">&#39;skip&#39;</span><span class=\"p\">))</span><span
    ...
    class=\"si\">}</span><span class=\"s2\"> posts skipped&quot;</span><span class=\"p\">)</span>\n
    \   <span class=\"n\">console</span><span class=\"o\">.</span><span class=\"n\">log</span><span
    ...
    class=\"p\">(</span><span class=\"s2\">&quot;MARKATA_SKIP&quot;</span><span class=\"p\">,</span>
    <span class=\"s2\">&quot;true&quot;</span><span class=\"p\">)</span>\n    <span
    class=\"n\">should_skip</span> <span class=\"o\">=</span> <span class=\"n\">raw_should_skip</span><span
    class=\"o\">.</span><span class=\"n\">lower</span><span class=\"p\">()</span>
    <span class=\"ow\">in</span> <span class=\"p\">[</span><span class=\"s2\">&quot;true&quot;</span><span
    class=\"p\">,</span> <span class=\"s2\">&quot;1&quot;</span><span class=\"p\">,</span>
    <span class=\"s2\">&quot;t&quot;</span><span class=\"p\">,</span> <span class=\"s2\">&quot;y&quot;</span><span
    class=\"p\">,</span> <span class=\"s2\">&quot;yes&quot;</span><span class=\"p\">,</span>
    <span class=\"s2\">&quot;on&quot;</span><span class=\"p\">]</span>\n    <span
    class=\"k\">if</span> <span class=\"ow\">not</span> <span class=\"n\">should_skip</span><span
    class=\"p\">:</span>\n        <span class=\"k\">return</span>\n    <span class=\"k\">for</span>
    <span class=\"n\">post</span> <span class=\"ow\">in</span> <span class=\"n\">markata</span><span
