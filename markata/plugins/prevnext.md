---
content: "---\n\nThe `markata.plugins.prevnext` plugin adds previous and next navigation
  links to each\npost, allowing readers to easily navigate between related content.\n\n##
  Installation\n\nThis plugin is built-in and enabled by default through the 'default'
  ...
  modes:\n- `first`: Use first map containing the post\n- `all`: Use all maps containing
  the post\n\n## Template Integration\n\nAdds to each post:\n- Previous post link\n-
  Next post link\n- Navigation styling\n- Responsive design\n\n## Styling\n\nCustomizable
  colors:\n- Text colors\n- Arrow colors\n- Light/dark mode support\n- Hover effects\n\n##
  Dependencies\n\nThis plugin depends on:\n- jinja2 for templating\n- pydantic for
  configuration\n\n---\n\n!!! class\n    <h2 id=\"UnsupportedPrevNextStrategy\" class=\"admonition-title\"
  ...
  custom error class to raise when an unsupporte prevnext strategy is\n        defined.\n
  \       \"\"\"\n    ```"
date: 2025-05-05
...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>prevnext.py</title>\n<meta charset=\"UTF-8\"
    ...
    name=\"description\" content=\"The   plugin adds previous and next navigation
    links to each post, allowing readers to easily navigate between related content.
    ...
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"The   plugin adds previous and next navigation
    links to each post, allowing readers to easily navigate between related content.
    Installation This plugin is\u2026\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    type=\"image/png\" />\n\n<link rel=\"stylesheet\" href=\"/post.css\" />\n<link
    rel=\"stylesheet\" href=\"/app.css\" />\n<script src=\"/theme.js\"></script>\n\n\n
    ...
    class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n        prevnext.py\n
    \   </h1>\n</section>    <section class=\"body\">\n        <hr />\n<p>The <code>markata.plugins.prevnext</code>
    plugin adds previous and next navigation links to each\npost, allowing readers
    to easily navigate between related content.</p>\n<h2 id=\"installation\">Installation
    ...
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;markata.plugins.prevnext&quot;</span><span
    class=\"p\">,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<h2
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Configure navigation
    behavior in <code>markata.toml</code>:</p>\n<pre class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button
    class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
    x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
    0 0 115.77 122.88\" xml:space=\"preserve\"><style type=\"text/css\">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path
    ...
    c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">[markata.prevnext]</span>\n<span
    class=\"c1\"># Strategy for finding prev/next posts</span>\n<span class=\"c1\">#
    &#39;first&#39;: Use first map where post is found</span>\n<span class=\"c1\">#
    &#39;all&#39;: Use all maps</span>\n<span class=\"n\">strategy</span><span class=\"w\">
    </span><span class=\"o\">=</span><span class=\"w\"> </span><span class=\"s1\">&#39;first&#39;</span>\n\n<span
    class=\"c1\"># Custom colors (optional)</span>\n<span class=\"n\">prevnext_color_text</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    ...
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;black&quot;</span>\n\n<span class=\"c1\"># Navigation maps</span>\n<span
    class=\"k\">[[markata.prevnext.maps]]</span>\n<span class=\"c1\"># Map posts by
    category</span>\n<span class=\"n\">category</span><span class=\"w\"> </span><span
    class=\"o\">=</span><span class=\"w\"> </span><span class=\"s2\">&quot;tutorials&quot;</span>\n<span
    class=\"n\">filter</span><span class=\"w\"> </span><span class=\"o\">=</span><span
    class=\"w\"> </span><span class=\"s2\">&quot;post.category == &#39;tutorials&#39;&quot;</span>\n<span
    class=\"n\">sort</span><span class=\"w\"> </span><span class=\"o\">=</span><span
    class=\"w\"> </span><span class=\"s2\">&quot;post.date&quot;</span>\n<span class=\"n\">reverse</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"kc\">true</span>\n\n<span class=\"k\">[[markata.prevnext.maps]]</span>\n<span
    class=\"c1\"># Map posts by series</span>\n<span class=\"n\">category</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;python-series&quot;</span>\n<span class=\"n\">filter</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;post.series == &#39;python&#39;&quot;</span>\n<span class=\"n\">sort</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;post.part&quot;</span>\n<span class=\"n\">reverse</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<h2 id=\"navigation-maps\">Navigation
    Maps <a class=\"header-anchor\" href=\"#navigation-maps\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>The plugin allows you
    to:</p>\n<ol>\n<li>Define multiple navigation maps</li>\n<li>Filter posts by attributes</li>\n<li>Sort
    posts by any field</li>\n<li>Control sort direction</li>\n<li>Group related content</li>\n</ol>\n<h2
    id=\"navigation-strategies\">Navigation Strategies <a class=\"header-anchor\"
    href=\"#navigation-strategies\"><svg class=\"heading-permalink\" aria-hidden=\"true\"
    ...
    Use first map containing the post</li>\n<li><code>all</code>: Use all maps containing
    the post</li>\n</ul>\n<h2 id=\"template-integration\">Template Integration <a
    class=\"header-anchor\" href=\"#template-integration\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Adds to each post:</p>\n<ul>\n<li>Previous
    post link</li>\n<li>Next post link</li>\n<li>Navigation styling</li>\n<li>Responsive
    design</li>\n</ul>\n<h2 id=\"styling\">Styling <a class=\"header-anchor\" href=\"#styling\"><svg
    class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
    height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    id=\"UnsupportedPrevNextStrategy\" class=\"admonition-title\" style=\"margin:
    0; padding: .5rem 1rem;\">UnsupportedPrevNextStrategy <em class=\"small\">class</em></h2>\n<p>A
    custom error class to raise when an unsupporte prevnext strategy is\ndefined.</p>\n</div>\n<div
    ...
    class=\"w\"> </span><span class=\"nc\">UnsupportedPrevNextStrategy</span><span
    class=\"p\">(</span><span class=\"ne\">NotImplementedError</span><span class=\"p\">):</span>\n<span
    class=\"w\">    </span><span class=\"sd\">&quot;&quot;&quot;</span>\n<span class=\"sd\">
    \   A custom error class to raise when an unsupporte prevnext strategy is</span>\n<span
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    \       prevnext.py\n    </h1>\n</section>    <section class=\"body\">\n        <hr
    />\n<p>The <code>markata.plugins.prevnext</code> plugin adds previous and next
    navigation links to each\npost, allowing readers to easily navigate between related
