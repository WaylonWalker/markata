---
content: "---\n\nThe `markata.plugins.jinja_md` plugin enables Jinja2 templating within
  your markdown\ncontent. This allows you to dynamically generate content using Python
  ...
  reporting with file and line info\n\n## Dependencies\n\nThis plugin depends on:\n-
  Jinja2 for template processing\n- The `render_markdown` plugin for final HTML rendering\n\n---\n\n\n\n!!!
  function\n    <h2 id=\"register_jinja_extensions\" class=\"admonition-title\" style=\"margin:
  0; padding: .5rem 1rem;\">register_jinja_extensions <em class=\"small\">function</em></h2>\n\n
  ...
  \       ]\n    ```\n\n\n\n\n\n!!! class\n    <h2 id=\"_SilentUndefined\" class=\"admonition-title\"
  style=\"margin: 0; padding: .5rem 1rem;\">_SilentUndefined <em class=\"small\">class</em></h2>\n\n
  ...
  = '{{ variable }}'\n        post.content = Template( template, undefined=_SilentUndefined).render()\n
  \       ```\n        \"\"\"\n\n        def _fail_with_undefined_error(self, *args,
  **kwargs):\n            return \"\"\n    ```\n\n\n\n!!! class\n    <h2 id=\"PostTemplateSyntaxError\"
  class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">PostTemplateSyntaxError
  <em class=\"small\">class</em></h2>\n\n    Custom error message for post template
  ...
  *register_jinja_extensions(config)],\n        # )\n        jinja_env = markata.config.jinja_env\n
  ...
  \               try:\n                    key = markata.make_hash(\"jina_md\", \"pre_render\",
  ...
  UndefinedError(f\"{e} in {post['path']}\")\n    ```"
date: 2025-02-14
description: 'The `markata.plugins.jinja_md` plugin enables Jinja2 templating within
  your markdown

  content. This allows you to dynamically generate content using Python expre'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>jinja_md.py</title>\n<meta charset=\"UTF-8\"
    />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n<meta
    name=\"description\" content=\"The `markata.plugins.jinja_md` plugin enables Jinja2
    templating within your markdown\ncontent. This allows you to dynamically generate
    content using Python expre\" />\n <link href=\"/favicon.ico\" rel=\"icon\" type=\"image/png\"
    />\n\n<link rel=\"stylesheet\" href=\"/post.css\" />\n<link rel=\"stylesheet\"
    href=\"/app.css\" />\n<script src=\"/theme.js\"></script>\n\n\n        <meta property=\"og:author_email\"
    content=\"waylon@waylonwalker.com\" />\n\n    <head>\n        <script src=\"https://unpkg.com/@tailwindcss/browser@4\"></script>\n<title>jinja_md.py</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"The `markata.plugins.jinja_md` plugin
    enables Jinja2 templating within your markdown\ncontent. This allows you to dynamically
    generate content using Python expre\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    type=\"image/png\" />\n\n<link rel=\"stylesheet\" href=\"/post.css\" />\n<link
    ...
    class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n        jinja_md.py\n
    \   </h1>\n</section>    <section class=\"body\">\n        <hr />\n<p>The <code>markata.plugins.jinja_md</code>
    plugin enables Jinja2 templating within your markdown\ncontent. This allows you
    to dynamically generate content using Python expressions and\naccess to the full
    ...
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;markata.plugins.jinja_md&quot;</span><span
    class=\"p\">,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<h1
    ...
    class=\"c1\"># List of files to ignore for Jinja processing</span>\n<span class=\"n\">ignore</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;README.md&quot;</span><span
    class=\"p\">,</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;CHANGELOG.md&quot;</span>\n<span
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h1>\n<h2 id=\"template-variables\">Template
    Variables <a class=\"header-anchor\" href=\"#template-variables\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Your markdown has access
    to:</p>\n<ul>\n<li><code>post</code>: The current post being rendered</li>\n<li><code>markata</code>:
    The Markata instance with all configuration and posts</li>\n</ul>\n<h2 id=\"example-usage\">Example
    Usage <a class=\"header-anchor\" href=\"#example-usage\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span>{# One-liner list of all
    posts #}\n{{ &#39;\\n&#39;.join(markata.map(&#39;f&quot;* [<span class=\"nt\">{title}</span>](<span
    class=\"na\">{slug}</span>)&quot;&#39;, sort=&#39;slug&#39;)) }}\n\n{# For-loop
    with filtering #}\n{% for post in markata.map(&#39;post&#39;, filter=&#39;&quot;git&quot;
    in tags&#39;) %}\n<span class=\"k\">*</span><span class=\"w\"> </span>[<span class=\"nt\">{{
    post.title }}</span>](<span class=\"na\">{{ post.slug }}</span>)\n{% endfor %}\n</pre></div>\n\n</pre>\n\n<h3>Include
    Raw Files</h3>\n<pre class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button
    class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
    x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
    ...
    c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span>{# Include file contents
    without processing #}\n{% include_raw &#39;code/example.py&#39; %}\n</pre></div>\n\n</pre>\n\n<h2
    id=\"jinja-extensions\">Jinja Extensions <a class=\"header-anchor\" href=\"#jinja-extensions\"><svg
    class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
    height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    extensions via entrypoints</li>\n<li>Built-in extensions like include_raw</li>\n<li>Silent
    undefined variables</li>\n<li>Custom error messages</li>\n</ol>\n<h2 id=\"error-handling\">Error
    ...
    error messages for template syntax errors</li>\n<li>Silent handling of undefined
    variables</li>\n<li>Detailed error reporting with file and line info</li>\n</ul>\n<h2
    ...
    on:</p>\n<ul>\n<li>Jinja2 for template processing</li>\n<li>The <code>render_markdown</code>
    plugin for final HTML rendering</li>\n</ul>\n<hr />\n<div class=\"admonition function\">\n<p
    class=\"admonition-title\">Function</p>\n<h2 id=\"register_jinja_extensions\"
    class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">register_jinja_extensions
    <em class=\"small\">function</em></h2>\n<p>Gets jinja extensions from entrypoints
    and loads them in.</p>\n<p>Returns: List of jinja Extensions</p>\n</div>\n<div
    class=\"admonition source is-collapsible collapsible-open\">\n<p class=\"admonition-title\">register_jinja_extensions
    ...
    class=\"w\"> </span><span class=\"nf\">register_jinja_extensions</span><span class=\"p\">(</span><span
    ...
    </span><span class=\"nn\">pkg_resources</span>\n\n    <span class=\"k\">return</span>
    <span class=\"p\">[</span>\n        <span class=\"n\">ep</span><span class=\"o\">.</span><span
    class=\"n\">load</span><span class=\"p\">()</span> <span class=\"k\">for</span>
    <span class=\"n\">ep</span> <span class=\"ow\">in</span> <span class=\"n\">pkg_resources</span><span
    class=\"o\">.</span><span class=\"n\">iter_entry_points</span><span class=\"p\">(</span><span
    class=\"n\">group</span><span class=\"o\">=</span><span class=\"s2\">&quot;markata.jinja_md&quot;</span><span
    class=\"p\">)</span>\n    <span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n</div>\n<div
    ...
    <em class=\"small\">class</em></h2>\n<p>silence undefined variable errors in jinja
    templates.</p>\n<h1 id=\"example\">Example <a class=\"header-anchor\" href=\"#example\"><svg
    class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
    height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"n\">template</span>
    <span class=\"o\">=</span> <span class=\"s1\">&#39;{{ variable }}&#39;</span>\n<span
    ...
    <span class=\"n\">template</span><span class=\"p\">,</span> <span class=\"n\">undefined</span><span
    class=\"o\">=</span><span class=\"n\">_SilentUndefined</span><span class=\"p\">)</span><span
    ...
    class=\"n\">Undefined</span><span class=\"p\">):</span>\n<span class=\"w\">    </span><span
    class=\"sd\">&quot;&quot;&quot;</span>\n<span class=\"sd\">    silence undefined
    variable errors in jinja templates.</span>\n\n<span class=\"sd\">    # Example</span>\n<span
    class=\"sd\">    ```python</span>\n<span class=\"sd\">    template = &#39;{{ variable
    }}&#39;</span>\n<span class=\"sd\">    post.content = Template( template, undefined=_SilentUndefined).render()</span>\n<span
    class=\"sd\">    ```</span>\n<span class=\"sd\">    &quot;&quot;&quot;</span>\n\n
    ...
    class=\"admonition class\">\n<p class=\"admonition-title\">Class</p>\n<h2 id=\"PostTemplateSyntaxError\"
    class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">PostTemplateSyntaxError
    <em class=\"small\">class</em></h2>\n<p>Custom error message for post template
    syntax errors.</p>\n</div>\n<div class=\"admonition source is-collapsible collapsible-open\">\n<p
    class=\"admonition-title\">PostTemplateSyntaxError <em class='small'>source</em></p>\n<pre
    class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button class='copy' title='copy
    code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
    x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
    ...
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">class</span><span
    class=\"w\"> </span><span class=\"nc\">PostTemplateSyntaxError</span><span class=\"p\">(</span><span
    ...
    markata to render your markdown post as a jinja template.</p>\n<p>The post itself
    is exposed as <code>post</code>, and the markata instance is exposed\nas <code>markata</code>.</p>\n</div>\n<div
    ...
    class=\"sd\">    jinja_md hook for markata to render your markdown post as a jinja
    template.</span>\n\n<span class=\"sd\">    The post itself is exposed as `post`,
    and the markata instance is exposed</span>\n<span class=\"sd\">    as `markata`.</span>\n<span
    class=\"sd\">    &quot;&quot;&quot;</span>\n\n    <span class=\"n\">config</span>
    <span class=\"o\">=</span> <span class=\"n\">markata</span><span class=\"o\">.</span><span
    class=\"n\">config</span><span class=\"o\">.</span><span class=\"n\">jinja_md</span>\n
    \   <span class=\"n\">ignore_spec</span> <span class=\"o\">=</span> <span class=\"n\">pathspec</span><span
    class=\"o\">.</span><span class=\"n\">PathSpec</span><span class=\"o\">.</span><span
    class=\"n\">from_lines</span><span class=\"p\">(</span><span class=\"s2\">&quot;gitwildmatch&quot;</span><span
    class=\"p\">,</span> <span class=\"n\">config</span><span class=\"o\">.</span><span
    class=\"n\">ignore</span><span class=\"p\">)</span>\n    <span class=\"c1\">#
    for post in markata.iter_articles(description=&quot;jinja_md&quot;):</span>\n\n
    \   <span class=\"c1\"># jinja_env = jinja2.Environment(</span>\n    <span class=\"c1\">#
    \    extensions=[IncludeRawExtension, *register_jinja_extensions(config)],</span>\n
    \   <span class=\"c1\"># )</span>\n    <span class=\"n\">jinja_env</span> <span
    class=\"o\">=</span> <span class=\"n\">markata</span><span class=\"o\">.</span><span
    class=\"n\">config</span><span class=\"o\">.</span><span class=\"n\">jinja_env</span>\n
    \   <span class=\"n\">jinja_env</span><span class=\"o\">.</span><span class=\"n\">undefined</span>
    <span class=\"o\">=</span> <span class=\"n\">_SilentUndefined</span>\n\n    <span
    ...
    class=\"p\">(</span><span class=\"s2\">&quot;jinja==True&quot;</span><span class=\"p\">):</span>\n
    \       <span class=\"k\">if</span> <span class=\"n\">post</span><span class=\"o\">.</span><span
    class=\"n\">get</span><span class=\"p\">(</span><span class=\"s2\">&quot;jinja&quot;</span><span
    class=\"p\">,</span> <span class=\"kc\">True</span><span class=\"p\">)</span>
    <span class=\"ow\">and</span> <span class=\"ow\">not</span> <span class=\"n\">ignore_spec</span><span
    class=\"o\">.</span><span class=\"n\">match_file</span><span class=\"p\">(</span><span
    class=\"n\">post</span><span class=\"p\">[</span><span class=\"s2\">&quot;path&quot;</span><span
    ...
    class=\"p\">(</span><span class=\"s2\">&quot;jina_md&quot;</span><span class=\"p\">,</span>
    <span class=\"s2\">&quot;pre_render&quot;</span><span class=\"p\">,</span> <span
    class=\"n\">post</span><span class=\"o\">.</span><span class=\"n\">content</span><span
    ...
    <span class=\"kc\">None</span> <span class=\"ow\">and</span> <span class=\"n\">post</span><span
    class=\"o\">.</span><span class=\"n\">content</span> <span class=\"ow\">is</span>
    <span class=\"ow\">not</span> <span class=\"kc\">None</span><span class=\"p\">:</span>\n
    \                   <span class=\"n\">post</span><span class=\"o\">.</span><span
    class=\"n\">content</span> <span class=\"o\">=</span> <span class=\"n\">jinja_env</span><span
    ...
    class=\"n\">body</span><span class=\"o\">=</span><span class=\"n\">post</span><span
    class=\"o\">.</span><span class=\"n\">article_html</span><span class=\"p\">,</span>\n
    ...
    class=\"p\">:</span>\n                    <span class=\"n\">post</span><span class=\"o\">.</span><span
    class=\"n\">content</span> <span class=\"o\">=</span> <span class=\"n\">content_from_cache</span>\n
    \               <span class=\"c1\"># prevent double rendering</span>\n                <span
    class=\"n\">post</span><span class=\"o\">.</span><span class=\"n\">jinja</span>
    <span class=\"o\">=</span> <span class=\"kc\">False</span>\n            <span
    class=\"k\">except</span> <span class=\"n\">TemplateSyntaxError</span> <span class=\"k\">as</span>
    ...
    class=\"o\">.</span><span class=\"n\">lineno</span> <span class=\"o\">-</span>
    ...
    class=\"s2\">                &quot;&quot;&quot;</span>\n\n                <span
    class=\"k\">raise</span> <span class=\"n\">PostTemplateSyntaxError</span><span
    class=\"p\">(</span><span class=\"n\">msg</span><span class=\"p\">,</span> <span
    class=\"n\">lineno</span><span class=\"o\">=</span><span class=\"n\">e</span><span
    class=\"o\">.</span><span class=\"n\">lineno</span><span class=\"p\">)</span>\n
    \           <span class=\"k\">except</span> <span class=\"n\">UndefinedError</span>
    <span class=\"k\">as</span> <span class=\"n\">e</span><span class=\"p\">:</span>\n
    \               <span class=\"k\">raise</span> <span class=\"n\">UndefinedError</span><span
    class=\"p\">(</span><span class=\"sa\">f</span><span class=\"s2\">&quot;</span><span
    class=\"si\">{</span><span class=\"n\">e</span><span class=\"si\">}</span><span
    class=\"s2\"> in </span><span class=\"si\">{</span><span class=\"n\">post</span><span
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    \       jinja_md.py\n    </h1>\n</section>    <section class=\"body\">\n        <hr
    />\n<p>The <code>markata.plugins.jinja_md</code> plugin enables Jinja2 templating
    within your markdown\ncontent. This allows you to dynamically generate content
    using Python expressions and\naccess to the full Markata context.</p>\n<h1 id=\"installation\">Installation
