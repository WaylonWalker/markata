...
content: "---\n\nThe `markata.plugins.feeds` plugin is used to create feed pages,
  ...
  markata.feeds config you may set `template`, and\n`card_template`.  These will become
  your defaults for every feed you create.\nIf you do not set these, markata will
  use it's defaults.  The defaults are\ndesigned to work for a variety of use cases,
  but are not likely the best for\nall.\n\n``` toml\n[markata.feeds_config]\ntemplate=\"pages/templates/archive_template.html\"\ncard_template=\"plugins/feed_card_template.html\"\n```\n\n#
  ...
  **args):\n            return self.markata.map(func, **{**self.config.dict(), **args})\n\n
  ...
  \   ```\n!!! function\n    <h2 id=\"create_page\" class=\"admonition-title\" style=\"margin:
  0; padding: .5rem 1rem;\">create_page <em class=\"small\">function</em></h2>\n\n
  ...
  \   ```\n!!! function\n    <h2 id=\"create_card\" class=\"admonition-title\" style=\"margin:
  0; padding: .5rem 1rem;\">create_card <em class=\"small\">function</em></h2>\n\n
  ...
  {}).get(\"card_template\", None)\n\n        # Get template modification time if
  template exists\n        template_mtime = 0\n        if template:\n            template_path
  ...
  not template_path:\n                import importlib\n\n                package_template
  = (\n                    importlib.resources.files(\"markata\") / \"templates\"
  / template\n                )\n                if package_template.exists():\n                    template_path
  = package_template\n\n            if template_path:\n                template_mtime
  = template_path.stat().st_mtime\n\n        key = markata.make_hash(\n            \"feeds\",
  template, str(post), post.content, str(template_mtime)\n        )\n\n        card
  ...
  \               _template = Template(template)\n            card = _template.render(post=post,
  **post.to_dict())\n        cache.add(key, card)\n        return card\n    ```\n!!!
  class\n    <h2 id=\"Feeds\" class=\"admonition-title\" style=\"margin: 0; padding:
  .5rem 1rem;\">Feeds <em class=\"small\">class</em></h2>\n\n    A storage class for
  all markata Feed objects\n\n    ``` python\n    from markata import Markata\n    markata
  ...
  \               )\n            return table\n    ```\n!!! method\n    <h2 id=\"name\"
  class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">name <em class=\"small\">method</em></h2>\n\n
  \   The name of the feed, used for accessing it in the feeds object.\n\n???+ source
  \"name <em class='small'>source</em>\"\n    ```python\n    def name(self) -> str:\n
  \           \"\"\"The name of the feed, used for accessing it in the feeds object.\"\"\"\n
  \           return self.config.name\n    ```\n!!! function\n    <h2 id=\"feeds\"
  ...
  \           \"\"\"Refresh all of the feeds objects\"\"\"\n            for feed_config
  in self.markata.config.feeds:\n                # Ensure feed has a name, falling
  back to slug if needed\n                if feed_config.name is None and feed_config.slug
  is not None:\n                    feed_config.name = feed_config.slug.replace(\"-\",
  \"_\")\n                elif feed_config.name is None and feed_config.slug is None:\n
  \                   feed_config.slug = \"archive\"\n                    feed_config.name
  = \"archive\"\n\n                feed = Feed(config=feed_config, markata=self.markata)\n
  \               self.__setattr__(feed.name, feed)\n    ```\n!!! method\n    <h2
  id=\"_dict_panel\" class=\"admonition-title\" style=\"margin: 0; padding: .5rem
...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>feeds.py</title>\n<meta charset=\"UTF-8\"
    ...
    name=\"description\" content=\"The   plugin is used to create feed pages, which
    are lists of posts.  The list is generated using a  , then each post in the list
    is rendered with a   before\u2026\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    type=\"image/png\" />\n\n<link rel=\"stylesheet\" href=\"/post.css\" />\n<link
    rel=\"stylesheet\" href=\"/app.css\" />\n<script src=\"/theme.js\"></script>\n\n\n
    \       <meta property=\"og:author_email\" content=\"waylon@waylonwalker.com\"
    />\n\n    <head>\n        <script src=\"https://unpkg.com/@tailwindcss/browser@4\"></script>\n<title>feeds.py</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"The   plugin is used to create feed pages,
    which are lists of posts.  The list is generated using a  , then each post in
    the list is rendered with a   before\u2026\" />\n <link href=\"/favicon.ico\"
    ...
    <span class=\"kc\">None</span><span class=\"p\">)</span>\n\n    <span class=\"c1\">#
    Get template modification time if template exists</span>\n    <span class=\"n\">template_mtime</span>
    <span class=\"o\">=</span> <span class=\"mi\">0</span>\n    <span class=\"k\">if</span>
    <span class=\"n\">template</span><span class=\"p\">:</span>\n        <span class=\"n\">template_path</span>
    <span class=\"o\">=</span> <span class=\"kc\">None</span>\n        <span class=\"c1\">#
    Check user template paths first</span>\n        <span class=\"k\">for</span> <span
    class=\"n\">path</span> <span class=\"ow\">in</span> <span class=\"n\">markata</span><span
    class=\"o\">.</span><span class=\"n\">jinja_env</span><span class=\"o\">.</span><span
    class=\"n\">template_paths</span><span class=\"p\">:</span>\n            <span
    class=\"n\">potential_path</span> <span class=\"o\">=</span> <span class=\"n\">Path</span><span
    class=\"p\">(</span><span class=\"n\">path</span><span class=\"p\">)</span> <span
    class=\"o\">/</span> <span class=\"n\">template</span>\n            <span class=\"k\">if</span>
    <span class=\"n\">potential_path</span><span class=\"o\">.</span><span class=\"n\">exists</span><span
    class=\"p\">():</span>\n                <span class=\"n\">template_path</span>
    <span class=\"o\">=</span> <span class=\"n\">potential_path</span>\n                <span
    class=\"k\">break</span>\n\n        <span class=\"c1\"># Check package templates
    if not found in user paths</span>\n        <span class=\"k\">if</span> <span class=\"ow\">not</span>
    <span class=\"n\">template_path</span><span class=\"p\">:</span>\n            <span
    class=\"kn\">import</span><span class=\"w\"> </span><span class=\"nn\">importlib</span>\n\n
    \           <span class=\"n\">package_template</span> <span class=\"o\">=</span>
    <span class=\"p\">(</span>\n                <span class=\"n\">importlib</span><span
    class=\"o\">.</span><span class=\"n\">resources</span><span class=\"o\">.</span><span
    class=\"n\">files</span><span class=\"p\">(</span><span class=\"s2\">&quot;markata&quot;</span><span
    class=\"p\">)</span> <span class=\"o\">/</span> <span class=\"s2\">&quot;templates&quot;</span>
    <span class=\"o\">/</span> <span class=\"n\">template</span>\n            <span
    class=\"p\">)</span>\n            <span class=\"k\">if</span> <span class=\"n\">package_template</span><span
    class=\"o\">.</span><span class=\"n\">exists</span><span class=\"p\">():</span>\n
    \               <span class=\"n\">template_path</span> <span class=\"o\">=</span>
    <span class=\"n\">package_template</span>\n\n        <span class=\"k\">if</span>
    <span class=\"n\">template_path</span><span class=\"p\">:</span>\n            <span
    class=\"n\">template_mtime</span> <span class=\"o\">=</span> <span class=\"n\">template_path</span><span
    class=\"o\">.</span><span class=\"n\">stat</span><span class=\"p\">()</span><span
    class=\"o\">.</span><span class=\"n\">st_mtime</span>\n\n    <span class=\"n\">key</span>
    <span class=\"o\">=</span> <span class=\"n\">markata</span><span class=\"o\">.</span><span
    class=\"n\">make_hash</span><span class=\"p\">(</span>\n        <span class=\"s2\">&quot;feeds&quot;</span><span
    ...
    class=\"p\">(</span><span class=\"n\">template_mtime</span><span class=\"p\">)</span>\n
    ...
    <span class=\"n\">card</span> <span class=\"ow\">is</span> <span class=\"ow\">not</span>
    <span class=\"kc\">None</span><span class=\"p\">:</span>\n        <span class=\"k\">return</span>
    ...
    class=\"p\">:</span>  <span class=\"c1\"># thrown by File name too long</span>\n
    \           <span class=\"n\">_template</span> <span class=\"o\">=</span> <span
    class=\"n\">Template</span><span class=\"p\">(</span><span class=\"n\">template</span><span
    class=\"p\">)</span>\n        <span class=\"n\">card</span> <span class=\"o\">=</span>
    <span class=\"n\">_template</span><span class=\"o\">.</span><span class=\"n\">render</span><span
    class=\"p\">(</span><span class=\"n\">post</span><span class=\"o\">=</span><span
    ...
    class=\"p\">,</span> <span class=\"n\">card</span><span class=\"p\">)</span>\n
    \   <span class=\"k\">return</span> <span class=\"n\">card</span>\n</pre></div>\n\n</pre>\n\n</div>\n<div
    class=\"admonition class\">\n<p class=\"admonition-title\">Class</p>\n<h2 id=\"Feeds\"
    class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">Feeds <em
    class=\"small\">class</em></h2>\n<p>A storage class for all markata Feed objects</p>\n<pre
    class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button class='copy' title='copy
    code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
    x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
