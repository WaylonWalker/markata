...
content: "---\n\nThe `markata.plugins.covers` plugin generates custom cover images
  ...
  image for each configuration\n2. Draws the post title using specified font and color\n3.
  Optionally draws description text\n4. Applies configured padding\n5. Saves the generated
  cover with appropriate suffix\n\n## File Naming\n\nGenerated files follow this pattern:\n-
  ...
  function\n    <h2 id=\"resolve_padding\" class=\"admonition-title\" style=\"margin:
  0; padding: .5rem 1rem;\">resolve_padding <em class=\"small\">function</em></h2>\n\n
  \   Convert padding to a len 4 tuple\n\n???+ source \"resolve_padding <em class='small'>source</em>\"\n
  \   ```python\n    def resolve_padding(padding: Tuple[int, ...], markata: \"Markata\")
  -> Tuple[int, ...]:\n        \"\"\"Convert padding to a len 4 tuple\"\"\"\n        if
  len(padding) == 4:\n            return padding\n        if len(padding) == 3:\n
...
date: 2025-02-14
description: 'The `markata.plugins.covers` plugin generates custom cover images for
  your posts using

  configurable templates. It supports multiple cover image formats with dif'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>covers.py</title>\n<meta charset=\"UTF-8\"
    />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n<meta
    name=\"description\" content=\"The `markata.plugins.covers` plugin generates custom
    cover images for your posts using\nconfigurable templates. It supports multiple
    cover image formats with dif\" />\n <link href=\"/favicon.ico\" rel=\"icon\" type=\"image/png\"
    />\n\n<link rel=\"stylesheet\" href=\"/post.css\" />\n<link rel=\"stylesheet\"
    href=\"/app.css\" />\n<script src=\"/theme.js\"></script>\n\n\n        <meta property=\"og:author_email\"
    content=\"waylon@waylonwalker.com\" />\n\n    <head>\n        <script src=\"https://unpkg.com/@tailwindcss/browser@4\"></script>\n<title>covers.py</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"The `markata.plugins.covers` plugin generates
    custom cover images for your posts using\nconfigurable templates. It supports
    multiple cover image formats with dif\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    type=\"image/png\" />\n\n<link rel=\"stylesheet\" href=\"/post.css\" />\n<link
    ...
    class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<h2 id=\"configuration-options\">Configuration
    Options <a class=\"header-anchor\" href=\"#configuration-options\"><svg class=\"heading-permalink\"
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Each cover configuration
    supports:</p>\n<ul>\n<li><code>name</code>: Suffix for generated files (e.g.,
    '-dev' creates 'post-dev.png')</li>\n<li><code>template</code>: Path to template
    ...
    <span class=\"n\">Image</span><span class=\"p\">,</span> <span class=\"n\">ImageDraw</span><span
    class=\"p\">,</span> <span class=\"n\">ImageFont</span>\n</pre></div>\n\n</pre>\n\n</div>\n<div
    class=\"admonition function\">\n<p class=\"admonition-title\">Function</p>\n<h2
