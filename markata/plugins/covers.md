---
content: "---\n\nThe `markata.plugins.covers` plugin generates custom cover images
  for your posts using\nconfigurable templates. It supports multiple cover image formats
  with different sizes,\nfonts, and layouts for various platforms (e.g., blog, social
  media, dev.to).\n\n## Installation\n\nThis plugin is built-in and enabled by default
  through the 'default' plugin.\nIf you want to be explicit, you can add it to your
  ...
  = '-dev'                                    # Suffix for generated files\ntemplate
  = \"static/cover-template.png\"           # Base template image\nfont = \"./static/JosefinSans-Regular.ttf\"
  \       # Title font\ntext_font = \"./static/JosefinSans-Regular.ttf\"   # Description
  font\nfont_color = \"rgb(185,155,165)\"                 # Title color\ntext_font_color
  = \"rgb(255,255,255)\"            # Description color\ntext_key = 'description'
  \                       # Post attribute to use for description\npadding = [0, 40,
  100, 300]                     # Title padding [top, right, bottom, left]\ntext_padding
  = [0, 0]                           # Description padding\n\n[[markata.covers]]\nname
  = ''                                       # No suffix (default cover)\ntemplate
  = \"static/og-template.png\"             # Different template for social media\nfont
  ...
  generated files (e.g., '-dev' creates 'post-dev.png')\n- `template`: Path to template
  image\n- `font`: Path to title font file\n- `text_font`: Path to description font
  ...
  integers for title padding\n- `text_padding`: List of 1-4 integers for description
  padding\n\n## Functionality\n\n## Cover Generation\n\nThe plugin:\n1. Loads the
  template image for each configuration\n2. Draws the post title using specified font
  and color\n3. Optionally draws description text\n4. Applies configured padding\n5.
  Saves the generated cover with appropriate suffix\n\n## File Naming\n\nGenerated
  files follow this pattern:\n- Main cover: `<slug>.png`\n- Named covers: `<slug><name>.png`\n\nExample:\n-
  `my-post.png` (default cover)\n- `my-post-dev.png` (dev.to cover)\n\n## Dependencies\n\nThis
  plugin depends on:\n- Pillow (PIL) for image manipulation\n\n---\n\n!!! function\n
  \   <h2 id=\"_lazy_import_pil\" class=\"admonition-title\" style=\"margin: 0; padding:
  .5rem 1rem;\">_lazy_import_pil <em class=\"small\">function</em></h2>\n\n    Lazy
  import PIL modules when needed.\n\n???+ source \"_lazy_import_pil <em class='small'>source</em>\"\n
  \   ```python\n    def _lazy_import_pil():\n        \"\"\"Lazy import PIL modules
  when needed.\"\"\"\n        global Image, ImageDraw, ImageFont\n        if Image
  is None:\n            from PIL import Image\n            from PIL import ImageDraw\n
  \           from PIL import ImageFont\n    ```\n!!! function\n    <h2 id=\"resolve_padding\"
  class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">resolve_padding
  <em class=\"small\">function</em></h2>\n\n    Convert padding to a len 4 tuple\n\n???+
  source \"resolve_padding <em class='small'>source</em>\"\n    ```python\n    def
  resolve_padding(padding: Tuple[int, ...], markata: \"Markata\") -> Tuple[int, ...]:\n
  \       \"\"\"Convert padding to a len 4 tuple\"\"\"\n        if len(padding) ==
  4:\n            return padding\n        if len(padding) == 3:\n            return
  (*padding, padding[1])\n        if len(padding) == 2:\n            return padding
  * 2\n        if len(padding) == 1:\n            return padding * 4\n        raise
  PaddingError(f\"recieved padding: {padding}\")\n    ```"
date: 2025-05-05
...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>covers.py</title>\n<meta charset=\"UTF-8\"
    ...
    name=\"description\" content=\"The   plugin generates custom cover images for
    your posts using configurable templates. It supports multiple cover image formats
    with different sizes, fonts,\u2026\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    type=\"image/png\" />\n\n<link rel=\"stylesheet\" href=\"/post.css\" />\n<link
    rel=\"stylesheet\" href=\"/app.css\" />\n<script src=\"/theme.js\"></script>\n\n\n
    \       <meta property=\"og:author_email\" content=\"waylon@waylonwalker.com\"
    />\n\n    <head>\n        <script src=\"https://unpkg.com/@tailwindcss/browser@4\"></script>\n<title>covers.py</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"The   plugin generates custom cover images
    for your posts using configurable templates. It supports multiple cover image
    formats with different sizes, fonts,\u2026\" />\n <link href=\"/favicon.ico\"
    ...
    class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n        covers.py\n
    \   </h1>\n</section>    <section class=\"body\">\n        <hr />\n<p>The <code>markata.plugins.covers</code>
    plugin generates custom cover images for your posts using\nconfigurable templates.
    It supports multiple cover image formats with different sizes,\nfonts, and layouts
    for various platforms (e.g., blog, social media, <a href=\"http://dev.to\">dev.to</a>).</p>\n<h2
    ...
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;markata.plugins.covers&quot;</span><span
    class=\"p\">,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<h2
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Configure multiple cover
    image templates in your <code>markata.toml</code>:</p>\n<pre class='wrapper'>\n\n<div
    class='copy-wrapper'>\n\n<button class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
    x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
    0 0 115.77 122.88\" xml:space=\"preserve\"><style type=\"text/css\">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path
    ...
    class=\"w\"> </span><span class=\"s1\">&#39;-dev&#39;</span><span class=\"w\">
    \                                   </span><span class=\"c1\"># Suffix for generated
    files</span>\n<span class=\"n\">template</span><span class=\"w\"> </span><span
    class=\"o\">=</span><span class=\"w\"> </span><span class=\"s2\">&quot;static/cover-template.png&quot;</span><span
    class=\"w\">           </span><span class=\"c1\"># Base template image</span>\n<span
    class=\"n\">font</span><span class=\"w\"> </span><span class=\"o\">=</span><span
    class=\"w\"> </span><span class=\"s2\">&quot;./static/JosefinSans-Regular.ttf&quot;</span><span
    class=\"w\">        </span><span class=\"c1\"># Title font</span>\n<span class=\"n\">text_font</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;./static/JosefinSans-Regular.ttf&quot;</span><span class=\"w\">
    \  </span><span class=\"c1\"># Description font</span>\n<span class=\"n\">font_color</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;rgb(185,155,165)&quot;</span><span class=\"w\">                 </span><span
    class=\"c1\"># Title color</span>\n<span class=\"n\">text_font_color</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;rgb(255,255,255)&quot;</span><span class=\"w\">            </span><span
    class=\"c1\"># Description color</span>\n<span class=\"n\">text_key</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s1\">&#39;description&#39;</span><span class=\"w\">                        </span><span
    class=\"c1\"># Post attribute to use for description</span>\n<span class=\"n\">padding</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    ...
    class=\"w\"> </span><span class=\"mi\">300</span><span class=\"p\">]</span><span
    class=\"w\">                     </span><span class=\"c1\"># Title padding [top,
    right, bottom, left]</span>\n<span class=\"n\">text_padding</span><span class=\"w\">
    </span><span class=\"o\">=</span><span class=\"w\"> </span><span class=\"p\">[</span><span
    class=\"mi\">0</span><span class=\"p\">,</span><span class=\"w\"> </span><span
    class=\"mi\">0</span><span class=\"p\">]</span><span class=\"w\">                           </span><span
    class=\"c1\"># Description padding</span>\n\n<span class=\"k\">[[markata.covers]]</span>\n<span
    class=\"n\">name</span><span class=\"w\"> </span><span class=\"o\">=</span><span
    class=\"w\"> </span><span class=\"s1\">&#39;&#39;</span><span class=\"w\">                                       </span><span
    class=\"c1\"># No suffix (default cover)</span>\n<span class=\"n\">template</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;static/og-template.png&quot;</span><span class=\"w\">             </span><span
    class=\"c1\"># Different template for social media</span>\n<span class=\"n\">font</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;./static/JosefinSans-Regular.ttf&quot;</span>\n<span class=\"n\">font_color</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;rgb(255,255,255)&quot;</span>\n<span class=\"n\">text_font</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;./static/JosefinSans-Regular.ttf&quot;</span>\n<span class=\"n\">text_font_color</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;rgb(200,200,200)&quot;</span>\n<span class=\"n\">text_key</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s1\">&#39;description&#39;</span>\n<span class=\"n\">padding</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    ...
    cover configuration supports:</p>\n<ul>\n<li><code>name</code>: Suffix for generated
    files (e.g., '-dev' creates 'post-dev.png')</li>\n<li><code>template</code>: Path
    to template image</li>\n<li><code>font</code>: Path to title font file</li>\n<li><code>text_font</code>:
    Path to description font file</li>\n<li><code>font_color</code>: RGB color for
    title</li>\n<li><code>text_font_color</code>: RGB color for description</li>\n<li><code>text_key</code>:
    Post attribute to use for description text</li>\n<li><code>padding</code>: List
    of 1-4 integers for title padding</li>\n<li><code>text_padding</code>: List of
    1-4 integers for description padding</li>\n</ul>\n<h2 id=\"functionality\">Functionality
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<h2 id=\"cover-generation\">Cover
    Generation <a class=\"header-anchor\" href=\"#cover-generation\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>The plugin:</p>\n<ol>\n<li>Loads
    the template image for each configuration</li>\n<li>Draws the post title using
    specified font and color</li>\n<li>Optionally draws description text</li>\n<li>Applies
    configured padding</li>\n<li>Saves the generated cover with appropriate suffix</li>\n</ol>\n<h2
    id=\"file-naming\">File Naming <a class=\"header-anchor\" href=\"#file-naming\"><svg
    class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
    height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Generated files follow
    this pattern:</p>\n<ul>\n<li>Main cover: <code>&lt;slug&gt;.png</code></li>\n<li>Named
    covers: <code>&lt;slug&gt;&lt;name&gt;.png</code></li>\n</ul>\n<p>Example:</p>\n<ul>\n<li><code>my-post.png</code>
    (default cover)</li>\n<li><code>my-post-dev.png</code> (<a href=\"http://dev.to\">dev.to</a>
    ...
    id=\"_lazy_import_pil\" class=\"admonition-title\" style=\"margin: 0; padding:
    .5rem 1rem;\">_lazy_import_pil <em class=\"small\">function</em></h2>\n<p>Lazy
    import PIL modules when needed.</p>\n</div>\n<div class=\"admonition source is-collapsible
    collapsible-open\">\n<p class=\"admonition-title\">_lazy_import_pil <em class='small'>source</em></p>\n<pre
    ...
    class=\"w\"> </span><span class=\"nf\">_lazy_import_pil</span><span class=\"p\">():</span>\n<span
    class=\"w\">    </span><span class=\"sd\">&quot;&quot;&quot;Lazy import PIL modules
    when needed.&quot;&quot;&quot;</span>\n    <span class=\"k\">global</span> <span
    class=\"n\">Image</span><span class=\"p\">,</span> <span class=\"n\">ImageDraw</span><span
    class=\"p\">,</span> <span class=\"n\">ImageFont</span>\n    <span class=\"k\">if</span>
    <span class=\"n\">Image</span> <span class=\"ow\">is</span> <span class=\"kc\">None</span><span
    class=\"p\">:</span>\n        <span class=\"kn\">from</span><span class=\"w\">
    </span><span class=\"nn\">PIL</span><span class=\"w\"> </span><span class=\"kn\">import</span>
    <span class=\"n\">Image</span>\n        <span class=\"kn\">from</span><span class=\"w\">
    </span><span class=\"nn\">PIL</span><span class=\"w\"> </span><span class=\"kn\">import</span>
    <span class=\"n\">ImageDraw</span>\n        <span class=\"kn\">from</span><span
    class=\"w\"> </span><span class=\"nn\">PIL</span><span class=\"w\"> </span><span
    class=\"kn\">import</span> <span class=\"n\">ImageFont</span>\n</pre></div>\n\n</pre>\n\n</div>\n<div
    class=\"admonition function\">\n<p class=\"admonition-title\">Function</p>\n<h2
    id=\"resolve_padding\" class=\"admonition-title\" style=\"margin: 0; padding:
    .5rem 1rem;\">resolve_padding <em class=\"small\">function</em></h2>\n<p>Convert
    padding to a len 4 tuple</p>\n</div>\n<div class=\"admonition source is-collapsible
    collapsible-open\">\n<p class=\"admonition-title\">resolve_padding <em class='small'>source</em></p>\n<pre
    class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button class='copy' title='copy
    code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
    x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
    ...
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">def</span><span
    class=\"w\"> </span><span class=\"nf\">resolve_padding</span><span class=\"p\">(</span><span
    class=\"n\">padding</span><span class=\"p\">:</span> <span class=\"n\">Tuple</span><span
    class=\"p\">[</span><span class=\"nb\">int</span><span class=\"p\">,</span> <span
    class=\"o\">...</span><span class=\"p\">],</span> <span class=\"n\">markata</span><span
    class=\"p\">:</span> <span class=\"s2\">&quot;Markata&quot;</span><span class=\"p\">)</span>
    <span class=\"o\">-&gt;</span> <span class=\"n\">Tuple</span><span class=\"p\">[</span><span
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    \       covers.py\n    </h1>\n</section>    <section class=\"body\">\n        <hr
    />\n<p>The <code>markata.plugins.covers</code> plugin generates custom cover images
    for your posts using\nconfigurable templates. It supports multiple cover image
    formats with different sizes,\nfonts, and layouts for various platforms (e.g.,
    blog, social media, <a href=\"http://dev.to\">dev.to</a>).</p>\n<h2 id=\"installation\">Installation
