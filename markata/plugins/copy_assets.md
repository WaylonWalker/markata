...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>copy_assets.py</title>\n<meta
    ...
    />\n<meta name=\"description\" content=\"The   plugin copies static assets (images,
    CSS, JavaScript, etc.) from your assets directory to the output directory during
    the build process. Installation\u2026\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>copy_assets.py</title>\n<meta charset=\"UTF-8\"
    />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n<meta
    name=\"description\" content=\"The   plugin copies static assets (images, CSS,
    JavaScript, etc.) from your assets directory to the output directory during the
