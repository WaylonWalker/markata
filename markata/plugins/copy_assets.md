---
content: "---\n\nThe `markata.plugins.copy_assets` plugin copies static assets (images,
  CSS, JavaScript, etc.)\nfrom your assets directory to the output directory during
  ...
  where assets will be copied\noutput_dir = \"markout\"\n```\n\n# Functionality\n\n##
  Asset Copying\n\nThe plugin:\n1. Checks if the configured assets directory exists\n2.
  Recursively copies all files and directories from assets_dir to output_dir\n3. Preserves
  ...
  logo.png\n```\n\n---"
date: 2025-02-14
description: 'The `markata.plugins.copy_assets` plugin copies static assets (images,
  CSS, JavaScript, etc.)

  from your assets directory to the output directory during the buil'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>copy_assets.py</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"The `markata.plugins.copy_assets` plugin
    copies static assets (images, CSS, JavaScript, etc.)\nfrom your assets directory
    to the output directory during the buil\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    ...
    class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n        copy_assets.py\n
    \   </h1>\n</section>    <section class=\"body\">\n        <hr />\n<p>The <code>markata.plugins.copy_assets</code>
    plugin copies static assets (images, CSS, JavaScript, etc.)\nfrom your assets
    directory to the output directory during the build process.</p>\n<h1 id=\"installation\">Installation
    ...
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;markata.plugins.copy_assets&quot;</span><span
    class=\"p\">,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<h1
    ...
    class=\"c1\"># Directory containing your static assets</span>\n<span class=\"n\">assets_dir</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;assets&quot;</span>\n\n<span class=\"c1\"># Directory where
    assets will be copied</span>\n<span class=\"n\">output_dir</span><span class=\"w\">
    </span><span class=\"o\">=</span><span class=\"w\"> </span><span class=\"s2\">&quot;markout&quot;</span>\n</pre></div>\n\n</pre>\n\n<h1
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h1>\n<h2 id=\"asset-copying\">Asset
    Copying <a class=\"header-anchor\" href=\"#asset-copying\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    if the configured assets directory exists</li>\n<li>Recursively copies all files
    and directories from assets_dir to output_dir</li>\n<li>Preserves directory structure</li>\n<li>Updates
    existing files if they've changed</li>\n<li>Maintains any existing files in the
    output directory</li>\n</ol>\n<h2 id=\"usage-example\">Usage Example <a class=\"header-anchor\"
    href=\"#usage-example\"><svg class=\"heading-permalink\" aria-hidden=\"true\"
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Place static assets
    in your assets directory:</p>\n<pre class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button
    class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
    x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
    0 0 115.77 122.88\" xml:space=\"preserve\"><style type=\"text/css\">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path
    ...
    c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span>markout/\n  \u251C\u2500\u2500
    css/\n  \u2502   \u2514\u2500\u2500 style.css\n  \u251C\u2500\u2500 js/\n  \u2502
    \  \u2514\u2500\u2500 main.js\n  \u2514\u2500\u2500 images/\n      \u2514\u2500\u2500
    logo.png\n</pre></div>\n\n</pre>\n\n<hr />\n\n    </section>\n</article>    </div>\n
    \   <div></div>\n</div>\n     </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>copy_assets.py</title>\n<meta charset=\"UTF-8\"
    />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n<meta
    name=\"description\" content=\"The `markata.plugins.copy_assets` plugin copies
    static assets (images, CSS, JavaScript, etc.)\nfrom your assets directory to the
    output directory during the buil\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    type=\"image/png\" />\n\n<link rel=\"stylesheet\" href=\"/post.css\" />\n<link
    rel=\"stylesheet\" href=\"/app.css\" />\n<script src=\"/theme.js\"></script>\n\n\n
    \       <meta property=\"og:author_email\" content=\"waylon@waylonwalker.com\"
    />\n\n    <head>\n        <script src=\"https://unpkg.com/@tailwindcss/browser@4\"></script>\n<title>copy_assets.py</title>\n<meta
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    \       copy_assets.py\n    </h1>\n</section>    <section class=\"body\">\n        <hr
    />\n<p>The <code>markata.plugins.copy_assets</code> plugin copies static assets
    (images, CSS, JavaScript, etc.)\nfrom your assets directory to the output directory
