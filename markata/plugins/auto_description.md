...
content: "A Markata plugin to create automatic descriptions for markdown documents.
  ...
  = get_description(article)[:max_description]\n                markata.cache.add(key,
  description, expire=markata.config.default_cache_expire)\n            else:\n                description
  = description_from_cache\n\n            for description_key in config:\n                if
  description_key not in [\"cache_expire\", \"config_key\"]:\n                    #
...
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Auto_Description.Py</title>\n<meta
  ...
  content=\"A Markata plugin to create automatic descriptions for markdown documents.
  \ It Open up your  ! In the above we will end up with three different descritpions,
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  name=\"og:type\" property=\"og:type\"/><meta content=\"A Markata plugin to create
  automatic descriptions for markdown documents.  It Open up your  ! In the above
  we will end up with three different descritpions, By \" name=\"description\" property=\"description\"/><meta
  content=\"A Markata plugin to create automatic descriptions for markdown documents.
  \ It Open up your  ! In the above we will end up with three different descritpions,
  By \" name=\"og:description\" property=\"og:description\"/><meta content=\"A Markata
  plugin to create automatic descriptions for markdown documents.  It Open up your
  \ ! In the above we will end up with three different descritpions, By \" name=\"twitter:description\"
  property=\"twitter:description\"/><meta content=\"Auto_Description.Py | Markata\"
  name=\"og:title\" property=\"og:title\"/><meta content=\"Auto_Description.Py | Markata\"
  name=\"twitter:title\" property=\"twitter:title\"/><meta content=\"https://markata.dev//markata/plugins/auto-description-og.png\"
  name=\"og:image\" property=\"og:image\"/><meta content=\"https://markata.dev//markata/plugins/auto-description-og.png\"
  ...
  name=\"twitter:creator\" property=\"twitter:creator\"/><meta content=\"Auto_Description.Py\"
  name=\"title\" property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\"
  property=\"generator\"/><link href=\"https://markata.dev//markata/plugins/auto-description/\"
  rel=\"canonical\"/><meta content=\"https://markata.dev//markata/plugins/auto-description/\"
  ...
  round\"></div>\n</label>\n</div>\n<section class=\"title\">\n<h1 id=\"title\">\n
  \           Auto_Description.Py \n            \n        </h1>\n</section>\n<main><p>A
  Markata plugin to create automatic descriptions for markdown documents.  It\ndoes
  this by grabbing the first <code>{len}</code> number of characters from the document\nthat
  are in a paragraph.</p>\n<h2 id=\"configuration\">Configuration <a class=\"header-anchor\"
  ...
  example that lists all of the descriptions in all posts.  This\nis a handy thing
  you can do right from a repl.</p>\n<pre class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button
  ...
  id=\"get_description\" style=\"margin:0;padding:.5rem 1rem;\">get_description <em
  ...
  \           Get the full-length description for a single post using the commonmark</span>\n<span
  class=\"sd\">            parser.  Only paragraph nodes will count as text towards
  the description.</span>\n<span class=\"sd\">            \"\"\"</span>\n            <span
  class=\"n\">ast</span> <span class=\"o\">=</span> <span class=\"n\">_parser</span><span
  ...
  \           <span class=\"n\">paragraph_nodes</span> <span class=\"o\">=</span>
  <span class=\"p\">[</span>\n                <span class=\"n\">n</span><span class=\"p\">[</span><span
  class=\"mi\">0</span><span class=\"p\">]</span>\n                <span class=\"k\">for</span>
  <span class=\"n\">n</span> <span class=\"ow\">in</span> <span class=\"n\">ast</span><span
  class=\"o\">.</span><span class=\"n\">walker</span><span class=\"p\">()</span>\n
  \               <span class=\"k\">if</span> <span class=\"n\">n</span><span class=\"p\">[</span><span
  class=\"mi\">0</span><span class=\"p\">]</span><span class=\"o\">.</span><span class=\"n\">t</span>
  <span class=\"o\">==</span> <span class=\"s2\">\"paragraph\"</span> <span class=\"ow\">and</span>
  ...
  class=\"p\">]</span>\n            <span class=\"c1\"># for reasons unknown to me
  commonmark duplicates nodes, dedupe based on sourcepos</span>\n            <span
  ...
  class=\"n\">unique_mask</span> <span class=\"o\">=</span> <span class=\"p\">[</span><span
  class=\"n\">sourcepos</span><span class=\"o\">.</span><span class=\"n\">index</span><span
  class=\"p\">(</span><span class=\"n\">s</span><span class=\"p\">)</span> <span class=\"o\">==</span>
  <span class=\"n\">i</span> <span class=\"k\">for</span> <span class=\"n\">i</span><span
  class=\"p\">,</span> <span class=\"n\">s</span> <span class=\"ow\">in</span> <span
  class=\"nb\">enumerate</span><span class=\"p\">(</span><span class=\"n\">sourcepos</span><span
  class=\"p\">)]</span>\n            <span class=\"c1\"># deduplicate paragraph_nodes
  based on unique source position</span>\n            <span class=\"n\">unique_paragraph_nodes</span>
  ...
  class=\"p\">([</span><span class=\"n\">p</span><span class=\"o\">.</span><span class=\"n\">first_child</span><span
  class=\"o\">.</span><span class=\"n\">literal</span> <span class=\"k\">for</span>
  <span class=\"n\">p</span> <span class=\"ow\">in</span> <span class=\"n\">unique_paragraph_nodes</span><span
  class=\"p\">])</span>\n            <span class=\"n\">paragraphs</span> <span class=\"o\">=</span>
  <span class=\"n\">html</span><span class=\"o\">.</span><span class=\"n\">escape</span><span
  class=\"p\">(</span><span class=\"n\">paragraphs</span><span class=\"p\">)</span>\n
  \           <span class=\"k\">return</span> <span class=\"n\">paragraphs</span>\n</pre></div>\n\n</pre>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"set_description\" style=\"margin:0;padding:.5rem
  ...
  class=\"p\">:</span> <span class=\"kc\">None</span> <span class=\"o\">=</span> <span
  class=\"s2\">\"\"</span><span class=\"p\">,</span>\n        <span class=\"p\">)</span>
  <span class=\"o\">-&gt;</span> <span class=\"kc\">None</span><span class=\"p\">:</span>\n<span
  class=\"w\">            </span><span class=\"sd\">\"\"\"</span>\n<span class=\"sd\">
  \           For a given `article`, find the description, put it in the cache, and
  set</span>\n<span class=\"sd\">            the configured descriptions for the article.</span>\n<span
  ...
  \               <span class=\"n\">plugin_text</span><span class=\"p\">,</span>\n
  \               <span class=\"n\">config</span><span class=\"p\">,</span>\n            <span
  ...
  class=\"ow\">not</span> <span class=\"n\">article</span><span class=\"o\">.</span><span
  ...
  will set descriptions for all posts in the pre-render phase.\n<div class=\"admonition
  ...
  <span class=\"s2\">\"long_description\"</span> <span class=\"ow\">not</span> <span
  class=\"ow\">in</span> <span class=\"n\">config</span><span class=\"o\">.</span><span
  class=\"n\">keys</span><span class=\"p\">():</span>\n                <span class=\"n\">config</span><span
  class=\"p\">[</span><span class=\"s2\">\"long_description\"</span><span class=\"p\">]</span>
  <span class=\"o\">=</span> <span class=\"p\">{}</span>\n                <span class=\"n\">config</span><span
  class=\"p\">[</span><span class=\"s2\">\"long_description\"</span><span class=\"p\">][</span><span
  class=\"s2\">\"len\"</span><span class=\"p\">]</span> <span class=\"o\">=</span>
  <span class=\"mi\">250</span>\n\n            <span class=\"k\">def</span> <span
  class=\"nf\">try_config_get</span><span class=\"p\">(</span><span class=\"n\">key</span><span
  ...
  \           <span class=\"n\">max_description</span> <span class=\"o\">=</span>
  <span class=\"nb\">max</span><span class=\"p\">(</span>\n                <span class=\"p\">[</span>\n
  \                   <span class=\"n\">value</span>\n                    <span class=\"k\">for</span>
  <span class=\"n\">description_key</span> <span class=\"ow\">in</span> <span class=\"n\">config</span>\n
  \                   <span class=\"k\">if</span> <span class=\"p\">(</span><span
  class=\"n\">value</span> <span class=\"o\">:=</span> <span class=\"n\">try_config_get</span><span
  class=\"p\">(</span><span class=\"n\">description_key</span><span class=\"p\">))</span>\n
  \               <span class=\"p\">],</span>\n            <span class=\"p\">)</span>\n\n
  ...
  class=\"p\">(),</span>\n                    <span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"try_config_get\" style=\"margin:0;padding:.5rem
  1rem;\">try_config_get <em class=\"small\">function</em></h2>\n<div class=\"admonition
