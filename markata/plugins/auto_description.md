...
content: "---\n\nThe `markata.plugins.auto_description` plugin automatically generates
  ...
  nodes.\n    Strips out any HTML tags, returning only plain text. Properly handles
  markdown links and formatting.\n\n???+ source \"get_description <em class='small'>source</em>\"\n
  \   ```python\n    def get_description(article: \"Post\") -> str:\n        \"\"\"\n
  \       Get the full-length description for a single post by converting markdown
  to plain text.\n        Uses markdown-it-py to parse the markdown and extracts text
  content from all nodes.\n        Strips out any HTML tags, returning only plain
  text. Properly handles markdown links and formatting.\n        \"\"\"\n        from
  ...
  \       tokens = md.parse(article.content)\n\n        # Recursively extract visible
  text from all tokens\n        description = extract_text(tokens)\n        # Remove
  any HTML tags using BeautifulSoup\n        soup = BeautifulSoup(description, \"html.parser\")\n
  ...
  config.get(key).get(\"len\") or None\n            except AttributeError:\n                return
  None\n\n        max_description = max(\n            [\n                value\n                for
...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>auto_description.py</title>\n<meta
    ...
    />\n<meta name=\"description\" content=\"The   plugin automatically generates
    descriptions for your posts by extracting text from the first paragraphs of your
    markdown content. It can create multiple\u2026\" />\n <link href=\"/favicon.ico\"
    ...
    markdown-it-py to parse the markdown and extracts text content from all nodes.\nStrips
    out any HTML tags, returning only plain text. Properly handles markdown links
    ...
    \   Strips out any HTML tags, returning only plain text. Properly handles markdown
    links and formatting.</span>\n<span class=\"sd\">    &quot;&quot;&quot;</span>\n
    \   <span class=\"kn\">from</span><span class=\"w\"> </span><span class=\"nn\">bs4</span><span
    class=\"w\"> </span><span class=\"kn\">import</span> <span class=\"n\">BeautifulSoup</span>\n
    \   <span class=\"kn\">from</span><span class=\"w\"> </span><span class=\"nn\">markdown_it</span><span
    class=\"w\"> </span><span class=\"kn\">import</span> <span class=\"n\">MarkdownIt</span>\n\n
    \   <span class=\"k\">def</span><span class=\"w\"> </span><span class=\"nf\">extract_text</span><span
    class=\"p\">(</span><span class=\"n\">tokens</span><span class=\"p\">):</span>\n
    \       <span class=\"n\">text_chunks</span> <span class=\"o\">=</span> <span
    class=\"p\">[]</span>\n        <span class=\"k\">for</span> <span class=\"n\">token</span>
    <span class=\"ow\">in</span> <span class=\"n\">tokens</span><span class=\"p\">:</span>\n
    \           <span class=\"c1\"># If the token has children, recursively extract
    from children</span>\n            <span class=\"k\">if</span> <span class=\"nb\">hasattr</span><span
    class=\"p\">(</span><span class=\"n\">token</span><span class=\"p\">,</span> <span
    class=\"s2\">&quot;children&quot;</span><span class=\"p\">)</span> <span class=\"ow\">and</span>
    <span class=\"n\">token</span><span class=\"o\">.</span><span class=\"n\">children</span><span
    class=\"p\">:</span>\n                <span class=\"n\">text_chunks</span><span
    class=\"o\">.</span><span class=\"n\">append</span><span class=\"p\">(</span><span
    class=\"n\">extract_text</span><span class=\"p\">(</span><span class=\"n\">token</span><span
    class=\"o\">.</span><span class=\"n\">children</span><span class=\"p\">))</span>\n
    \           <span class=\"k\">elif</span> <span class=\"n\">token</span><span
    class=\"o\">.</span><span class=\"n\">type</span> <span class=\"o\">==</span>
    <span class=\"s2\">&quot;text&quot;</span><span class=\"p\">:</span>\n                <span
    class=\"n\">text_chunks</span><span class=\"o\">.</span><span class=\"n\">append</span><span
    ...
    class=\"p\">(</span><span class=\"n\">text_chunks</span><span class=\"p\">)</span>\n\n
    \   <span class=\"n\">md</span> <span class=\"o\">=</span> <span class=\"n\">MarkdownIt</span><span
    class=\"p\">(</span><span class=\"s2\">&quot;commonmark&quot;</span><span class=\"p\">)</span>\n
    \   <span class=\"n\">tokens</span> <span class=\"o\">=</span> <span class=\"n\">md</span><span
    ...
    class=\"p\">)</span>\n\n    <span class=\"c1\"># Recursively extract visible text
    from all tokens</span>\n    <span class=\"n\">description</span> <span class=\"o\">=</span>
    <span class=\"n\">extract_text</span><span class=\"p\">(</span><span class=\"n\">tokens</span><span
    class=\"p\">)</span>\n    <span class=\"c1\"># Remove any HTML tags using BeautifulSoup</span>\n
    ...
    <span class=\"s2\">&quot;html.parser&quot;</span><span class=\"p\">)</span>\n
    \   <span class=\"n\">plain_text</span> <span class=\"o\">=</span> <span class=\"n\">soup</span><span
    class=\"o\">.</span><span class=\"n\">get_text</span><span class=\"p\">(</span><span
    class=\"n\">separator</span><span class=\"o\">=</span><span class=\"s2\">&quot;
    &quot;</span><span class=\"p\">,</span> <span class=\"n\">strip</span><span class=\"o\">=</span><span
    class=\"kc\">True</span><span class=\"p\">)</span>\n    <span class=\"k\">return</span>
    <span class=\"n\">plain_text</span>\n</pre></div>\n\n</pre>\n\n</div>\n<div class=\"admonition
    function\">\n<p class=\"admonition-title\">Function</p>\n<h2 id=\"set_description\"
    class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">set_description
    <em class=\"small\">function</em></h2>\n<p>For a given <code>article</code>, find
    the description, put it in the cache, and set\nthe configured descriptions for
    the article.</p>\n</div>\n<div class=\"admonition source is-collapsible collapsible-open\">\n<p
    ...
    class=\"p\">(</span>\n        <span class=\"s2\">&quot;auto_description-v5&quot;</span><span
    ...
    \   <span class=\"k\">if</span> <span class=\"n\">description_from_cache</span>
    <span class=\"ow\">is</span> <span class=\"kc\">None</span><span class=\"p\">:</span>\n
    \       <span class=\"n\">description</span> <span class=\"o\">=</span> <span
    class=\"n\">get_description</span><span class=\"p\">(</span><span class=\"n\">article</span><span
    class=\"p\">)[:</span><span class=\"n\">max_description</span><span class=\"p\">]</span>\n
    ...
    class=\"n\">article</span><span class=\"p\">[</span><span class=\"s2\">&quot;description&quot;</span><span
    class=\"p\">]</span> <span class=\"o\">=</span> <span class=\"n\">description</span>\n\n
    \   <span class=\"k\">for</span> <span class=\"n\">description_key</span> <span
    class=\"ow\">in</span> <span class=\"n\">config</span><span class=\"p\">:</span>\n
    \       <span class=\"k\">if</span> <span class=\"n\">description_key</span> <span
    ...
    class=\"p\">]:</span>\n            <span class=\"n\">desc_len</span> <span class=\"o\">=</span>
    <span class=\"n\">config</span><span class=\"p\">[</span><span class=\"n\">description_key</span><span
    class=\"p\">][</span><span class=\"s2\">&quot;len&quot;</span><span class=\"p\">]</span>\n\n
    \           <span class=\"c1\"># Truncate to word boundary and add ellipsis if
    needed</span>\n            <span class=\"k\">def</span><span class=\"w\"> </span><span
    class=\"nf\">safe_truncate</span><span class=\"p\">(</span><span class=\"n\">text</span><span
    class=\"p\">,</span> <span class=\"n\">max_len</span><span class=\"p\">):</span>\n
    ...
    \                   <span class=\"n\">truncated</span> <span class=\"o\">=</span>
    <span class=\"n\">text</span><span class=\"p\">[:</span><span class=\"n\">max_len</span><span
    class=\"p\">]</span><span class=\"o\">.</span><span class=\"n\">rstrip</span><span
    class=\"p\">()</span>\n                    <span class=\"k\">if</span> <span class=\"s2\">&quot;
    &quot;</span> <span class=\"ow\">in</span> <span class=\"n\">truncated</span><span
    class=\"p\">:</span>\n                        <span class=\"n\">truncated</span>
    <span class=\"o\">=</span> <span class=\"n\">truncated</span><span class=\"p\">[:</span>
    <span class=\"n\">truncated</span><span class=\"o\">.</span><span class=\"n\">rfind</span><span
    class=\"p\">(</span><span class=\"s2\">&quot; &quot;</span><span class=\"p\">)]</span><span
    class=\"o\">.</span><span class=\"n\">rstrip</span><span class=\"p\">()</span>\n
    \                   <span class=\"k\">return</span> <span class=\"n\">truncated</span>
    <span class=\"o\">+</span> <span class=\"s2\">&quot;\u2026&quot;</span>\n                <span
    class=\"k\">return</span> <span class=\"n\">text</span>\n\n            <span class=\"c1\">#
    overwrites missing (None) and empty (&#39;&#39;)</span>\n            <span class=\"k\">if</span>
    ...
    class=\"p\">]</span> <span class=\"o\">=</span> <span class=\"n\">safe_truncate</span><span
    class=\"p\">(</span><span class=\"n\">description</span><span class=\"p\">,</span>
    <span class=\"n\">desc_len</span><span class=\"p\">)</span>\n            <span
    class=\"k\">if</span> <span class=\"n\">description_key</span> <span class=\"o\">==</span>
    <span class=\"s2\">&quot;description&quot;</span><span class=\"p\">:</span>\n
    \               <span class=\"n\">article</span><span class=\"p\">[</span><span
    class=\"s2\">&quot;description&quot;</span><span class=\"p\">]</span> <span class=\"o\">=</span>
    <span class=\"n\">safe_truncate</span><span class=\"p\">(</span><span class=\"n\">description</span><span
    class=\"p\">,</span> <span class=\"n\">desc_len</span><span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n\n</div>\n<div
    class=\"admonition function\">\n<p class=\"admonition-title\">Function</p>\n<h2
    id=\"pre_render\" class=\"admonition-title\" style=\"margin: 0; padding: .5rem
    1rem;\">pre_render <em class=\"small\">function</em></h2>\n<p>The Markata hook
    that will set descriptions for all posts in the pre-render phase.</p>\n</div>\n<div
    ...
    for article in markata.iter_articles(&quot;setting auto description&quot;):</span>\n
