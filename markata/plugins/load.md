---
content: "---\n\nThe `markata.plugins.load` plugin is responsible for loading and
  parsing markdown files\nwith frontmatter into Post objects. It provides parallel
  loading capabilities and\nhandles both modern Pydantic-based and legacy frontmatter
  ...
  plugin:\n\n```toml\ndisabled_hooks = [\n    \"markata.plugins.load\",\n]\n```\n\nNote:
  Disabling this plugin will prevent Markata from loading any markdown files.\nThis
  will effectively disable most of Markata's functionality.\n\n# Configuration\n\nConfigure
  loading behavior in your `markata.toml`:\n\n```toml\n[markata]\n# Directories containing
  markdown content\ncontent_directories = [\n    \"content\",\n    \"posts\"\n]\n\n#
  Optional: Set to true to use legacy frontmatter validation\nlegacy_frontmatter =
  false\n\n# Optional: Number of worker processes for parallel loading\nload_workers
  = 4\n```\n\n# Functionality\n\n## File Loading\n\nThe plugin:\n1. Discovers markdown
  files in content directories\n2. Loads file content and frontmatter\n3. Validates
  frontmatter against Post model\n4. Creates Post objects for further processing\n\n##
  ...
  Legacy frontmatter validation\n   - Looser type checking\n   - Compatible with older
  content\n   - Less strict validation\n\n## Error Handling\n\nThe plugin provides:\n-
  Detailed validation error messages\n- Per-file error reporting\n- Graceful fallback
  to legacy mode\n- Optional strict validation\n\n## Registered Attributes\n\nThe
  plugin adds:\n- `articles`: List of loaded Post objects\n- `content_directories`:
  List of content source directories\n\n## Dependencies\n\nThis plugin depends on:\n-
  python-frontmatter for YAML parsing\n- pydantic for validation\n- multiprocessing
  for parallel loading\n\n---\n\n\n\n\n\n!!! function\n    <h2 id=\"load_file_content\"
  class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">load_file_content
  <em class=\"small\">function</em></h2>\n\n    Load file content without validation.\n\n???+
  source \"load_file_content <em class='small'>source</em>\"\n    ```python\n    def
  load_file_content(path: Path) -> tuple[Path, dict]:\n        \"\"\"Load file content
  without validation.\"\"\"\n        try:\n            with open(path, \"r\") as f:\n
  \               raw_content = f.read()\n            try:\n                content
  = frontmatter.loads(raw_content)\n            except Exception:\n                content
  = None\n            content[\"raw\"] = raw_content\n            return path, content\n
  \       except Exception:\n            return path, None\n    ```"
date: 2025-02-14
description: 'The `markata.plugins.load` plugin is responsible for loading and parsing
  markdown files

  with frontmatter into Post objects. It provides parallel loading capabil'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>load.py</title>\n<meta charset=\"UTF-8\"
    />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n<meta
    name=\"description\" content=\"The `markata.plugins.load` plugin is responsible
    for loading and parsing markdown files\nwith frontmatter into Post objects. It
    provides parallel loading capabil\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    type=\"image/png\" />\n\n<link rel=\"stylesheet\" href=\"/post.css\" />\n<link
    rel=\"stylesheet\" href=\"/app.css\" />\n<script src=\"/theme.js\"></script>\n\n\n
    \       <meta property=\"og:author_email\" content=\"waylon@waylonwalker.com\"
    />\n\n    <head>\n        <script src=\"https://unpkg.com/@tailwindcss/browser@4\"></script>\n<title>load.py</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"The `markata.plugins.load` plugin is
    responsible for loading and parsing markdown files\nwith frontmatter into Post
    objects. It provides parallel loading capabil\" />\n <link href=\"/favicon.ico\"
    ...
    class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n        load.py\n
    \   </h1>\n</section>    <section class=\"body\">\n        <hr />\n<p>The <code>markata.plugins.load</code>
    plugin is responsible for loading and parsing markdown files\nwith frontmatter
    into Post objects. It provides parallel loading capabilities and\nhandles both
    modern Pydantic-based and legacy frontmatter validation.</p>\n<h1 id=\"installation\">Installation
    ...
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;markata.plugins.load&quot;</span><span
    class=\"p\">,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<h1
    ...
    class=\"p\">,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<p>Note:
    Disabling this plugin will prevent Markata from loading any markdown files.\nThis
    will effectively disable most of Markata's functionality.</p>\n<h1 id=\"configuration\">Configuration
    ...
    class=\"c1\"># Directories containing markdown content</span>\n<span class=\"n\">content_directories</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;content&quot;</span><span
    class=\"p\">,</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;posts&quot;</span>\n<span
    class=\"p\">]</span>\n\n<span class=\"c1\"># Optional: Set to true to use legacy
    frontmatter validation</span>\n<span class=\"n\">legacy_frontmatter</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"kc\">false</span>\n\n<span class=\"c1\"># Optional: Number of worker processes
    for parallel loading</span>\n<span class=\"n\">load_workers</span><span class=\"w\">
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h1>\n<h2 id=\"file-loading\">File
    Loading <a class=\"header-anchor\" href=\"#file-loading\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Loading is parallelized
    using:</p>\n<ul>\n<li>Process pool for file reading</li>\n<li>Configurable number
    of workers</li>\n<li>Chunked file processing</li>\n</ul>\n<h2 id=\"validation-modes\">Validation
    Modes <a class=\"header-anchor\" href=\"#validation-modes\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    fallback to legacy mode</li>\n<li>Optional strict validation</li>\n</ul>\n<h2
    id=\"registered-attributes\">Registered Attributes <a class=\"header-anchor\"
    href=\"#registered-attributes\"><svg class=\"heading-permalink\" aria-hidden=\"true\"
    ...
    List of loaded Post objects</li>\n<li><code>content_directories</code>: List of
    content source directories</li>\n</ul>\n<h2 id=\"dependencies\">Dependencies <a
    class=\"header-anchor\" href=\"#dependencies\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    id=\"load_file_content\" class=\"admonition-title\" style=\"margin: 0; padding:
    .5rem 1rem;\">load_file_content <em class=\"small\">function</em></h2>\n<p>Load
    file content without validation.</p>\n</div>\n<div class=\"admonition source is-collapsible
    ...
    class=\"w\"> </span><span class=\"nf\">load_file_content</span><span class=\"p\">(</span><span
    class=\"n\">path</span><span class=\"p\">:</span> <span class=\"n\">Path</span><span
    class=\"p\">)</span> <span class=\"o\">-&gt;</span> <span class=\"nb\">tuple</span><span
    class=\"p\">[</span><span class=\"n\">Path</span><span class=\"p\">,</span> <span
    class=\"nb\">dict</span><span class=\"p\">]:</span>\n<span class=\"w\">    </span><span
    class=\"sd\">&quot;&quot;&quot;Load file content without validation.&quot;&quot;&quot;</span>\n
    \   <span class=\"k\">try</span><span class=\"p\">:</span>\n        <span class=\"k\">with</span>
    <span class=\"nb\">open</span><span class=\"p\">(</span><span class=\"n\">path</span><span
    class=\"p\">,</span> <span class=\"s2\">&quot;r&quot;</span><span class=\"p\">)</span>
    <span class=\"k\">as</span> <span class=\"n\">f</span><span class=\"p\">:</span>\n
    \           <span class=\"n\">raw_content</span> <span class=\"o\">=</span> <span
    ...
    class=\"p\">(</span><span class=\"n\">raw_content</span><span class=\"p\">)</span>\n
    ...
    class=\"p\">[</span><span class=\"s2\">&quot;raw&quot;</span><span class=\"p\">]</span>
    <span class=\"o\">=</span> <span class=\"n\">raw_content</span>\n        <span
    class=\"k\">return</span> <span class=\"n\">path</span><span class=\"p\">,</span>
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    \       load.py\n    </h1>\n</section>    <section class=\"body\">\n        <hr
    />\n<p>The <code>markata.plugins.load</code> plugin is responsible for loading
