---
content: "---\n\nThe `markata.plugins.flat_slug` plugin handles URL slug generation
  for your articles.\nIt sanitizes special characters that don't work in browsers
  ...
  plugin:\n\n```toml\ndisabled_hooks = [\n    \"markata.plugins.flat_slug\",\n]\n```\n\nNote:
  Disabling this plugin will prevent automatic URL slug generation and sanitization.\n\n##
  Configuration\n\nConfigure the plugin behavior in your `markata.toml`:\n\n```toml\n[markata.flat_slug]\nslugify
  = true  # Set to false to disable automatic slug sanitization\n```\n\n## Functionality\n\n##
  Explicit Slug in Frontmatter\n\nIf you explicitly set the slug in the frontmatter
  of a post, markata will not\noverwrite it:\n\n```markdown\n---\ntitle: My First
  Post\nslug: /my-post\n---\n\nThis is my first post it will be at `<markata.config.url>/my-post/`\nregardless
  of filename.\n```\n\n## Automatic Slug Based on Filename\n\nBy default the flat_slug
  plugin will use the `stem` of your filename (filename without\nextension) unless
  you explicitly set your slug in frontmatter.\n\nExamples:\n* `/pages/my-post.md`
  becomes `<markata.config.url>/my-post/`\n* `/pages/blog/a-blog-post.md` becomes
  `<markata.config.url>/a-blog-post/`\n\n## Registered Attributes\n\nThe plugin registers
  the following attributes on Post objects:\n- `should_slugify`: Boolean indicating
  if the post's slug should be sanitized\n\n---\n\n!!! function\n    <h2 id=\"pre_render\"
  class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">pre_render
  <em class=\"small\">function</em></h2>\n\n    Sets the article slug if one is not
  already set in the frontmatter.\n\n???+ source \"pre_render <em class='small'>source</em>\"\n
  \   ```python\n    def pre_render(markata: \"Markata\") -> None:\n        \"\"\"\n
  \       Sets the article slug if one is not already set in the frontmatter.\n        \"\"\"\n
  \       from slugify import slugify\n\n        for article in markata.iter_articles(description=\"creating
...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>flat_slug.py</title>\n<meta
    ...
    />\n<meta name=\"description\" content=\"The   plugin handles URL slug generation
    for your articles. It sanitizes special characters that don't work in browsers
    and provides a consistent URL\u2026\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    ...
    class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n        flat_slug.py\n
    \   </h1>\n</section>    <section class=\"body\">\n        <hr />\n<p>The <code>markata.plugins.flat_slug</code>
    plugin handles URL slug generation for your articles.\nIt sanitizes special characters
    that don't work in browsers and provides a consistent\nURL structure.</p>\n<h2
    ...
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;markata.plugins.flat_slug&quot;</span><span
    class=\"p\">,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<h2
    ...
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;markata.plugins.flat_slug&quot;</span><span
    class=\"p\">,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<p>Note:
    Disabling this plugin will prevent automatic URL slug generation and sanitization.</p>\n<h2
    ...
    c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">[markata.flat_slug]</span>\n<span
    class=\"n\">slugify</span><span class=\"w\"> </span><span class=\"o\">=</span><span
    class=\"w\"> </span><span class=\"kc\">true</span><span class=\"w\">  </span><span
    class=\"c1\"># Set to false to disable automatic slug sanitization</span>\n</pre></div>\n\n</pre>\n\n<h2
    ...
    class=\"gu\">slug: /my-post</span>\n<span class=\"gu\">---</span>\n\nThis is my
    first post it will be at <span class=\"sb\">`&lt;markata.config.url&gt;/my-post/`</span>\nregardless
    ...
    plugin will use the <code>stem</code> of your filename (filename without\nextension)
    unless you explicitly set your slug in frontmatter.</p>\n<p>Examples:</p>\n<ul>\n<li><code>/pages/my-post.md</code>
    ...
    the following attributes on Post objects:</p>\n<ul>\n<li><code>should_slugify</code>:
    Boolean indicating if the post's slug should be sanitized</li>\n</ul>\n<hr />\n<div
    ...
    slug if one is not already set in the frontmatter.</p>\n</div>\n<div class=\"admonition
    ...
    class=\"sd\">    Sets the article slug if one is not already set in the frontmatter.</span>\n<span
    class=\"sd\">    &quot;&quot;&quot;</span>\n    <span class=\"kn\">from</span><span
    class=\"w\"> </span><span class=\"nn\">slugify</span><span class=\"w\"> </span><span
    class=\"kn\">import</span> <span class=\"n\">slugify</span>\n\n    <span class=\"k\">for</span>
    ...
    class=\"n\">should_slugify</span><span class=\"p\">:</span>\n            <span
    class=\"n\">article</span><span class=\"o\">.</span><span class=\"n\">slug</span>
    <span class=\"o\">=</span> <span class=\"s2\">&quot;/&quot;</span><span class=\"o\">.</span><span
    class=\"n\">join</span><span class=\"p\">([</span><span class=\"n\">slugify</span><span
    class=\"p\">(</span><span class=\"n\">s</span><span class=\"p\">)</span> <span
    class=\"k\">for</span> <span class=\"n\">s</span> <span class=\"ow\">in</span>
    <span class=\"n\">stem</span><span class=\"o\">.</span><span class=\"n\">split</span><span
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>flat_slug.py</title>\n<meta charset=\"UTF-8\"
    />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n<meta
    name=\"description\" content=\"The   plugin handles URL slug generation for your
    articles. It sanitizes special characters that don't work in browsers and provides
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    \       flat_slug.py\n    </h1>\n</section>    <section class=\"body\">\n        <hr
    />\n<p>The <code>markata.plugins.flat_slug</code> plugin handles URL slug generation
    for your articles.\nIt sanitizes special characters that don't work in browsers
