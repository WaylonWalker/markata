---
content: "The articles slug is what determines the url to your page.  It should be\nsanitized
  of special characters that do not work in the browser.\n\n\n## Explicit Slug in
  Frontmatter\n\nIf you explicitly set the slug in the frontmatter of a post, markata
  will not\noverwrite it.\n\n```markdown\n---\ntitle: My First Post\nslug: /my-post\n\n---\n\nThis
  is my first post it will be at `<markata.config.url>/my-post/`\nreguardless of filename.\n```\n\n##
  Automatic Slug Based on Filename\n\nBy default the flat_slug plugin will use the
  `stem` of your filename, which is\nthe filename without the extension, unless you
  explicitly set your slug in\nfrontmatter.\n\n* `/pages/my-post.md` becomes `<markata.config.url>/my-post/`\n*
  `/pages/blog/a-blog-post.md` becomes `<markata.config.url>/a-blog-post/`\n\n\n!!
  class <h2 id='FlatSlugConfig' class='admonition-title' style='margin:0;padding:.5rem
  1rem;'>FlatSlugConfig <em class='small'>class</em></h2>\n\n???+ source \"FlatSlugConfig
  ...
  id='FlatSlugPost' class='admonition-title' style='margin:0;padding:.5rem 1rem;'>FlatSlugPost
  <em class='small'>class</em></h2>\n\n???+ source \"FlatSlugPost <em class='small'>source</em>\"\n\n```python\n\n
  \       class FlatSlugPost(pydantic.BaseModel):\n            should_slugify: Optional[bool]
  = None\n\n            @pydantic.validator(\"should_slugify\", pre=True, always=True)\n
  \           def default_slugify(cls: \"FlatSlugPost\", v: bool, *, values: Dict)
  ...
  if one is not already set in the frontmatter.\n???+ source \"pre_render <em class='small'>source</em>\"\n\n```python\n\n
  \       def pre_render(markata: \"Markata\") -> None:\n            \"\"\"\n            Sets
  the article slug if one is not already set in the frontmatter.\n            \"\"\"\n
  \           for article in markata.iter_articles(description=\"creating slugs\"):\n
  \               stem = article.get(\n                    \"slug\",\n                    Path(article.get(\"path\",
  article.get(\"title\", \"\"))).stem,\n                )\n                if article.should_slugify:\n
  \                   article.slug = \"/\".join([slugify(s) for s in stem.split(\"/\")])\n
  \               else:\n                    article.slug = stem\n```\n\n\n!! method
  <h2 id='default_slugify' class='admonition-title' style='margin:0;padding:.5rem
  1rem;'>default_slugify <em class='small'>method</em></h2>\n\n???+ source \"default_slugify
  <em class='small'>source</em>\"\n\n```python\n\n        def default_slugify(cls:
  \"FlatSlugPost\", v: bool, *, values: Dict) -> bool:\n                if not v:\n
  \                   return cls.markata.config.flat_slug.slugify\n                return
  v\n```\n"
date: 0001-01-01
description: The articles slug is what determines the url to your page.  It should
  be If you explicitly set the slug in the frontmatter of a post, markata will not
  By defaul
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Flat_Slug.Py</title>\n<meta
  charset=\"utf-8\"/>\n<meta content=\"width=device-width, initial-scale=1\" name=\"viewport\"/>\n<meta
  content=\"The articles slug is what determines the url to your page.  It should
  be If you explicitly set the slug in the frontmatter of a post, markata will not
  By defaul\" name=\"description\"/>\n<link href=\"/static/favicon.ico\" rel=\"icon\"
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  name=\"og:type\" property=\"og:type\"/><meta content=\"The articles slug is what
  determines the url to your page.  It should be If you explicitly set the slug in
  the frontmatter of a post, markata will not By defaul\" name=\"description\" property=\"description\"/><meta
  content=\"The articles slug is what determines the url to your page.  It should
  be If you explicitly set the slug in the frontmatter of a post, markata will not
  By defaul\" name=\"og:description\" property=\"og:description\"/><meta content=\"The
  articles slug is what determines the url to your page.  It should be If you explicitly
  set the slug in the frontmatter of a post, markata will not By defaul\" name=\"twitter:description\"
  property=\"twitter:description\"/><meta content=\"Flat_Slug.Py | Markata\" name=\"og:title\"
  property=\"og:title\"/><meta content=\"Flat_Slug.Py | Markata\" name=\"twitter:title\"
  property=\"twitter:title\"/><meta content=\"https://markata.dev//markata/plugins/flat-slug-og.png\"
  name=\"og:image\" property=\"og:image\"/><meta content=\"https://markata.dev//markata/plugins/flat-slug-og.png\"
  ...
  name=\"twitter:creator\" property=\"twitter:creator\"/><meta content=\"Flat_Slug.Py\"
  name=\"title\" property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\"
  property=\"generator\"/><link href=\"https://markata.dev//markata/plugins/flat-slug/\"
  rel=\"canonical\"/><meta content=\"https://markata.dev//markata/plugins/flat-slug/\"
  ...
  round\"></div>\n</label>\n</div>\n<section class=\"title\">\n<h1 id=\"title\">\n
  \           Flat_Slug.Py \n            \n        </h1>\n</section>\n<main><p>The
  articles slug is what determines the url to your page.  It should be\nsanitized
  of special characters that do not work in the browser.</p>\n<h2 id=\"explicit-slug-in-frontmatter\">Explicit
  Slug in Frontmatter <a class=\"header-anchor\" href=\"#explicit-slug-in-frontmatter\"><svg
  ...
  1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>If you explicitly set
  the slug in the frontmatter of a post, markata will not\noverwrite it.</p>\n<pre
  ...
  /my-post\n\n---\n\nThis is my first post it will be at <span class=\"sb\">`&lt;markata.config.url&gt;/my-post/`</span>\nreguardless
  of filename.\n</pre></div>\n\n</pre>\n<h2 id=\"automatic-slug-based-on-filename\">Automatic
  Slug Based on Filename <a class=\"header-anchor\" href=\"#automatic-slug-based-on-filename\"><svg
  aria-hidden=\"true\" class=\"heading-permalink\" fill=\"currentColor\" focusable=\"false\"
  height=\"1em\" viewbox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
  d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
  5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
  ...
  19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997 0
  0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
  1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>By default the flat_slug
  plugin will use the <code>stem</code> of your filename, which is\nthe filename without
  the extension, unless you explicitly set your slug in\nfrontmatter.</p>\n<ul>\n<li><code>/pages/my-post.md</code>
  becomes <code>&lt;markata.config.url&gt;/my-post/</code></li>\n<li><code>/pages/blog/a-blog-post.md</code>
  becomes <code>&lt;markata.config.url&gt;/a-blog-post/</code></li>\n</ul>\n<p>!!
  class </p><h2 class=\"admonition-title\" id=\"FlatSlugConfig\" style=\"margin:0;padding:.5rem
  1rem;\">FlatSlugConfig <em class=\"small\">class</em></h2>\n<div class=\"admonition
  source is-collapsible collapsible-open\">\n<p class=\"admonition-title\">\"FlatSlugConfig
  ...
  <span class=\"nc\">FlatSlugConfig</span><span class=\"p\">(</span><span class=\"n\">pydantic</span><span
  class=\"o\">.</span><span class=\"n\">BaseModel</span><span class=\"p\">):</span>\n
  \           <span class=\"n\">slugify</span><span class=\"p\">:</span> <span class=\"nb\">bool</span>
  ...
  class=\"o\">.</span><span class=\"n\">BaseModel</span><span class=\"p\">):</span>\n
  \           <span class=\"n\">flat_slug</span><span class=\"p\">:</span> <span class=\"n\">FlatSlugConfig</span>
  <span class=\"o\">=</span> <span class=\"n\">FlatSlugConfig</span><span class=\"p\">()</span>\n</pre></div>\n\n</pre>\n<p>!!
  class </p><h2 class=\"admonition-title\" id=\"FlatSlugPost\" style=\"margin:0;padding:.5rem
  1rem;\">FlatSlugPost <em class=\"small\">class</em></h2>\n<div class=\"admonition
  source is-collapsible collapsible-open\">\n<p class=\"admonition-title\">\"FlatSlugPost
  <em class=\"small\">source</em>\"</p>\n</div>\n<pre class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button
  class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
  ...
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"></path></g></svg></button>\n</div>\n
  \       \n<div class=\"highlight\"><pre><span></span>        <span class=\"k\">class</span>
  <span class=\"nc\">FlatSlugPost</span><span class=\"p\">(</span><span class=\"n\">pydantic</span><span
  class=\"o\">.</span><span class=\"n\">BaseModel</span><span class=\"p\">):</span>\n
  \           <span class=\"n\">should_slugify</span><span class=\"p\">:</span> <span
  class=\"n\">Optional</span><span class=\"p\">[</span><span class=\"nb\">bool</span><span
  ...
  class=\"p\">(</span><span class=\"s2\">\"should_slugify\"</span><span class=\"p\">,</span>
  ...
  <span class=\"nf\">default_slugify</span><span class=\"p\">(</span><span class=\"bp\">cls</span><span
  class=\"p\">:</span> <span class=\"s2\">\"FlatSlugPost\"</span><span class=\"p\">,</span>
  <span class=\"n\">v</span><span class=\"p\">:</span> <span class=\"nb\">bool</span><span
  ...
  class=\"o\">.</span><span class=\"n\">flat_slug</span><span class=\"o\">.</span><span
  ...
  class=\"o\">.</span><span class=\"n\">append</span><span class=\"p\">(</span><span
  class=\"n\">FlatSlugPost</span><span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n<p>!!
  ...
  \           Sets the article slug if one is not already set in the frontmatter.</span>\n<span
  ...
  class=\"n\">description</span><span class=\"o\">=</span><span class=\"s2\">\"creating
  slugs\"</span><span class=\"p\">):</span>\n                <span class=\"n\">stem</span>
  ...
  <span class=\"n\">article</span><span class=\"o\">.</span><span class=\"n\">get</span><span
  ...
  class=\"o\">.</span><span class=\"n\">should_slugify</span><span class=\"p\">:</span>\n
  \                   <span class=\"n\">article</span><span class=\"o\">.</span><span
  class=\"n\">slug</span> <span class=\"o\">=</span> <span class=\"s2\">\"/\"</span><span
  class=\"o\">.</span><span class=\"n\">join</span><span class=\"p\">([</span><span
  class=\"n\">slugify</span><span class=\"p\">(</span><span class=\"n\">s</span><span
  class=\"p\">)</span> <span class=\"k\">for</span> <span class=\"n\">s</span> <span
  class=\"ow\">in</span> <span class=\"n\">stem</span><span class=\"o\">.</span><span
  class=\"n\">split</span><span class=\"p\">(</span><span class=\"s2\">\"/\"</span><span
  class=\"p\">)])</span>\n                <span class=\"k\">else</span><span class=\"p\">:</span>\n
  \                   <span class=\"n\">article</span><span class=\"o\">.</span><span
  class=\"n\">slug</span> <span class=\"o\">=</span> <span class=\"n\">stem</span>\n</pre></div>\n\n</pre>\n<p>!!
  method </p><h2 class=\"admonition-title\" id=\"default_slugify\" style=\"margin:0;padding:.5rem
  1rem;\">default_slugify <em class=\"small\">method</em></h2>\n<div class=\"admonition
  source is-collapsible collapsible-open\">\n<p class=\"admonition-title\">\"default_slugify
  <em class=\"small\">source</em>\"</p>\n</div>\n<pre class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button
  class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
...
!! class <h2 id='FlatSlugConfig' class='admonition-title' style='margin:0;padding:.5rem 1rem;'>FlatSlugConfig <em class='small'>class</em></h2>

???+ source "FlatSlugConfig <em class='small'>source</em>"
...
!! class <h2 id='FlatSlugPost' class='admonition-title' style='margin:0;padding:.5rem 1rem;'>FlatSlugPost <em class='small'>class</em></h2>
...
!! method <h2 id='default_slugify' class='admonition-title' style='margin:0;padding:.5rem 1rem;'>default_slugify <em class='small'>method</em></h2>

???+ source "default_slugify <em class='small'>source</em>"
