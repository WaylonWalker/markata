...
content: "None\n\n\n!! class <h2 id='Config' class='admonition-title' style='margin:0;padding:.5rem
  ...
  class <h2 id='SubroutePost' class='admonition-title' style='margin:0;padding:.5rem
  1rem;'>SubroutePost <em class='small'>class</em></h2>\n\n???+ source \"SubroutePost
  ...
  method <h2 id='relative_to_subroute' class='admonition-title' style='margin:0;padding:.5rem
  1rem;'>relative_to_subroute <em class='small'>method</em></h2>\n\n???+ source \"relative_to_subroute
  <em class='small'>source</em>\"\n\n```python\n\n        def relative_to_subroute(cls,
  v, *, values: Dict) -> Path:\n                subroute = cls.markata.config.subroute\n
  \               if subroute == Path(\"\"):\n                    return v\n\n                slug
  = Path(v)\n\n                if not slug.relative_to(subroute):\n                    return
  slug.parent / subroute / slug.stem\n                return v\n```\n"
date: 0001-01-01
...
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Subroute.Py</title>\n<meta
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  property=\"twitter:description\"/><meta content=\"Subroute.Py | Markata\" name=\"og:title\"
  property=\"og:title\"/><meta content=\"Subroute.Py | Markata\" name=\"twitter:title\"
  property=\"twitter:title\"/><meta content=\"https://markata.dev//markata/plugins/subroute-og.png\"
  name=\"og:image\" property=\"og:image\"/><meta content=\"https://markata.dev//markata/plugins/subroute-og.png\"
  ...
  name=\"twitter:creator\" property=\"twitter:creator\"/><meta content=\"Subroute.Py\"
  name=\"title\" property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\"
  property=\"generator\"/><link href=\"https://markata.dev//markata/plugins/subroute/\"
  rel=\"canonical\"/><meta content=\"https://markata.dev//markata/plugins/subroute/\"
  ...
  \           <span class=\"n\">subroute</span><span class=\"p\">:</span> <span class=\"n\">Path</span>
  <span class=\"o\">=</span> <span class=\"n\">Path</span><span class=\"p\">(</span><span
  class=\"s2\">\"\"</span><span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n<p>!!
  class </p><h2 class=\"admonition-title\" id=\"SubroutePost\" style=\"margin:0;padding:.5rem
  1rem;\">SubroutePost <em class=\"small\">class</em></h2>\n<div class=\"admonition
  source is-collapsible collapsible-open\">\n<p class=\"admonition-title\">\"SubroutePost
  ...
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"></path></g></svg></button>\n</div>\n
  \       \n<div class=\"highlight\"><pre><span></span>        <span class=\"k\">class</span>
  <span class=\"nc\">SubroutePost</span><span class=\"p\">(</span><span class=\"n\">pydantic</span><span
  class=\"o\">.</span><span class=\"n\">BaseModel</span><span class=\"p\">):</span>\n
  ...
  class=\"k\">def</span> <span class=\"nf\">relative_to_subroute</span><span class=\"p\">(</span><span
  ...
  class=\"p\">:</span>\n                <span class=\"n\">subroute</span> <span class=\"o\">=</span>
  ...
  class=\"n\">subroute</span>\n                <span class=\"k\">if</span> <span class=\"n\">subroute</span>
  <span class=\"o\">==</span> <span class=\"n\">Path</span><span class=\"p\">(</span><span
  ...
  <span class=\"ow\">not</span> <span class=\"n\">slug</span><span class=\"o\">.</span><span
  class=\"n\">relative_to</span><span class=\"p\">(</span><span class=\"n\">subroute</span><span
  class=\"p\">):</span>\n                    <span class=\"k\">return</span> <span
  class=\"n\">slug</span><span class=\"o\">.</span><span class=\"n\">parent</span>
  <span class=\"o\">/</span> <span class=\"n\">subroute</span> <span class=\"o\">/</span>
  <span class=\"n\">slug</span><span class=\"o\">.</span><span class=\"n\">stem</span>\n
  ...
  class=\"o\">.</span><span class=\"n\">append</span><span class=\"p\">(</span><span
  class=\"n\">SubroutePost</span><span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n<p>!!
  method </p><h2 class=\"admonition-title\" id=\"relative_to_subroute\" style=\"margin:0;padding:.5rem
  1rem;\">relative_to_subroute <em class=\"small\">method</em></h2>\n<div class=\"admonition
  source is-collapsible collapsible-open\">\n<p class=\"admonition-title\">\"relative_to_subroute
  <em class=\"small\">source</em>\"</p>\n</div>\n<pre class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button
  class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
  ...
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"></path></g></svg></button>\n</div>\n
  \       \n<div class=\"highlight\"><pre><span></span>        <span class=\"k\">def</span>
  <span class=\"nf\">relative_to_subroute</span><span class=\"p\">(</span><span class=\"bp\">cls</span><span
  ...
  \               <span class=\"n\">subroute</span> <span class=\"o\">=</span> <span
...
!! class <h2 id='SubroutePost' class='admonition-title' style='margin:0;padding:.5rem 1rem;'>SubroutePost <em class='small'>class</em></h2>

???+ source "SubroutePost <em class='small'>source</em>"
...
!! method <h2 id='relative_to_subroute' class='admonition-title' style='margin:0;padding:.5rem 1rem;'>relative_to_subroute <em class='small'>method</em></h2>

???+ source "relative_to_subroute <em class='small'>source</em>"
