---
content: "---\n\nThe `markata.plugins.icon_resize` plugin automatically generates
  favicons in multiple\nsizes from a single source image. This ensures your site has
  appropriate icons for\ndifferent devices and platforms.\n\n# Installation\n\nThis
  ...
  = [\n    \"markata.plugins.icon_resize\",\n]\n```\n\n# Configuration\n\nConfigure
  icon settings in your `markata.toml`:\n\n```toml\n[markata]\n# Directory for output
  ...
  (180x180)\n\n## HTML Integration\n\nThe plugin adds appropriate meta tags to your
  HTML:\n```html\n<link rel=\"icon\" type=\"image/png\" sizes=\"16x16\" href=\"/favicon-16x16.png\">\n<link
  rel=\"icon\" type=\"image/png\" sizes=\"32x32\" href=\"/favicon-32x32.png\">\n<link
  rel=\"apple-touch-icon\" sizes=\"180x180\" href=\"/apple-touch-icon.png\">\n```\n\n##
  Dependencies\n\nThis plugin depends on:\n- Pillow (PIL) for image manipulation\n\n---"
date: 2025-02-14
description: 'The `markata.plugins.icon_resize` plugin automatically generates favicons
  in multiple

  sizes from a single source image. This ensures your site has appropriate i'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>icon_resize.py</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"The `markata.plugins.icon_resize` plugin
    automatically generates favicons in multiple\nsizes from a single source image.
    This ensures your site has appropriate i\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    ...
    class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n        icon_resize.py\n
    \   </h1>\n</section>    <section class=\"body\">\n        <hr />\n<p>The <code>markata.plugins.icon_resize</code>
    plugin automatically generates favicons in multiple\nsizes from a single source
    image. This ensures your site has appropriate icons for\ndifferent devices and
    ...
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;markata.plugins.icon_resize&quot;</span><span
    class=\"p\">,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<h1
    ...
    class=\"c1\"># Directory for output files</span>\n<span class=\"n\">output_dir</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;markout&quot;</span>\n\n<span class=\"c1\"># Directory containing
    static assets</span>\n<span class=\"n\">assets_dir</span><span class=\"w\"> </span><span
    class=\"o\">=</span><span class=\"w\"> </span><span class=\"s2\">&quot;static&quot;</span>\n\n<span
    class=\"c1\"># Path to source icon file</span>\n<span class=\"n\">icon</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;static/icon.png&quot;</span>\n\n<span class=\"c1\"># Optional:
    List of icon sizes to generate</span>\n<span class=\"c1\"># Default sizes are
    provided if not specified</span>\n<span class=\"n\">icon_sizes</span><span class=\"w\">
    </span><span class=\"o\">=</span><span class=\"w\"> </span><span class=\"p\">[</span><span
    class=\"mi\">16</span><span class=\"p\">,</span><span class=\"w\"> </span><span
    class=\"mi\">32</span><span class=\"p\">,</span><span class=\"w\"> </span><span
    class=\"mi\">48</span><span class=\"p\">,</span><span class=\"w\"> </span><span
    class=\"mi\">128</span><span class=\"p\">,</span><span class=\"w\"> </span><span
    class=\"mi\">180</span><span class=\"p\">,</span><span class=\"w\"> </span><span
    class=\"mi\">192</span><span class=\"p\">,</span><span class=\"w\"> </span><span
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h1>\n<h2 id=\"icon-generation\">Icon
    Generation <a class=\"header-anchor\" href=\"#icon-generation\"><svg class=\"heading-permalink\"
    ...
    the source icon image</li>\n<li>Resizes it to multiple standard sizes</li>\n<li>Saves
    each size as a separate PNG file</li>\n<li>Generates appropriate HTML meta tags</li>\n</ol>\n<h2
    id=\"default-sizes\">Default Sizes <a class=\"header-anchor\" href=\"#default-sizes\"><svg
    class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
    height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>If not configured, generates
    these standard sizes:</p>\n<ul>\n<li>16x16: Classic favicon size</li>\n<li>32x32:
    Modern favicon size</li>\n<li>48x48: Windows taskbar</li>\n<li>128x128: Chrome
    Web Store</li>\n<li>180x180: Apple Touch icon</li>\n<li>192x192: Android homescreen</li>\n<li>512x512:
    PWA splash screen</li>\n</ul>\n<h2 id=\"output-files\">Output Files <a class=\"header-anchor\"
    href=\"#output-files\"><svg class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\"
    focusable=\"false\" height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    6.003 6.003 0 0 0-1.905 1.24l-1.731 1.721a.999.999 0 1 0 1.41 1.418l1.709-1.699a3.985
    ...
    this pattern:</p>\n<ul>\n<li><code>favicon-{size}x{size}.png</code></li>\n<li><code>favicon.ico</code>
    (16x16 and 32x32 combined)</li>\n<li><code>apple-touch-icon.png</code> (180x180)</li>\n</ul>\n<h2
    id=\"html-integration\">HTML Integration <a class=\"header-anchor\" href=\"#html-integration\"><svg
    class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
    height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>The plugin adds appropriate
    meta tags to your HTML:</p>\n<pre class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button
    class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
    x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
    0 0 115.77 122.88\" xml:space=\"preserve\"><style type=\"text/css\">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path
    ...
    class=\"s\">&quot;icon&quot;</span> <span class=\"na\">type</span><span class=\"o\">=</span><span
    class=\"s\">&quot;image/png&quot;</span> <span class=\"na\">sizes</span><span
    class=\"o\">=</span><span class=\"s\">&quot;16x16&quot;</span> <span class=\"na\">href</span><span
    class=\"o\">=</span><span class=\"s\">&quot;/favicon-16x16.png&quot;</span><span
    ...
    <span class=\"na\">href</span><span class=\"o\">=</span><span class=\"s\">&quot;/favicon-32x32.png&quot;</span><span
    class=\"p\">&gt;</span>\n<span class=\"p\">&lt;</span><span class=\"nt\">link</span>
    ...
    <span class=\"na\">href</span><span class=\"o\">=</span><span class=\"s\">&quot;/apple-touch-icon.png&quot;</span><span
  ...
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>icon_resize.py</title>\n<meta charset=\"UTF-8\"
    />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n<meta
    name=\"description\" content=\"The `markata.plugins.icon_resize` plugin automatically
    generates favicons in multiple\nsizes from a single source image. This ensures
    your site has appropriate i\" />\n <link href=\"/favicon.ico\" rel=\"icon\" type=\"image/png\"
    />\n\n<link rel=\"stylesheet\" href=\"/post.css\" />\n<link rel=\"stylesheet\"
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    \       icon_resize.py\n    </h1>\n</section>    <section class=\"body\">\n        <hr
    />\n<p>The <code>markata.plugins.icon_resize</code> plugin automatically generates
    favicons in multiple\nsizes from a single source image. This ensures your site
    has appropriate icons for\ndifferent devices and platforms.</p>\n<h1 id=\"installation\">Installation
