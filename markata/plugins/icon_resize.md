...
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Icon_Resize.Py</title>\n<meta
  ...
  content=\"Icon Resize Plugin Resized favicon to a set of common sizes. ! ???+ source
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  name=\"og:type\" property=\"og:type\"/><meta content=\"Icon Resize Plugin Resized
  favicon to a set of common sizes. ! ???+ source  ! ???+ source  ! ???+ source  !
  ???+ source  ! ???+ source  ! ???+ source \" name=\"description\" property=\"description\"/><meta
  content=\"Icon Resize Plugin Resized favicon to a set of common sizes. ! ???+ source
  \ ! ???+ source  ! ???+ source  ! ???+ source  ! ???+ source  ! ???+ source \" name=\"og:description\"
  property=\"og:description\"/><meta content=\"Icon Resize Plugin Resized favicon
  to a set of common sizes. ! ???+ source  ! ???+ source  ! ???+ source  ! ???+ source
  \ ! ???+ source  ! ???+ source \" name=\"twitter:description\" property=\"twitter:description\"/><meta
  content=\"Icon_Resize.Py | Markata\" name=\"og:title\" property=\"og:title\"/><meta
  content=\"Icon_Resize.Py | Markata\" name=\"twitter:title\" property=\"twitter:title\"/><meta
  content=\"https://markata.dev//markata/plugins/icon-resize-og.png\" name=\"og:image\"
  property=\"og:image\"/><meta content=\"https://markata.dev//markata/plugins/icon-resize-og.png\"
  ...
  name=\"twitter:creator\" property=\"twitter:creator\"/><meta content=\"Icon_Resize.Py\"
  name=\"title\" property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\"
  property=\"generator\"/><link href=\"https://markata.dev//markata/plugins/icon-resize/\"
  rel=\"canonical\"/><meta content=\"https://markata.dev//markata/plugins/icon-resize/\"
  ...
  class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span class=\"s2\">\"static\"</span>\n<span
  class=\"n\">icon</span><span class=\"w\"> </span><span class=\"o\">=</span><span
  class=\"w\"> </span><span class=\"s2\">\"static/icon.png\"</span>\n</pre></div>\n\n</pre>\n<p>!!
  ...
  <span class=\"n\">values</span><span class=\"p\">:</span> <span class=\"n\">Dict</span><span
  class=\"p\">)</span> <span class=\"o\">-&gt;</span> <span class=\"n\">Path</span><span
  class=\"p\">:</span>\n                <span class=\"k\">if</span> <span class=\"n\">v</span>
  <span class=\"ow\">is</span> <span class=\"kc\">None</span><span class=\"p\">:</span>\n
  \                   <span class=\"k\">return</span>\n                <span class=\"k\">if</span>
  <span class=\"n\">v</span><span class=\"o\">.</span><span class=\"n\">exists</span><span
  ...
  <span class=\"n\">icon</span><span class=\"o\">.</span><span class=\"n\">exists</span><span
  class=\"p\">():</span>\n                    <span class=\"k\">return</span> <span
  class=\"n\">icon</span>\n                <span class=\"k\">else</span><span class=\"p\">:</span>\n
  \                   <span class=\"k\">raise</span> <span class=\"ne\">FileNotFoundError</span><span
  ...
  class=\"p\">(</span><span class=\"s2\">\"icon_out_file\"</span><span class=\"p\">,</span>
  ...
  <span class=\"nf\">default_icon_out_file</span><span class=\"p\">(</span><span class=\"bp\">cls</span><span
  ...
  class=\"n\">config</span><span class=\"o\">.</span><span class=\"n\">icon</span>
  <span class=\"ow\">is</span> <span class=\"kc\">None</span><span class=\"p\">:</span>\n
  ...
  class=\"nb\">int</span><span class=\"p\">(</span><span class=\"nb\">float</span><span
  ...
  class=\"k\">as</span> <span class=\"n\">img</span><span class=\"p\">:</span>\n                    <span
  ...
  class=\"p\">])))</span>\n                    <span class=\"n\">img</span> <span
  class=\"o\">=</span> <span class=\"n\">img</span><span class=\"o\">.</span><span
  ...
  <span class=\"n\">filename</span>\n                    <span class=\"k\">if</span>
  <span class=\"n\">out_file</span><span class=\"o\">.</span><span class=\"n\">exists</span><span
  ...
  id=\"ensure_icon_exists\" style=\"margin:0;padding:.5rem 1rem;\">ensure_icon_exists
  ...
  \               <span class=\"n\">icon</span> <span class=\"o\">=</span> <span class=\"n\">Path</span><span
  ...
  class=\"n\">icon</span><span class=\"o\">.</span><span class=\"n\">exists</span><span
  class=\"p\">():</span>\n                    <span class=\"k\">return</span> <span
  class=\"n\">icon</span>\n                <span class=\"k\">else</span><span class=\"p\">:</span>\n
  \                   <span class=\"k\">raise</span> <span class=\"ne\">FileNotFoundError</span><span
  class=\"p\">(</span><span class=\"n\">v</span><span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n<p>!!
  method </p><h2 class=\"admonition-title\" id=\"default_icon_out_file\" style=\"margin:0;padding:.5rem
  1rem;\">default_icon_out_file <em class=\"small\">method</em></h2>\n<div class=\"admonition
  source is-collapsible collapsible-open\">\n<p class=\"admonition-title\">\"default_icon_out_file
  <em class=\"small\">source</em>\"</p>\n</div>\n<pre class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button
  class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
