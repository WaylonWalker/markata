---
content: "---\n\nThe `markata.plugins.docs` plugin automatically generates documentation
  pages from Python\nsource code docstrings. It parses Python files, extracts docstrings
  ...
  is included in the default plugin set, to disable it you must explicitly\nadd it
  to the disabled_hooks list if you are using the 'default' plugin:\n\n```toml\ndisabled_hooks
  = [\n    \"markata.plugins.docs\",\n]\n```\n\n## Configuration\n\nConfigure documentation
  generation in your `markata.toml`:\n\n```toml\n[markata.docs]\n# Directories containing
  ...
  definitions and their docstrings\n- `functions`: List of function definitions and
  ...
  function\n    <h2 id=\"glob\" class=\"admonition-title\" style=\"margin: 0; padding:
  .5rem 1rem;\">glob <em class=\"small\">function</em></h2>\n\n    finds k\n\n    ##
  Parameters\n\n    `markata` the markata object\n\n???+ source \"glob <em class='small'>source</em>\"\n
  \   ```python\n    def glob(markata: \"MarkataDocs\") -> None:\n        \"\"\"\n
  \       finds k\n\n        ## Parameters\n\n        `markata` the markata object\n\n
  \       \"\"\"\n\n        import glob\n\n        markata.py_files = [Path(f) for
  f in glob.glob(\"**/*.py\", recursive=True)]\n\n        content_directories = list({f.parent
  for f in markata.py_files})\n        if \"content_directories\" in markata.__dict__:\n
  ...
  \       similar to [glob](../glob)\n        \"\"\"\n        # if \"articles\" not
  in markata.__dict__:\n        #     markata.articles = []\n        for py_file in
  markata.py_files:\n            with markata.cache as cache:\n                markata.articles.append(make_article(markata,
  py_file, cache))\n    ```"
date: 2025-05-05
...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>docs.py</title>\n<meta charset=\"UTF-8\"
    ...
    name=\"description\" content=\"The   plugin automatically generates documentation
    pages from Python source code docstrings. It parses Python files, extracts docstrings
    ...
    documentation pages from Python source code docstrings. It parses Python files,
    ...
    class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n        docs.py\n
    \   </h1>\n</section>    <section class=\"body\">\n        <hr />\n<p>The <code>markata.plugins.docs</code>
    plugin automatically generates documentation pages from Python\nsource code docstrings.
    It parses Python files, extracts docstrings and code structure,\nand creates markdown
    ...
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;markata.plugins.docs&quot;</span><span
    class=\"p\">,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<h2
    ...
    generation in your <code>markata.toml</code>:</p>\n<pre class='wrapper'>\n\n<div
    class='copy-wrapper'>\n\n<button class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
    x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
    0 0 115.77 122.88\" xml:space=\"preserve\"><style type=\"text/css\">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path
    ...
    c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">[markata.docs]</span>\n<span
    class=\"c1\"># Directories containing Python files to document</span>\n<span class=\"n\">content_directories</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;markata&quot;</span><span
    class=\"p\">,</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;tests&quot;</span>\n<span
    class=\"p\">]</span>\n\n<span class=\"c1\"># Template for generated documentation</span>\n<span
    class=\"n\">template</span><span class=\"w\"> </span><span class=\"o\">=</span><span
    class=\"w\"> </span><span class=\"s2\">&quot;docs/template.md.j2&quot;</span>\n</pre></div>\n\n</pre>\n\n<h2
    id=\"template-variables\">Template Variables <a class=\"header-anchor\" href=\"#template-variables\"><svg
    class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
    height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>The following variables
    are available in documentation templates:</p>\n<ul>\n<li><code>module</code>:
    Module name</li>\n<li><code>docstring</code>: Module docstring</li>\n<li><code>classes</code>:
    List of class definitions and their docstrings</li>\n<li><code>functions</code>:
    List of function definitions and their docstrings</li>\n<li><code>source</code>:
    Path to source file</li>\n<li><code>ast</code>: Abstract Syntax Tree of the module</li>\n</ul>\n<h2
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<h2 id=\"documentation-generation\">Documentation
    Generation <a class=\"header-anchor\" href=\"#documentation-generation\"><svg
    class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
    height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>The plugin:</p>\n<ol>\n<li>Finds
    Python files in configured directories</li>\n<li>Parses files using Python's AST</li>\n<li>Extracts
    docstrings and code structure</li>\n<li>Applies templates to generate markdown</li>\n<li>Creates
    documentation pages in the output directory</li>\n</ol>\n<h2 id=\"ast-analysis\">AST
    Analysis <a class=\"header-anchor\" href=\"#ast-analysis\"><svg class=\"heading-permalink\"
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>The plugin adds these
    attributes to Markata:</p>\n<ul>\n<li><code>py_files</code>: List of Python files
    being documented</li>\n<li><code>content_directories</code>: List of directories
    ...
    on:</p>\n<ul>\n<li>ast (Python standard library) for code parsing</li>\n<li>jinja2
    for template rendering</li>\n</ul>\n<hr />\n<div class=\"admonition function\">\n<p
    class=\"admonition-title\">Function</p>\n<h2 id=\"glob\" class=\"admonition-title\"
    style=\"margin: 0; padding: .5rem 1rem;\">glob <em class=\"small\">function</em></h2>\n<p>finds
    k</p>\n<h2 id=\"parameters\">Parameters <a class=\"header-anchor\" href=\"#parameters\"><svg
    class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
    height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    class=\"w\"> </span><span class=\"nf\">glob</span><span class=\"p\">(</span><span
    class=\"n\">markata</span><span class=\"p\">:</span> <span class=\"s2\">&quot;MarkataDocs&quot;</span><span
    ...
    <span class=\"n\">glob</span><span class=\"o\">.</span><span class=\"n\">glob</span><span
    class=\"p\">(</span><span class=\"s2\">&quot;**/*.py&quot;</span><span class=\"p\">,</span>
    <span class=\"n\">recursive</span><span class=\"o\">=</span><span class=\"kc\">True</span><span
    class=\"p\">)]</span>\n\n    <span class=\"n\">content_directories</span> <span
    ...
    <span class=\"o\">=</span> <span class=\"n\">content_directories</span>\n\n    <span
    class=\"k\">try</span><span class=\"p\">:</span>\n        <span class=\"n\">ignore</span>
    <span class=\"o\">=</span> <span class=\"kc\">True</span>\n    <span class=\"k\">except</span>
    <span class=\"ne\">KeyError</span><span class=\"p\">:</span>\n        <span class=\"n\">ignore</span>
    <span class=\"o\">=</span> <span class=\"kc\">True</span>\n\n    <span class=\"k\">if</span>
    <span class=\"n\">ignore</span> <span class=\"ow\">and</span> <span class=\"p\">(</span><span
    ...
    </span><span class=\"nn\">pathspec</span>\n\n        <span class=\"n\">lines</span>
    ...
    class=\"o\">.</span><span class=\"n\">read_text</span><span class=\"p\">()</span><span
    class=\"o\">.</span><span class=\"n\">splitlines</span><span class=\"p\">())</span>\n\n
    \   <span class=\"n\">spec</span> <span class=\"o\">=</span> <span class=\"n\">pathspec</span><span
    ...
    id=\"load\" class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">load
    ...
    \   <span class=\"c1\"># if &quot;articles&quot; not in markata.__dict__:</span>\n
    \   <span class=\"c1\">#     markata.articles = []</span>\n    <span class=\"k\">for</span>
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    \       docs.py\n    </h1>\n</section>    <section class=\"body\">\n        <hr
    />\n<p>The <code>markata.plugins.docs</code> plugin automatically generates documentation
    pages from Python\nsource code docstrings. It parses Python files, extracts docstrings
    and code structure,\nand creates markdown documentation.</p>\n<h2 id=\"installation\">Installation
