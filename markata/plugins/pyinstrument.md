...
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Pyinstrument.Py</title>\n<meta
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  name=\"og:type\" property=\"og:type\"/><meta content=\"Markata plugin to create
  a pyinstrument profile if pyinstrument is installed. The profile will be saved to
  \ ! ???+ source  ! ???+ source  ! ???+ source  ! ???+ \" name=\"description\" property=\"description\"/><meta
  content=\"Markata plugin to create a pyinstrument profile if pyinstrument is installed.
  The profile will be saved to  ! ???+ source  ! ???+ source  ! ???+ source  ! ???+
  \" name=\"og:description\" property=\"og:description\"/><meta content=\"Markata
  plugin to create a pyinstrument profile if pyinstrument is installed. The profile
  will be saved to  ! ???+ source  ! ???+ source  ! ???+ source  ! ???+ \" name=\"twitter:description\"
  property=\"twitter:description\"/><meta content=\"Pyinstrument.Py | Markata\" name=\"og:title\"
  property=\"og:title\"/><meta content=\"Pyinstrument.Py | Markata\" name=\"twitter:title\"
  property=\"twitter:title\"/><meta content=\"https://markata.dev//markata/plugins/pyinstrument-og.png\"
  name=\"og:image\" property=\"og:image\"/><meta content=\"https://markata.dev//markata/plugins/pyinstrument-og.png\"
  ...
  name=\"twitter:creator\" property=\"twitter:creator\"/><meta content=\"Pyinstrument.Py\"
  name=\"title\" property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\"
  property=\"generator\"/><link href=\"https://markata.dev//markata/plugins/pyinstrument/\"
  rel=\"canonical\"/><meta content=\"https://markata.dev//markata/plugins/pyinstrument/\"
  ...
  </p><h2 class=\"admonition-title\" id=\"ProfilerConfig\" style=\"margin:0;padding:.5rem
  1rem;\">ProfilerConfig <em class=\"small\">class</em></h2>\n<div class=\"admonition
  ...
  class=\"n\">SHOULD_PROFILE</span>\n            <span class=\"n\">profiler</span><span
  class=\"p\">:</span> <span class=\"n\">Optional</span><span class=\"p\">[</span>\n
  \               <span class=\"n\">Any</span>\n            <span class=\"p\">]</span>
  <span class=\"o\">=</span> <span class=\"kc\">None</span>  <span class=\"c1\">#
  No valicator for type pyinstrument.profiler.Profiler</span>\n            <span class=\"n\">output_file</span><span
  ...
  <span class=\"s2\">\"_profile\"</span> <span class=\"o\">/</span> <span class=\"s2\">\"index.html\"</span>\n
  ...
  class=\"o\">.</span><span class=\"n\">BaseModel</span><span class=\"p\">):</span>\n
  \           <span class=\"n\">profiler</span><span class=\"p\">:</span> <span class=\"n\">ProfilerConfig</span>
  <span class=\"o\">=</span> <span class=\"n\">ProfilerConfig</span><span class=\"p\">()</span>\n</pre></div>\n\n</pre>\n<p>!!
  ...
  class=\"s2\">\"[red]to enable profiler [wheat1][itallic]pip install 'markata\\[pyinstrument]'\"</span><span
  class=\"p\">,</span>\n                            <span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"teardown\" style=\"margin:0;padding:.5rem
  1rem;\">teardown <em class=\"small\">function</em></h2>\nstop the profiler on exit\n<div
  ...
  class=\"o\">.</span><span class=\"n\">profiler</span><span class=\"o\">.</span><span
  class=\"n\">stop</span><span class=\"p\">()</span>\n</pre></div>\n\n</pre>\n<p>!!
  method </p><h2 class=\"admonition-title\" id=\"validate_output_file\" style=\"margin:0;padding:.5rem
  1rem;\">validate_output_file <em class=\"small\">method</em></h2>\n<div class=\"admonition
  ...
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"></path></g></svg></button>\n</div>\n
  \       \n<div class=\"highlight\"><pre><span></span>        <span class=\"k\">def</span>
  <span class=\"nf\">validate_output_file</span><span class=\"p\">(</span><span class=\"bp\">cls</span><span
