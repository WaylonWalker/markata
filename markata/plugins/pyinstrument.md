---
content: "---\n\nThe `markata.plugins.pyinstrument` plugin adds performance profiling
  capabilities using\npyinstrument. It generates detailed HTML reports showing where
  your build spends time.\n\n## Installation\n\nThis plugin is built-in but not enabled
  by default. Add it to your plugins list:\n\n```toml\nhooks = [\n    \"markata.plugins.pyinstrument\",\n]\n```\n\nYou
  must also install pyinstrument:\n```bash\npip install pyinstrument\n```\n\n## Uninstallation\n\nRemove
  the plugin from your hooks list in `markata.toml`:\n\n```toml\nhooks = [\n    #
  Remove or comment out the line below\n    # \"markata.plugins.pyinstrument\",\n]\n```\n\n##
  Configuration\n\nConfigure profiling in `markata.toml`:\n\n```toml\n[markata.profiler]\n#
  Enable/disable profiling\nshould_profile = true\n\n# Output location (relative to
  output_dir)\noutput_file = \"_profile/index.html\"\n\n# Profile options\ninterval
  = 0.001\nasync_mode = \"enabled\"\nshow_all = false\ntimeline = false\n```\n\n##
  Functionality\n\n## Profiling Features\n\nThe plugin:\n1. Profiles the entire build
  ...
  \                           \"profiler not available, skipping save pyinstrument
  save\",\n                        )\n                        markata.console.log(\n
  \                           r\"[red]to enable profiler [wheat1][itallic]pip install
  'markata\\[pyinstrument]'\",\n                        )\n    ```\n!!! function\n
  \   <h2 id=\"teardown\" class=\"admonition-title\" style=\"margin: 0; padding: .5rem
  ...
  \                   markata.config.profiler.profiler.stop()\n    ```\n!!! method\n
  \   <h2 id=\"ensure_output_dir_exists\" class=\"admonition-title\" style=\"margin:
  0; padding: .5rem 1rem;\">ensure_output_dir_exists <em class=\"small\">method</em></h2>\n\n
  \   Ensure output directory exists, creating it if necessary.\n\n???+ source \"ensure_output_dir_exists
  <em class='small'>source</em>\"\n    ```python\n    def ensure_output_dir_exists(cls,
...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>pyinstrument.py</title>\n<meta
    ...
    />\n<meta name=\"description\" content=\"The   plugin adds performance profiling
    capabilities using pyinstrument. It generates detailed HTML reports showing where
    your build spends time. Installation\u2026\" />\n <link href=\"/favicon.ico\"
    ...
    class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n        pyinstrument.py\n
    \   </h1>\n</section>    <section class=\"body\">\n        <hr />\n<p>The <code>markata.plugins.pyinstrument</code>
    plugin adds performance profiling capabilities using\npyinstrument. It generates
    detailed HTML reports showing where your build spends time.</p>\n<h2 id=\"installation\">Installation
    ...
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;markata.plugins.pyinstrument&quot;</span><span
    class=\"p\">,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<p>You
    must also install pyinstrument:</p>\n<pre class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button
    ...
    class=\"w\"> </span>pyinstrument\n</pre></div>\n\n</pre>\n\n<h2 id=\"uninstallation\">Uninstallation
    <a class=\"header-anchor\" href=\"#uninstallation\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    &quot;markata.plugins.pyinstrument&quot;,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<h2
    ...
    c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">[markata.profiler]</span>\n<span
    class=\"c1\"># Enable/disable profiling</span>\n<span class=\"n\">should_profile</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"kc\">true</span>\n\n<span class=\"c1\"># Output location (relative to
    output_dir)</span>\n<span class=\"n\">output_file</span><span class=\"w\"> </span><span
    class=\"o\">=</span><span class=\"w\"> </span><span class=\"s2\">&quot;_profile/index.html&quot;</span>\n\n<span
    class=\"c1\"># Profile options</span>\n<span class=\"n\">interval</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"mf\">0.001</span>\n<span class=\"n\">async_mode</span><span class=\"w\">
    </span><span class=\"o\">=</span><span class=\"w\"> </span><span class=\"s2\">&quot;enabled&quot;</span>\n<span
    class=\"n\">show_all</span><span class=\"w\"> </span><span class=\"o\">=</span><span
    class=\"w\"> </span><span class=\"kc\">false</span>\n<span class=\"n\">timeline</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<h2 id=\"profiling-features\">Profiling
    Features <a class=\"header-anchor\" href=\"#profiling-features\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>The plugin:</p>\n<ol>\n<li>Profiles
    the entire build process</li>\n<li>Generates HTML reports</li>\n<li>Shows time
    distribution</li>\n<li>Identifies bottlenecks</li>\n</ol>\n<h2 id=\"report-generation\">Report
    Generation <a class=\"header-anchor\" href=\"#report-generation\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Creates reports with:</p>\n<ul>\n<li>Call
    tree visualization</li>\n<li>Time percentages</li>\n<li>Function details</li>\n<li>Stack
    traces</li>\n</ul>\n<h3>Configuration Options</h3>\n<p>Supports:</p>\n<ul>\n<li>Custom
    output paths</li>\n<li>Sampling intervals</li>\n<li>Async mode settings</li>\n<li>Display
    options</li>\n<li>Timeline view</li>\n</ul>\n<h2 id=\"performance-impact\">Performance
    Impact <a class=\"header-anchor\" href=\"#performance-impact\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Note:</p>\n<ul>\n<li>Minimal
    overhead</li>\n<li>Configurable precision</li>\n<li>Optional async profiling</li>\n<li>Selective
    ...
    on:</p>\n<ul>\n<li>pyinstrument for profiling</li>\n<li>pydantic for configuration</li>\n</ul>\n<hr
    ...
    <em class=\"small\">function</em></h2>\n<p>stop the profiler and save as late
    ...
    class=\"p\">:</span>\n    <span class=\"s2\">&quot;stop the profiler and save
    as late as possible&quot;</span>\n    <span class=\"k\">if</span> <span class=\"n\">markata</span><span
    ...
    class=\"o\">.</span><span class=\"n\">profiler</span><span class=\"o\">.</span><span
    class=\"n\">output_html</span><span class=\"p\">()</span>\n                    <span
    class=\"n\">markata</span><span class=\"o\">.</span><span class=\"n\">config</span><span
    class=\"o\">.</span><span class=\"n\">profiler</span><span class=\"o\">.</span><span
    ...
    class=\"o\">.</span><span class=\"n\">config</span><span class=\"o\">.</span><span
    class=\"n\">profiler</span><span class=\"o\">.</span><span class=\"n\">profiler</span><span
    class=\"o\">.</span><span class=\"n\">output_text</span><span class=\"p\">()</span>\n
    ...
    class=\"n\">markata</span><span class=\"o\">.</span><span class=\"n\">console</span><span
    class=\"o\">.</span><span class=\"n\">log</span><span class=\"p\">(</span>\n                        <span
    class=\"sa\">r</span><span class=\"s2\">&quot;[red]to enable profiler [wheat1][itallic]pip
    install &#39;markata\\[pyinstrument]&#39;&quot;</span><span class=\"p\">,</span>\n
    \                   <span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n\n</div>\n<div
    class=\"admonition function\">\n<p class=\"admonition-title\">Function</p>\n<h2
    id=\"teardown\" class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">teardown
    <em class=\"small\">function</em></h2>\n<p>stop the profiler on exit</p>\n</div>\n<div
    ...
    \       <span class=\"k\">if</span> <span class=\"n\">markata</span><span class=\"o\">.</span><span
    class=\"n\">config</span><span class=\"o\">.</span><span class=\"n\">profiler</span><span
    class=\"o\">.</span><span class=\"n\">profiler</span> <span class=\"ow\">is</span>
    ...
    class=\"admonition method\">\n<p class=\"admonition-title\">Method</p>\n<h2 id=\"ensure_output_dir_exists\"
    class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">ensure_output_dir_exists
    <em class=\"small\">method</em></h2>\n<p>Ensure output directory exists, creating
    it if necessary.</p>\n</div>\n<div class=\"admonition source is-collapsible collapsible-open\">\n<p
    class=\"admonition-title\">ensure_output_dir_exists <em class='small'>source</em></p>\n<pre
    ...
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">def</span><span
    class=\"w\"> </span><span class=\"nf\">ensure_output_dir_exists</span><span class=\"p\">(</span><span
    class=\"bp\">cls</span><span class=\"p\">,</span> <span class=\"n\">v</span><span
    class=\"p\">:</span> <span class=\"n\">Union</span><span class=\"p\">[</span><span
    class=\"nb\">str</span><span class=\"p\">,</span> <span class=\"n\">Path</span><span
    class=\"p\">])</span> <span class=\"o\">-&gt;</span> <span class=\"n\">Path</span><span
    class=\"p\">:</span>\n<span class=\"w\">        </span><span class=\"sd\">&quot;&quot;&quot;Ensure
    output directory exists, creating it if necessary.&quot;&quot;&quot;</span>\n
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    \       pyinstrument.py\n    </h1>\n</section>    <section class=\"body\">\n        <hr
    />\n<p>The <code>markata.plugins.pyinstrument</code> plugin adds performance profiling
    capabilities using\npyinstrument. It generates detailed HTML reports showing where
    your build spends time.</p>\n<h2 id=\"installation\">Installation <a class=\"header-anchor\"
