...
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Publish_Source.Py</title>\n<meta
  ...
  content=\"Writes the final modified markdown and frontmatter to the output directory.
  The only configuration for the publish ! ! ! ! ???+ source \" name=\"description\"/>\n<link
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  name=\"og:type\" property=\"og:type\"/><meta content=\"Writes the final modified
  markdown and frontmatter to the output directory. The only configuration for the
  publish ! ! ! ! ???+ source \" name=\"description\" property=\"description\"/><meta
  content=\"Writes the final modified markdown and frontmatter to the output directory.
  The only configuration for the publish ! ! ! ! ???+ source \" name=\"og:description\"
  property=\"og:description\"/><meta content=\"Writes the final modified markdown
  and frontmatter to the output directory. The only configuration for the publish
  ! ! ! ! ???+ source \" name=\"twitter:description\" property=\"twitter:description\"/><meta
  content=\"Publish_Source.Py | Markata\" name=\"og:title\" property=\"og:title\"/><meta
  content=\"Publish_Source.Py | Markata\" name=\"twitter:title\" property=\"twitter:title\"/><meta
  content=\"https://markata.dev//markata/plugins/publish-source-og.png\" name=\"og:image\"
  property=\"og:image\"/><meta content=\"https://markata.dev//markata/plugins/publish-source-og.png\"
  ...
  name=\"twitter:creator\" property=\"twitter:creator\"/><meta content=\"Publish_Source.Py\"
  name=\"title\" property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\"
  property=\"generator\"/><link href=\"https://markata.dev//markata/plugins/publish-source/\"
  rel=\"canonical\"/><meta content=\"https://markata.dev//markata/plugins/publish-source/\"
  ...
  round\"></div>\n</label>\n</div>\n<section class=\"title\">\n<h1 id=\"title\">\n
  \           Publish_Source.Py \n            \n        </h1>\n</section>\n<main><p>Writes
  the final modified markdown and frontmatter to the output directory.\nReplacing
  the trailing slash if its there and adding .md will bring up the raw\nsource.</p>\n<h2
  ...
  note\">\n<p class=\"admonition-title\">Note</p>\n<p>publish_source is included by
  default, but if you have not included the\ndefault set of hooks you will need to
  explicitly add it.</p>\n</div>\n<p>!! function </p><h2 class=\"admonition-title\"
  id=\"_save\" style=\"margin:0;padding:.5rem 1rem;\">_save <em class=\"small\">function</em></h2>\nsaves
  the article to the output directory at its specified slug.\n<div class=\"admonition
  ...
  \           saves the article to the output directory at its specified slug.</span>\n<span
  ...
  class=\"k\">return</span> <span class=\"n\">_article</span>\n</pre></div>\n\n</pre>\n<p>!!
  ...
  to the output site as markdown.\n<pre><code>!!! note\n    Any keys that are not
  yaml serializable will be stripped.\n</code></pre>\n<div class=\"admonition source
  ...
  class=\"w\">            </span><span class=\"sd\">\"\"\"</span>\n<span class=\"sd\">
  \           Saves the final modified post to the output site as markdown.</span>\n\n<span
  class=\"sd\">            !!! note</span>\n<span class=\"sd\">                Any
