---
content: "---\n\nThe `markata.plugins.mdit_details` plugin adds support for collapsible
  details/summary\nsections in markdown using the `???` syntax. This is similar to
  HTML's `<details>` element\nbut with a more markdown-friendly syntax.\n\n# Installation\n\nThis
  ...
  = [\n    \"markata.plugins.mdit_details\",\n]\n```\n\n# Configuration\n\nThis plugin
  requires no explicit configuration. It automatically processes details\nblocks in
  your markdown content.\n\n# Functionality\n\n## Basic Usage\n\nCreate collapsible
  sections:\n```markdown\n??? note \"Optional Title\"\n    This content will be collapsible.\n
  \   It can contain *any* markdown.\n\n???+ note \"Open by Default\"\n    The + symbol
  makes this section expanded by default.\n```\n\n## Supported Styles\n\nDefault styles
  include:\n- note\n- info\n- warning\n- danger\n- success\n- question\n- abstract\n-
  example\n\n## Syntax Options\n\nThe plugin supports:\n- Basic: `??? type`\n- With
  title: `??? type \"Custom Title\"`\n- Open by default: `???+ type`\n- No title:
  Title defaults to capitalized type\n\n## HTML Output\n\nGenerated HTML structure:\n```html\n<details
  class=\"details type\">\n  <summary>Title Text</summary>\n  <div class=\"details-content\">\n
  \   <!-- Markdown content -->\n  </div>\n</details>\n```\n\n## Nesting Support\n\nDetails
  blocks can be nested:\n```markdown\n??? outer \"Outer Section\"\n    Some content\n\n
  \   ??? inner \"Inner Section\"\n        Nested content\n```\n\n## Dependencies\n\nThis
  plugin depends on:\n- markdown-it-py for markdown parsing\n- The `render_markdown`
  plugin for final HTML output\n\n---\n\n\n\n\n\n\n\n\n\n!!! function\n    <h2 id=\"details_plugin\"
  class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">details_plugin
...
date: 2025-02-14
description: 'The `markata.plugins.mdit_details` plugin adds support for collapsible
  details/summary

  sections in markdown using the `???` syntax. This is similar to HTML&#x27'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>mdit_details.py</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"The `markata.plugins.mdit_details` plugin
    adds support for collapsible details/summary\nsections in markdown using the `???`
    syntax. This is similar to HTML&#x27\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    ...
    class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n        mdit_details.py\n
    \   </h1>\n</section>    <section class=\"body\">\n        <hr />\n<p>The <code>markata.plugins.mdit_details</code>
    plugin adds support for collapsible details/summary\nsections in markdown using
    the <code>???</code> syntax. This is similar to HTML's <code>&lt;details&gt;</code>
    element\nbut with a more markdown-friendly syntax.</p>\n<h1 id=\"installation\">Installation
    ...
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;markata.plugins.mdit_details&quot;</span><span
    class=\"p\">,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<h1
    ...
    no explicit configuration. It automatically processes details\nblocks in your
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h1>\n<h2 id=\"basic-usage\">Basic
    Usage <a class=\"header-anchor\" href=\"#basic-usage\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Create collapsible sections:</p>\n<pre
    ...
    c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span>??? note &quot;Optional Title&quot;\n
    \   This content will be collapsible.\n    It can contain <span class=\"ge\">*any*</span>
    markdown.\n\n???+ note &quot;Open by Default&quot;\n    The + symbol makes this
    section expanded by default.\n</pre></div>\n\n</pre>\n\n<h2 id=\"supported-styles\">Supported
    Styles <a class=\"header-anchor\" href=\"#supported-styles\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Default styles include:</p>\n<ul>\n<li>note</li>\n<li>info</li>\n<li>warning</li>\n<li>danger</li>\n<li>success</li>\n<li>question</li>\n<li>abstract</li>\n<li>example</li>\n</ul>\n<h2
    id=\"syntax-options\">Syntax Options <a class=\"header-anchor\" href=\"#syntax-options\"><svg
    class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
    height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    <code>??? type</code></li>\n<li>With title: <code>??? type &quot;Custom Title&quot;</code></li>\n<li>Open
    by default: <code>???+ type</code></li>\n<li>No title: Title defaults to capitalized
    type</li>\n</ul>\n<h2 id=\"html-output\">HTML Output <a class=\"header-anchor\"
    href=\"#html-output\"><svg class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\"
    ...
    class=\"nt\">details</span> <span class=\"na\">class</span><span class=\"o\">=</span><span
    class=\"s\">&quot;details type&quot;</span><span class=\"p\">&gt;</span>\n  <span
    class=\"p\">&lt;</span><span class=\"nt\">summary</span><span class=\"p\">&gt;</span>Title
    Text<span class=\"p\">&lt;/</span><span class=\"nt\">summary</span><span class=\"p\">&gt;</span>\n
    \ <span class=\"p\">&lt;</span><span class=\"nt\">div</span> <span class=\"na\">class</span><span
    class=\"o\">=</span><span class=\"s\">&quot;details-content&quot;</span><span
    class=\"p\">&gt;</span>\n    <span class=\"cm\">&lt;!-- Markdown content --&gt;</span>\n
    \ <span class=\"p\">&lt;/</span><span class=\"nt\">div</span><span class=\"p\">&gt;</span>\n<span
    class=\"p\">&lt;/</span><span class=\"nt\">details</span><span class=\"p\">&gt;</span>\n</pre></div>\n\n</pre>\n\n<h2
    id=\"nesting-support\">Nesting Support <a class=\"header-anchor\" href=\"#nesting-support\"><svg
    class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
    height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span>??? outer &quot;Outer Section&quot;\n
    \   Some content\n\n    ??? inner &quot;Inner Section&quot;\n        Nested content\n</pre></div>\n\n</pre>\n\n<h2
    ...
    class=\"admonition-title\">Function</p>\n<h2 id=\"details_plugin\" class=\"admonition-title\"
    style=\"margin: 0; padding: .5rem 1rem;\">details_plugin <em class=\"small\">function</em></h2>\n<p>Plugin
    to use\n<code>python-markdown style detailss &lt;https://python-markdown.github.io/extensions/details&gt;</code>_.</p>\n<p>..
    code-block:: md</p>\n<pre><code>??? note\n    *content*\n</code></pre>\n<p>Note,
    this is ported from\n<code>markdown-it-admon &lt;https://github.com/commenthol/markdown-it-admon&gt;</code>_.</p>\n</div>\n<div
    ...
    class=\"w\"> </span><span class=\"nf\">details_plugin</span><span class=\"p\">(</span><span
    ...
    <span class=\"n\">Optional</span><span class=\"p\">[</span><span class=\"n\">Callable</span><span
    class=\"p\">]</span> <span class=\"o\">=</span> <span class=\"kc\">None</span><span
    class=\"p\">)</span> <span class=\"o\">-&gt;</span> <span class=\"kc\">None</span><span
    class=\"p\">:</span>\n<span class=\"w\">    </span><span class=\"sd\">&quot;&quot;&quot;Plugin
    ...
    class=\"sd\">            *content*</span>\n\n<span class=\"sd\">    Note, this
    is ported from</span>\n<span class=\"sd\">    `markdown-it-admon</span>\n<span
    class=\"sd\">    &lt;https://github.com/commenthol/markdown-it-admon&gt;`_.</span>\n<span
    class=\"sd\">    &quot;&quot;&quot;</span>\n\n    <span class=\"k\">def</span><span
    class=\"w\"> </span><span class=\"nf\">renderDefault</span><span class=\"p\">(</span><span
    class=\"bp\">self</span><span class=\"p\">,</span> <span class=\"n\">tokens</span><span
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    \       mdit_details.py\n    </h1>\n</section>    <section class=\"body\">\n        <hr
    />\n<p>The <code>markata.plugins.mdit_details</code> plugin adds support for collapsible
    details/summary\nsections in markdown using the <code>???</code> syntax. This
    is similar to HTML's <code>&lt;details&gt;</code> element\nbut with a more markdown-friendly
