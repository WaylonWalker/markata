---
content: "---\n\nThe `markata.plugins.generator` plugin adds a meta generator tag
  to each generated HTML page,\nindicating that the page was generated by Markata
  and including the version number.\n\n# Installation\n\nThis plugin is built-in and
  ...
  = true  # Set to false to disable HTML prettification\n```\n\n# Functionality\n\n##
  Meta Tag Generation\n\nThe plugin adds a meta tag to the head of each HTML document:\n```html\n<meta
  name=\"generator\" content=\"markata X.Y.Z\">\n```\nwhere X.Y.Z is the current Markata
  version.\n\n## Dependencies\n\nThis plugin depends on:\n- The `render_markdown`
  plugin to provide HTML content\n\n---"
date: 2025-02-14
description: 'The `markata.plugins.generator` plugin adds a meta generator tag to
  each generated HTML page,

  indicating that the page was generated by Markata and including th'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>generator.py</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"The `markata.plugins.generator` plugin
    adds a meta generator tag to each generated HTML page,\nindicating that the page
    was generated by Markata and including th\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    ...
    class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n        generator.py\n
    \   </h1>\n</section>    <section class=\"body\">\n        <hr />\n<p>The <code>markata.plugins.generator</code>
    plugin adds a meta generator tag to each generated HTML page,\nindicating that
    the page was generated by Markata and including the version number.</p>\n<h1 id=\"installation\">Installation
    ...
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;markata.plugins.generator&quot;</span><span
    class=\"p\">,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<h1
    ...
    global <code>prettify_html</code> configuration:</p>\n<pre class='wrapper'>\n\n<div
    class='copy-wrapper'>\n\n<button class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
    x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
    0 0 115.77 122.88\" xml:space=\"preserve\"><style type=\"text/css\">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path
    ...
    class=\"c1\"># Set to false to disable HTML prettification</span>\n</pre></div>\n\n</pre>\n\n<h1
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h1>\n<h2 id=\"meta-tag-generation\">Meta
    Tag Generation <a class=\"header-anchor\" href=\"#meta-tag-generation\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>The plugin adds a meta
    tag to the head of each HTML document:</p>\n<pre class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button
    class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
    x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
    0 0 115.77 122.88\" xml:space=\"preserve\"><style type=\"text/css\">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path
    ...
    class=\"s\">&quot;generator&quot;</span> <span class=\"na\">content</span><span
    class=\"o\">=</span><span class=\"s\">&quot;markata X.Y.Z&quot;</span><span class=\"p\">&gt;</span>\n</pre></div>\n\n</pre>\n\n<p>where
    X.Y.Z is the current Markata version.</p>\n<h2 id=\"dependencies\">Dependencies
    ...
    on:</p>\n<ul>\n<li>The <code>render_markdown</code> plugin to provide HTML content</li>\n</ul>\n<hr
    />\n\n    </section>\n</article>    </div>\n    <div></div>\n</div>\n     </body>\n</html>"
  og: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>generator.py</title>\n<meta charset=\"UTF-8\"
    />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n<meta
    name=\"description\" content=\"The `markata.plugins.generator` plugin adds a meta
    generator tag to each generated HTML page,\nindicating that the page was generated
    by Markata and including th\" />\n <link href=\"/favicon.ico\" rel=\"icon\" type=\"image/png\"
    />\n\n<link rel=\"stylesheet\" href=\"/post.css\" />\n<link rel=\"stylesheet\"
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    \       generator.py\n    </h1>\n</section>    <section class=\"body\">\n        <hr
    />\n<p>The <code>markata.plugins.generator</code> plugin adds a meta generator
    tag to each generated HTML page,\nindicating that the page was generated by Markata
    and including the version number.</p>\n<h1 id=\"installation\">Installation <a
    class=\"header-anchor\" href=\"#installation\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
