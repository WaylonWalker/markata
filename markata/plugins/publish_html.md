...
content: "Sets the articles `output_html` path, and saves the article's `html` to
  ...
  *, values):\n                if v is None:\n                    return slugify(str(values[\"path\"].stem))\n
  \               return v\n```\n\n\n!! method <h2 id='default_output_html' class='admonition-title'
  style='margin:0;padding:.5rem 1rem;'>default_output_html <em class='small'>method</em></h2>\n\n???+
...
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Publish_Html.Py</title>\n<meta
  ...
  content=\"Sets the articles  Output will always be written inside of the configured
  \ markata will save the articles  Here is an example use case of explicitly setting
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  name=\"og:type\" property=\"og:type\"/><meta content=\"Sets the articles  Output
  will always be written inside of the configured  markata will save the articles
  \ Here is an example use case of explicitly setting the\" name=\"description\" property=\"description\"/><meta
  content=\"Sets the articles  Output will always be written inside of the configured
  \ markata will save the articles  Here is an example use case of explicitly setting
  the\" name=\"og:description\" property=\"og:description\"/><meta content=\"Sets
  the articles  Output will always be written inside of the configured  markata will
  save the articles  Here is an example use case of explicitly setting the\" name=\"twitter:description\"
  property=\"twitter:description\"/><meta content=\"Publish_Html.Py | Markata\" name=\"og:title\"
  property=\"og:title\"/><meta content=\"Publish_Html.Py | Markata\" name=\"twitter:title\"
  property=\"twitter:title\"/><meta content=\"https://markata.dev//markata/plugins/publish-html-og.png\"
  name=\"og:image\" property=\"og:image\"/><meta content=\"https://markata.dev//markata/plugins/publish-html-og.png\"
  ...
  name=\"twitter:creator\" property=\"twitter:creator\"/><meta content=\"Publish_Html.Py\"
  name=\"title\" property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\"
  property=\"generator\"/><link href=\"https://markata.dev//markata/plugins/publish-html/\"
  rel=\"canonical\"/><meta content=\"https://markata.dev//markata/plugins/publish-html/\"
  ...
  to the\n<code>output_html</code> file.</p>\n<h2 id=\"ouptut-directory\">Ouptut Directory
  <a class=\"header-anchor\" href=\"#ouptut-directory\"><svg aria-hidden=\"true\"
  ...
  href=\"#explicityly-set-the-output\"><svg aria-hidden=\"true\" class=\"heading-permalink\"
  ...
  will save the articles <code>html</code> to the <code>output_html</code> specified
  in the\narticles metadata, loaded from frontmatter.</p>\n<h2 id=\"404-example-use-case\">404
  example use case <a class=\"header-anchor\" href=\"#404-example-use-case\"><svg
  ...
  into <code>markout/404/index.html</code>, but many\nhosting providers look for a
  404.html to redirect the user to when a page is\nnot found.</p>\n<pre class=\"wrapper\">\n\n<div
  class=\"copy-wrapper\">\n\n<button class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
  xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  ...
  was not found\ndescription: 404, looks like we can't find the page you are looking
  for\noutput_html: 404.html\n\n---\n\n404, looks like we can't find the page you
  ...
  your home page</a></p>\n<p>!! class </p><h2 class=\"admonition-title\" id=\"OutputHTML\"
  style=\"margin:0;padding:.5rem 1rem;\">OutputHTML <em class=\"small\">class</em></h2>\n<div
  ...
  <span class=\"s2\">\"OutputHTML\"</span><span class=\"p\">,</span> <span class=\"n\">v</span><span
  ...
  class=\"n\">Path</span><span class=\"p\">(</span><span class=\"n\">v</span><span
  ...
  class=\"p\">(</span><span class=\"s2\">\"output_html\"</span><span class=\"p\">)</span>\n
  \           <span class=\"k\">def</span> <span class=\"nf\">output_html_relative</span><span
  class=\"p\">(</span>\n                <span class=\"bp\">cls</span><span class=\"p\">:</span>
  <span class=\"s2\">\"OutputHTML\"</span><span class=\"p\">,</span> <span class=\"n\">v</span><span
  class=\"p\">:</span> <span class=\"n\">Optional</span><span class=\"p\">[</span><span
  class=\"n\">Path</span><span class=\"p\">],</span> <span class=\"o\">*</span><span
  ...
  \               <span class=\"bp\">cls</span><span class=\"p\">:</span> <span class=\"s2\">\"OutputHTML\"</span><span
  class=\"p\">,</span> <span class=\"n\">v</span><span class=\"p\">:</span> <span
  ...
  \           Saves all the articles to their set `output_html` location if that location</span>\n<span
  class=\"sd\">            is relative to the specified `output_dir`.  If its not
  relative to the</span>\n<span class=\"sd\">            `output_dir` it will log
  an error and move on.</span>\n<span class=\"sd\">            \"\"\"</span>\n\n            <span
  ...
  method </p><h2 class=\"admonition-title\" id=\"default_output_html\" style=\"margin:0;padding:.5rem
  ...
  <span class=\"n\">values</span><span class=\"p\">[</span><span class=\"s2\">\"slug\"</span><span
  class=\"p\">]</span> <span class=\"o\">/</span> <span class=\"s2\">\"index.html\"</span>\n</pre></div>\n\n</pre>\n<p>!!
  method </p><h2 class=\"admonition-title\" id=\"output_html_relative\" style=\"margin:0;padding:.5rem
  1rem;\">output_html_relative <em class=\"small\">method</em></h2>\n<div class=\"admonition
  ...
  id=\"output_html_exists\" style=\"margin:0;padding:.5rem 1rem;\">output_html_exists
