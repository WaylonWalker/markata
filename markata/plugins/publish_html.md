---
content: "---\n\nThe `markata.plugins.publish_html` plugin handles saving rendered
  HTML content to files.\nIt determines the output path for each article and ensures
  files are saved in the correct\nlocation within the output directory.\n\n# Installation\n\nThis
  ...
  will prevent HTML files from being written to disk.\n\n# Configuration\n\nConfigure
  HTML output in `markata.toml`:\n\n```toml\n[markata]\n# Base output directory\noutput_dir
  = \"dist\"\n\n# Custom output paths\n[[markata.output_paths]]\npattern = \"blog/*\"\noutput
  = \"posts/{stem}.html\"\n\n[[markata.output_paths]]\npattern = \"docs/*\"\noutput
  = \"documentation/{stem}/index.html\"\n```\n\n# Functionality\n\n## Path Resolution\n\nThe
  plugin:\n1. Determines output path for each post\n2. Creates necessary directories\n3.
  Validates paths are within output_dir\n4. Handles custom path mappings\n\n## Output
  ...
  1rem;\">save <em class=\"small\">function</em></h2>\n\n    Saves all the articles
  to their set `output_html` location if that location\n    is relative to the specified
  `output_dir`.  If its not relative to the\n    `output_dir` it will log an error
  and move on.\n\n???+ source \"save <em class='small'>source</em>\"\n    ```python\n
  \   def save(markata: \"Markata\") -> None:\n        \"\"\"\n        Saves all the
  articles to their set `output_html` location if that location\n        is relative
  to the specified `output_dir`.  If its not relative to the\n        `output_dir`
  it will log an error and move on.\n        \"\"\"\n        from slugify import slugify\n\n
  \       for article in markata.filter(\"not skip\"):\n            if article.html
  is None:\n                continue\n\n            if isinstance(article.html, str):\n
  \               # Create parent directories before writing\n                article.output_html.parent.mkdir(parents=True,
  ...
  = article.output_html.parent / slug\n                    # Handle other slugs by
  creating subdirectories\n                    else:\n                        slug_path
  = slugify(slug)\n                        output_path = article.output_html.parent
  / slug_path / \"index.html\"\n\n                    # Create parent directories
  and write file\n                    output_path.parent.mkdir(parents=True, exist_ok=True)\n
  \                   output_path.write_text(html)\n    ```"
date: 2025-02-14
description: 'The `markata.plugins.publish_html` plugin handles saving rendered HTML
  content to files.

  It determines the output path for each article and ensures files are sa'
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>publish_html.py</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"The `markata.plugins.publish_html` plugin
    handles saving rendered HTML content to files.\nIt determines the output path
    for each article and ensures files are sa\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
    ...
    class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n        publish_html.py\n
    \   </h1>\n</section>    <section class=\"body\">\n        <hr />\n<p>The <code>markata.plugins.publish_html</code>
    plugin handles saving rendered HTML content to files.\nIt determines the output
    path for each article and ensures files are saved in the correct\nlocation within
    ...
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;markata.plugins.publish_html&quot;</span><span
    class=\"p\">,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<h1
    ...
    class=\"p\">[</span>\n<span class=\"w\">    </span><span class=\"s2\">&quot;markata.plugins.publish_html&quot;</span><span
    class=\"p\">,</span>\n<span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n\n<p>Note:
    Disabling this plugin will prevent HTML files from being written to disk.</p>\n<h1
    ...
    class=\"c1\"># Base output directory</span>\n<span class=\"n\">output_dir</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;dist&quot;</span>\n\n<span class=\"c1\"># Custom output paths</span>\n<span
    class=\"k\">[[markata.output_paths]]</span>\n<span class=\"n\">pattern</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;blog/*&quot;</span>\n<span class=\"n\">output</span><span class=\"w\">
    </span><span class=\"o\">=</span><span class=\"w\"> </span><span class=\"s2\">&quot;posts/{stem}.html&quot;</span>\n\n<span
    class=\"k\">[[markata.output_paths]]</span>\n<span class=\"n\">pattern</span><span
    class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span
    class=\"s2\">&quot;docs/*&quot;</span>\n<span class=\"n\">output</span><span class=\"w\">
    </span><span class=\"o\">=</span><span class=\"w\"> </span><span class=\"s2\">&quot;documentation/{stem}/index.html&quot;</span>\n</pre></div>\n\n</pre>\n\n<h1
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h1>\n<h2 id=\"path-resolution\">Path
    Resolution <a class=\"header-anchor\" href=\"#path-resolution\"><svg class=\"heading-permalink\"
    ...
    output path for each post</li>\n<li>Creates necessary directories</li>\n<li>Validates
    paths are within output_dir</li>\n<li>Handles custom path mappings</li>\n</ol>\n<h2
    id=\"output-model\">Output Model <a class=\"header-anchor\" href=\"#output-model\"><svg
    class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
    height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997
    0 0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Extends the base Post
    model with:</p>\n<ul>\n<li>output_html path</li>\n<li>Path validation</li>\n<li>Slug
    resolution</li>\n<li>Directory creation</li>\n</ul>\n<h2 id=\"file-operations\">File
    Operations <a class=\"header-anchor\" href=\"#file-operations\"><svg class=\"heading-permalink\"
    aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
    viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Handles:</p>\n<ul>\n<li>Directory
    creation</li>\n<li>File writing</li>\n<li>Path validation</li>\n<li>Error logging</li>\n</ul>\n<h2
    id=\"path-customization\">Path Customization <a class=\"header-anchor\" href=\"#path-customization\"><svg
    class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
    height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
    d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
    5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
    ...
    files</li>\n</ul>\n<h2 id=\"safety-features\">Safety Features <a class=\"header-anchor\"
    href=\"#safety-features\"><svg class=\"heading-permalink\" aria-hidden=\"true\"
    ...
    on:</p>\n<ul>\n<li>pathlib for path operations</li>\n<li>pydantic for model validation</li>\n</ul>\n<hr
    ...
    <em class=\"small\">function</em></h2>\n<p>Saves all the articles to their set
    <code>output_html</code> location if that location\nis relative to the specified
    ...
    class=\"sd\">    Saves all the articles to their set `output_html` location if
    that location</span>\n<span class=\"sd\">    is relative to the specified `output_dir`.
    \ If its not relative to the</span>\n<span class=\"sd\">    `output_dir` it will
    log an error and move on.</span>\n<span class=\"sd\">    &quot;&quot;&quot;</span>\n
    \   <span class=\"kn\">from</span><span class=\"w\"> </span><span class=\"nn\">slugify</span><span
    class=\"w\"> </span><span class=\"kn\">import</span> <span class=\"n\">slugify</span>\n\n
    ...
    class=\"p\">(</span><span class=\"s2\">&quot;not skip&quot;</span><span class=\"p\">):</span>\n
    \       <span class=\"k\">if</span> <span class=\"n\">article</span><span class=\"o\">.</span><span
    class=\"n\">html</span> <span class=\"ow\">is</span> <span class=\"kc\">None</span><span
    ...
    \           <span class=\"c1\"># Create parent directories before writing</span>\n
    \           <span class=\"n\">article</span><span class=\"o\">.</span><span class=\"n\">output_html</span><span
    ...
    <span class=\"n\">slug</span><span class=\"p\">,</span> <span class=\"n\">html</span>
    ...
    class=\"p\">():</span>\n                <span class=\"c1\"># Handle special case
    for index</span>\n                <span class=\"k\">if</span> <span class=\"n\">slug</span>
    <span class=\"o\">==</span> <span class=\"s2\">&quot;index&quot;</span><span class=\"p\">:</span>\n
    \                   <span class=\"n\">output_path</span> <span class=\"o\">=</span>
    <span class=\"n\">article</span><span class=\"o\">.</span><span class=\"n\">output_html</span>\n
    \               <span class=\"c1\"># Handle files with extensions</span>\n                <span
    class=\"k\">elif</span> <span class=\"s2\">&quot;.&quot;</span> <span class=\"ow\">in</span>
    <span class=\"n\">slug</span><span class=\"p\">:</span>\n                    <span
    class=\"n\">output_path</span> <span class=\"o\">=</span> <span class=\"n\">article</span><span
    ...
    \               <span class=\"c1\"># Handle other slugs by creating subdirectories</span>\n
    \               <span class=\"k\">else</span><span class=\"p\">:</span>\n                    <span
    class=\"n\">slug_path</span> <span class=\"o\">=</span> <span class=\"n\">slugify</span><span
    class=\"p\">(</span><span class=\"n\">slug</span><span class=\"p\">)</span>\n
    \                   <span class=\"n\">output_path</span> <span class=\"o\">=</span>
    <span class=\"n\">article</span><span class=\"o\">.</span><span class=\"n\">output_html</span><span
    class=\"o\">.</span><span class=\"n\">parent</span> <span class=\"o\">/</span>
    <span class=\"n\">slug_path</span> <span class=\"o\">/</span> <span class=\"s2\">&quot;index.html&quot;</span>\n\n
    \               <span class=\"c1\"># Create parent directories and write file</span>\n
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    \       publish_html.py\n    </h1>\n</section>    <section class=\"body\">\n        <hr
    />\n<p>The <code>markata.plugins.publish_html</code> plugin handles saving rendered
    HTML content to files.\nIt determines the output path for each article and ensures
    files are saved in the correct\nlocation within the output directory.</p>\n<h1
