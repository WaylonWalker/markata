...
content: "---\n\nThe `markata.plugins.publish_html` plugin handles saving rendered
  ...
  = article.output_html.parent / slug_path / \"index.html\"\n\n                    #
...
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>publish_html.py</title>\n<meta
    ...
    />\n<meta name=\"description\" content=\"The   plugin handles saving rendered
    HTML content to files. It determines the output path for each article and ensures
