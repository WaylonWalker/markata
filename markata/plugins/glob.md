...
content: "Default glob plugin\n\n\n!! class <h2 id='GlobConfig' class='admonition-title'
  ...
  v):\n                if not isinstance(v, list):\n                    return v.split(\",\")\n
  \               return v\n```\n\n\n!! function <h2 id='check_spec' class='admonition-title'
  style='margin:0;padding:.5rem 1rem;'>check_spec <em class='small'>function</em></h2>\n\n???+
...
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Glob.Py</title>\n<meta
  ...
  content=\"Default glob plugin ! ???+ source  ! ???+ source  ! ???+ source  ! ???+
  source  ! ???+ source  ! ???+ source \" name=\"description\"/>\n<link href=\"/static/favicon.ico\"
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  name=\"og:type\" property=\"og:type\"/><meta content=\"Default glob plugin ! ???+
  source  ! ???+ source  ! ???+ source  ! ???+ source  ! ???+ source  ! ???+ source
  \" name=\"description\" property=\"description\"/><meta content=\"Default glob plugin
  ! ???+ source  ! ???+ source  ! ???+ source  ! ???+ source  ! ???+ source  ! ???+
  source \" name=\"og:description\" property=\"og:description\"/><meta content=\"Default
  glob plugin ! ???+ source  ! ???+ source  ! ???+ source  ! ???+ source  ! ???+ source
  \ ! ???+ source \" name=\"twitter:description\" property=\"twitter:description\"/><meta
  content=\"Glob.Py | Markata\" name=\"og:title\" property=\"og:title\"/><meta content=\"Glob.Py
  | Markata\" name=\"twitter:title\" property=\"twitter:title\"/><meta content=\"https://markata.dev//markata/plugins/glob-og.png\"
  name=\"og:image\" property=\"og:image\"/><meta content=\"https://markata.dev//markata/plugins/glob-og.png\"
  ...
  name=\"twitter:creator\" property=\"twitter:creator\"/><meta content=\"Glob.Py\"
  name=\"title\" property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\"
  property=\"generator\"/><link href=\"https://markata.dev//markata/plugins/glob/\"
  rel=\"canonical\"/><meta content=\"https://markata.dev//markata/plugins/glob/\"
  ...
  round\"></div>\n</label>\n</div>\n<section class=\"title\">\n<h1 id=\"title\">\n
  \           Glob.Py \n            \n        </h1>\n</section>\n<main><p>Default
  glob plugin</p>\n<p>!! class </p><h2 class=\"admonition-title\" id=\"GlobConfig\"
  style=\"margin:0;padding:.5rem 1rem;\">GlobConfig <em class=\"small\">class</em></h2>\n<div
  ...
  class=\"s2\">\"glob\"</span><span class=\"p\">,</span> <span class=\"s2\">\"spec\"</span><span
  class=\"p\">,</span> <span class=\"n\">lines</span><span class=\"p\">)</span>\n
  \               <span class=\"n\">spec</span> <span class=\"o\">=</span> <span class=\"n\">markata</span><span
  ...
  \                   <span class=\"n\">spec</span> <span class=\"o\">=</span> <span
  class=\"n\">pathspec</span><span class=\"o\">.</span><span class=\"n\">PathSpec</span><span
  ...
  <span class=\"s2\">\"check_spec\"</span><span class=\"p\">,</span> <span class=\"n\">file</span><span
  ...
  <span class=\"n\">check</span> <span class=\"ow\">is</span> <span class=\"ow\">not</span>
  <span class=\"kc\">None</span><span class=\"p\">:</span>\n                        <span
  class=\"k\">return</span> <span class=\"n\">check</span>\n\n                    <span
  class=\"n\">check</span> <span class=\"o\">=</span> <span class=\"n\">spec</span><span
  ...
  class=\"ow\">not</span> <span class=\"n\">check_spec</span><span class=\"p\">(</span><span
  class=\"nb\">str</span><span class=\"p\">(</span><span class=\"n\">file</span><span
  class=\"p\">))]</span>\n</pre></div>\n\n</pre>\n<p>!! method </p><h2 class=\"admonition-title\"
  id=\"convert_to_list\" style=\"margin:0;padding:.5rem 1rem;\">convert_to_list <em
  class=\"small\">method</em></h2>\n<div class=\"admonition source is-collapsible
  collapsible-open\">\n<p class=\"admonition-title\">\"convert_to_list <em class=\"small\">source</em>\"</p>\n</div>\n<pre
  class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
  xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  ...
  class=\"p\">(</span><span class=\"s2\">\",\"</span><span class=\"p\">)</span>\n
  \               <span class=\"k\">return</span> <span class=\"n\">v</span>\n</pre></div>\n\n</pre>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"check_spec\" style=\"margin:0;padding:.5rem
