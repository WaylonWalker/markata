...
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Standard_Config.Py</title>\n<meta
  ...
  content=\"Standard Config. Inspired from frustrations that some tools have a tool.ini,
  .tool.ini, This file is for any project that can be configured in plain text such
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  name=\"og:type\" property=\"og:type\"/><meta content=\"Standard Config. Inspired
  from frustrations that some tools have a tool.ini, .tool.ini, This file is for any
  project that can be configured in plain text such a\" name=\"description\" property=\"description\"/><meta
  content=\"Standard Config. Inspired from frustrations that some tools have a tool.ini,
  .tool.ini, This file is for any project that can be configured in plain text such
  a\" name=\"og:description\" property=\"og:description\"/><meta content=\"Standard
  Config. Inspired from frustrations that some tools have a tool.ini, .tool.ini, This
  file is for any project that can be configured in plain text such a\" name=\"twitter:description\"
  property=\"twitter:description\"/><meta content=\"Standard_Config.Py | Markata\"
  name=\"og:title\" property=\"og:title\"/><meta content=\"Standard_Config.Py | Markata\"
  name=\"twitter:title\" property=\"twitter:title\"/><meta content=\"https://markata.dev//markata/standard-config-og.png\"
  name=\"og:image\" property=\"og:image\"/><meta content=\"https://markata.dev//markata/standard-config-og.png\"
  ...
  name=\"twitter:creator\" property=\"twitter:creator\"/><meta content=\"Standard_Config.Py\"
  name=\"title\" property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\"
  property=\"generator\"/><link href=\"https://markata.dev//markata/standard-config/\"
  rel=\"canonical\"/><meta content=\"https://markata.dev//markata/standard-config/\"
  ...
  \ Some allow for global configs, some don't.  Some\nproperly follow the users home
  directory, others end up in a weird temp\ndirectory.  Windows home directory is
  only more confusing.  Some will even\nrespect the users <code>$XDG_HOME</code> directory.</p>\n<p>This
  file is for any project that can be configured in plain text such as <code>ini</code>\nor
  <code>toml</code> and not requiring a .py file.  Just name your tool and let users
  put\nconfig where it makes sense to them, no need to figure out resolution order.</p>\n<h2
  id=\"usage\">Usage: <a class=\"header-anchor\" href=\"#usage\"><svg aria-hidden=\"true\"
  ...
  Order <a class=\"header-anchor\" href=\"#resolution-order\"><svg aria-hidden=\"true\"
  class=\"heading-permalink\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
  viewbox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M9.199
  13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
  5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
  ...
  class=\"na\">setting</span><span class=\"w\"> </span><span class=\"o\">=</span><span
  class=\"w\"> </span><span class=\"s\">True</span>\n</pre></div>\n\n</pre>\n<h3>global
  files to consider</h3>\n<ul>\n<li><home>/tool.ini</home></li>\n<li><home>/.tool</home></li>\n<li><home>/.tool.ini</home></li>\n<li><home>/.config/tool.ini</home></li>\n<li><home>/.config/.tool</home></li>\n<li><home>/.config/.tool.ini</home></li>\n</ul>\n<h3>local
  files to consider</h3>\n<ul>\n<li>&lt;project_home&gt;/tool.ini</li>\n<li>&lt;project_home&gt;/.tool</li>\n<li>&lt;project_home&gt;/.tool.ini</li>\n<li>&lt;project_home&gt;/pyproject.toml</li>\n<li>&lt;project_home&gt;/setup.cfg</li>\n</ul>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"_get_global_path_specs\" style=\"margin:0;padding:.5rem
  1rem;\">_get_global_path_specs <em class=\"small\">function</em></h2>\nGenerate
  a list of standard pathspecs for global config files.\n<pre><code>Args:\n    tool
  ...
  class=\"p\">(</span><span class=\"n\">os</span><span class=\"o\">.</span><span class=\"n\">environ</span><span
  ...
  <span class=\"n\">Path</span><span class=\"o\">.</span><span class=\"n\">home</span><span
  class=\"p\">()</span>\n\n            <span class=\"k\">return</span> <span class=\"p\">[</span>\n
  \               <span class=\"p\">{</span><span class=\"s2\">\"path_specs\"</span><span
  class=\"p\">:</span> <span class=\"n\">home</span> <span class=\"o\">/</span> <span
  ...
  id=\"_get_local_path_specs\" style=\"margin:0;padding:.5rem 1rem;\">_get_local_path_specs
  <em class=\"small\">function</em></h2>\nGenerate a list of standard pathspecs for
  local, project directory config files.\n<pre><code>Args:\n    tool (str): name of
  ...
  \           </span><span class=\"sd\">\"\"\"</span>\n<span class=\"sd\">            Generate
  a list of standard pathspecs for local, project directory config files.</span>\n\n<span
  class=\"sd\">            Args:</span>\n<span class=\"sd\">                tool (str):
  name of the tool to configure</span>\n<span class=\"sd\">            \"\"\"</span>\n
  \           <span class=\"k\">return</span> <span class=\"p\">[</span>\n                <span
  ...
  \                   <span class=\"s2\">\"path_specs\"</span><span class=\"p\">:</span>
  <span class=\"n\">Path</span><span class=\"p\">(</span><span class=\"n\">project_home</span><span
  class=\"p\">)</span> <span class=\"o\">/</span> <span class=\"s2\">\"pyproject.toml\"</span><span
  class=\"p\">,</span>\n                    <span class=\"s2\">\"ac_parser\"</span><span
  class=\"p\">:</span> <span class=\"s2\">\"toml\"</span><span class=\"p\">,</span>\n
  \                   <span class=\"s2\">\"keys\"</span><span class=\"p\">:</span>
  ...
  <span class=\"o\">/</span> <span class=\"s2\">\"setup.cfg\"</span><span class=\"p\">,</span>\n
  \                   <span class=\"s2\">\"ac_parser\"</span><span class=\"p\">:</span>
  <span class=\"s2\">\"ini\"</span><span class=\"p\">,</span>\n                    <span
  class=\"s2\">\"keys\"</span><span class=\"p\">:</span> <span class=\"p\">[</span><span
  class=\"sa\">f</span><span class=\"s2\">\"tool.</span><span class=\"si\">{</span><span
  class=\"n\">tool</span><span class=\"si\">}</span><span class=\"s2\">\"</span><span
  class=\"p\">],</span>\n                <span class=\"p\">},</span>\n            <span
  class=\"p\">]</span>\n</pre></div>\n\n</pre>\n<p>!! function </p><h2 class=\"admonition-title\"
  id=\"_get_attrs\" style=\"margin:0;padding:.5rem 1rem;\">_get_attrs <em class=\"small\">function</em></h2>\nGet
  nested config data from a list of keys.\n<pre><code>specifically written for pyproject.toml
  ...
  function </p><h2 class=\"admonition-title\" id=\"_load_files\" style=\"margin:0;padding:.5rem
  1rem;\">_load_files <em class=\"small\">function</em></h2>\nUse anyconfig to load
  config files stopping at the first one that exists.\n<pre><code>config_path_specs
  ...
  class=\"w\">            </span><span class=\"sd\">\"\"\"Use anyconfig to load config
  files stopping at the first one that exists.</span>\n\n<span class=\"sd\">            config_path_specs
  ...
  class=\"n\">config</span> <span class=\"o\">=</span> <span class=\"n\">anyconfig</span><span
  ...
  ignore missing files</span>\n                    <span class=\"k\">continue</span>\n\n
  \               <span class=\"k\">try</span><span class=\"p\">:</span>\n                    <span
  class=\"k\">return</span> <span class=\"n\">_get_attrs</span><span class=\"p\">(</span><span
  class=\"n\">file</span><span class=\"p\">[</span><span class=\"s2\">\"keys\"</span><span
  class=\"p\">],</span> <span class=\"n\">config</span><span class=\"p\">)</span>\n
  \               <span class=\"k\">except</span> <span class=\"ne\">KeyError</span><span
  class=\"p\">:</span>\n                    <span class=\"c1\"># ignore incorrect
  keys</span>\n                    <span class=\"k\">continue</span>\n\n            <span
  class=\"k\">return</span> <span class=\"p\">{}</span>\n</pre></div>\n\n</pre>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"_load_env\" style=\"margin:0;padding:.5rem
  1rem;\">_load_env <em class=\"small\">function</em></h2>\nLoad config from environment
  variables.\n<pre><code>Args:\n    tool (str): name of the tool to configure\n</code></pre>\n<div
  ...
  class=\"w\">            </span><span class=\"sd\">\"\"\"Load config from environment
  variables.</span>\n\n<span class=\"sd\">            Args:</span>\n<span class=\"sd\">
  \               tool (str): name of the tool to configure</span>\n<span class=\"sd\">
  \           \"\"\"</span>\n            <span class=\"nb\">vars</span> <span class=\"o\">=</span>
  <span class=\"p\">[</span><span class=\"n\">var</span> <span class=\"k\">for</span>
  <span class=\"n\">var</span> <span class=\"ow\">in</span> <span class=\"n\">os</span><span
  class=\"o\">.</span><span class=\"n\">environ</span> <span class=\"k\">if</span>
  <span class=\"n\">var</span><span class=\"o\">.</span><span class=\"n\">startswith</span><span
  ...
  class=\"n\">strip</span><span class=\"p\">(</span><span class=\"n\">tool</span><span
  ...
  class=\"n\">environ</span><span class=\"p\">[</span><span class=\"n\">var</span><span
  class=\"p\">]</span>\n                <span class=\"k\">for</span> <span class=\"n\">var</span>
  <span class=\"ow\">in</span> <span class=\"nb\">vars</span>\n            <span class=\"p\">}</span>\n</pre></div>\n\n</pre>\n<p>!!
  ...
  class=\"p\">:</span> <span class=\"n\">Dict</span> <span class=\"o\">=</span> <span
  class=\"p\">{})</span> <span class=\"o\">-&gt;</span> <span class=\"n\">Dict</span><span
  class=\"p\">:</span>\n<span class=\"w\">            </span><span class=\"sd\">\"\"\"Load
  tool config from standard config files.</span>\n\n<span class=\"sd\">            Resolution
  Order</span>\n\n<span class=\"sd\">            * First global file with a tool key</span>\n<span
  class=\"sd\">            * First local file with a tool key</span>\n<span class=\"sd\">
  \           * Environment variables prefixed with `TOOL`</span>\n<span class=\"sd\">
  \           * Overrides</span>\n\n<span class=\"sd\">            Args:</span>\n<span
