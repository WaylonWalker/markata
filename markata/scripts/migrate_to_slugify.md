---
content: "Slugify migration for projects moving from markata<0.5.0 into markata>=0.5.0\n\nto
  run this script install markata>=0.5.0 and run the following.\n\n``` bash\npython
  -m markata.scripts.migrate_to_slugify\n```\n\nThen make sure that you do not explicity
  turn off slugify and your site is\ngoing to be on to better urls.\n\n``` toml\n[markata]\nslugify=false\n```\n\n\n!!
  function <h2 id='routed_slugify' class='admonition-title' style='margin:0;padding:.5rem
  1rem;'>routed_slugify <em class='small'>function</em></h2>\n\n???+ source \"routed_slugify
  <em class='small'>source</em>\"\n\n```python\n\n        def routed_slugify(text):\n
  \           return \"/\".join([slugify(s) for s in text.split(\"/\")])\n```\n"
date: 0001-01-01
description: 'Slugify migration for projects moving from markata to run this script
  install markata&gt;=0.5.0 and run the following. Then make sure that you do not
  explicity '
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Migrate_To_Slugify.Py</title>\n<meta
  charset=\"utf-8\"/>\n<meta content=\"width=device-width, initial-scale=1\" name=\"viewport\"/>\n<meta
  content=\"Slugify migration for projects moving from markata to run this script
  install markata&gt;=0.5.0 and run the following. Then make sure that you do not
  explicity \" name=\"description\"/>\n<link href=\"/static/favicon.ico\" rel=\"icon\"
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  name=\"og:type\" property=\"og:type\"/><meta content=\"Slugify migration for projects
  moving from markata to run this script install markata&amp;gt;=0.5.0 and run the
  following. Then make sure that you do not explicity \" name=\"description\" property=\"description\"/><meta
  content=\"Slugify migration for projects moving from markata to run this script
  install markata&amp;gt;=0.5.0 and run the following. Then make sure that you do
  not explicity \" name=\"og:description\" property=\"og:description\"/><meta content=\"Slugify
  migration for projects moving from markata to run this script install markata&amp;gt;=0.5.0
  and run the following. Then make sure that you do not explicity \" name=\"twitter:description\"
  property=\"twitter:description\"/><meta content=\"Migrate_To_Slugify.Py | Markata\"
  name=\"og:title\" property=\"og:title\"/><meta content=\"Migrate_To_Slugify.Py |
  Markata\" name=\"twitter:title\" property=\"twitter:title\"/><meta content=\"https://markata.dev//markata/scripts/migrate-to-slugify-og.png\"
  name=\"og:image\" property=\"og:image\"/><meta content=\"https://markata.dev//markata/scripts/migrate-to-slugify-og.png\"
  ...
  name=\"twitter:creator\" property=\"twitter:creator\"/><meta content=\"Migrate_To_Slugify.Py\"
  name=\"title\" property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\"
  property=\"generator\"/><link href=\"https://markata.dev//markata/scripts/migrate-to-slugify/\"
  rel=\"canonical\"/><meta content=\"https://markata.dev//markata/scripts/migrate-to-slugify/\"
  ...
  migration for projects moving from markata&lt;0.5.0 into markata&gt;=0.5.0</p>\n<p>to
  run this script install markata&gt;=0.5.0 and run the following.</p>\n<pre class=\"wrapper\">\n\n<div
  ...
  make sure that you do not explicity turn off slugify and your site is\ngoing to
  be on to better urls.</p>\n<pre class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button
  ...
  function </p><h2 class=\"admonition-title\" id=\"routed_slugify\" style=\"margin:0;padding:.5rem
  1rem;\">routed_slugify <em class=\"small\">function</em></h2>\n<div class=\"admonition
  source is-collapsible collapsible-open\">\n<p class=\"admonition-title\">\"routed_slugify
  ...
  <span class=\"nf\">routed_slugify</span><span class=\"p\">(</span><span class=\"n\">text</span><span
...
!! function <h2 id='routed_slugify' class='admonition-title' style='margin:0;padding:.5rem 1rem;'>routed_slugify <em class='small'>function</em></h2>

???+ source "routed_slugify <em class='small'>source</em>"
