...
description: Slugify migration for projects moving from markata&lt;0.5.0 into markata&gt;=0.5.0
  to run this script install markata&gt;=0.5.0 and run the following. Then make
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>migrate_to_slugify.py</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"Slugify migration for projects moving
    from markata&lt;0.5.0 into markata&gt;=0.5.0 to run this script install markata&gt;=0.5.0
    and run the following. Then make\" />\n <link href=\"/favicon.ico\" rel=\"icon\"
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    \       migrate_to_slugify.py\n    </h1>\n</section>    <section class=\"body\">\n
    \       <hr />\n<p>Slugify migration for projects moving from markata&lt;0.5.0
    into markata&gt;=0.5.0</p>\n<p>to run this script install markata&gt;=0.5.0 and
    run the following.</p>\n<pre class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button
    class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
    x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
