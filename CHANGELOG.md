...
content: "# Markata Changelog\n\n## 0.8.1\n\n### Feeds have partials\n\nThe `feeds`
  plugin now has configurable `partial_template` that can be used to\nrender only
  the inside of the feeds page.  This is indended to allow you to\nload small feeds
  into a page with htmx.\n\n### Better Jinja Templates\n\nMarkata now fully supports
  jinja templates with a loader that will load from\nyour templates directory, the
  markata built-in templates, and from a\ndynamically generated templates directory
...
date: 0001-01-01
description: The  Markata now fully supports jinja templates with a loader that will
  load from You can list out your templates and configuration with the following command
  T
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>Changelog</title>\n<meta charset=\"UTF-8\"
    />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n<meta
    name=\"description\" content=\"The  Markata now fully supports jinja templates
    with a loader that will load from You can list out your templates and configuration
    with the following command T\" />\n <link href=\"/favicon.ico\" rel=\"icon\" type=\"image/png\"
    />\n\n<link rel=\"stylesheet\" href=\"/post.css\" />\n<link rel=\"stylesheet\"
    href=\"/app.css\" />\n<script src=\"/theme.js\"></script>\n\n\n<meta name=\"og:author_email\"
    content=\"waylon@waylonwalker.com\" />\n\n    <head>\n<title>Changelog</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"The  Markata now fully supports jinja
    templates with a loader that will load from You can list out your templates and
    configuration with the following command T\" />\n <link href=\"/favicon.ico\"
    ...
    class=\"header-anchor\" href=\"#081\"><svg class=\"heading-permalink\" aria-hidden=\"true\"
