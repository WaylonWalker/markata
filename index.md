...
content: "\nMarkata is a fully plugins all the way down static site generator for\nfolks
  who just want their site to get started quickly and build great\ncontent, with the
  ability to tinker with everything under the hood if\nthey want to.\n\n## QuickStart\n\nMarkata
  is fully configurable through a `markata.toml` file, but the defaults\nallow to
  build your site right out of the box with nothing more than markdown.\n\n### Create
  Some Content\n\n```\nmkdir pages\ncd pages\necho '# My First Post' > first-post.md\necho
  '# Hello World' > hello-world.md\n```\n\n### Build your site\n\n```bash\npip install
  markata\nmarkata build\n\n# or if pipx is your thing\npipx run markata build\n```\n\n###
  Frontmatter\n\nYou will likely want to set things like `title`, `date`, `description`,\n`published`,
  or `template` per post, this can all be done inside yaml frontmatter.\n\n```markdown\n---\ntemplateKey:
  blog-post\ntags: [\"python\"]\ntitle: My Awesome Post\ndate: 2022-01-21T16:40:34\npublished:
  False\n---\n\nThis is my awesome post.\n```\n\n> Frontmatter is not required, but
  definitely gives you more control over your site.\n\n## Next steps\n\n_blog starter_\n\nThe
  [blog-starter](https://blog-starter.markata.dev/) has a really great write\nup on
  how to use markata. You can see it in your brower at the\n[link](https://blog-starter.markata.dev/)
  or run it yourself `pipx run markata\nnew blog`.\n\n## Examples Gallary\n\nMarkata
  has a project gallery to show off sites built with markata. Please\n[submit](https://github.com/WaylonWalker/markata/issues/78)
  yours, and check\nout the [project-gallery](http://markata.dev/project-gallery/)
  for inspiration.\n\n## Deploying to a sub route\n\n_gh pages_\n\nTo deploy a subroute,
  add a markata.path_prifix to your config (markata.toml).\n\n```toml\n[markata]\npath_prefix='my-sub-route'\n```\n\n##
  Source Code\n\nIf you have comments, questions, issues, or like it enough to give
  a \u2B50\ncheck out\n[waylonwalker/markata](https://github.com/WaylonWalker/markata)\n\n##
  Markata Docs\n\nNot much is documented yet, lots of work to do on the docs. Checkout\n[LifeCycle](https://markata.dev/markata/lifecycle/)
...
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Getting Started With Markata</title>\n<meta
  ...
  content=\"Guide to get going with Markata\" name=\"description\"/>\n<link href=\"/static/favicon.ico\"
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  name=\"og:type\" property=\"og:type\"/><meta content=\"Guide to get going with Markata\"
  name=\"description\" property=\"description\"/><meta content=\"Guide to get going
  with Markata\" name=\"og:description\" property=\"og:description\"/><meta content=\"Guide
  to get going with Markata\" name=\"twitter:description\" property=\"twitter:description\"/><meta
  content=\"Getting Started With Markata | Markata\" name=\"og:title\" property=\"og:title\"/><meta
  content=\"Getting Started With Markata | Markata\" name=\"twitter:title\" property=\"twitter:title\"/><meta
  content=\"https://markata.dev//-og.png\" name=\"og:image\" property=\"og:image\"/><meta
  content=\"https://markata.dev//-og.png\" name=\"twitter:image\" property=\"twitter:image\"/><meta
  content=\"1600\" name=\"og:image:width\" property=\"og:image:width\"/><meta content=\"900\"
  name=\"og:image:width\" property=\"og:image:width\"/><meta content=\"summary_large_image\"
  name=\"twitter:card\" property=\"twitter:card\"/><meta content=\"Markata\" name=\"og:site_name\"
  property=\"og:site_name\"/><meta content=\"@_waylonwalker\" name=\"twitter:creator\"
  property=\"twitter:creator\"/><meta content=\"Getting Started With Markata\" name=\"title\"
  property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\" property=\"generator\"/><link
  href=\"https://markata.dev///\" rel=\"canonical\"/><meta content=\"https://markata.dev///\"
  ...
  is a fully plugins all the way down static site generator for\nfolks who just want
  their site to get started quickly and build great\ncontent, with the ability to
  tinker with everything under the hood if\nthey want to.</p>\n<h2 id=\"quickstart\">QuickStart
  <a class=\"header-anchor\" href=\"#quickstart\"><svg aria-hidden=\"true\" class=\"heading-permalink\"
  ...
  is fully configurable through a <code>markata.toml</code> file, but the defaults\nallow
  to build your site right out of the box with nothing more than markdown.</p>\n<h3>Create
  ...
  \       \n<div class=\"highlight\"><pre><span></span>mkdir pages\ncd pages\necho
  ...
  [\"python\"]\ntitle: My Awesome Post\ndate: 2022-01-21T16:40:34\n<span class=\"gu\">published:
  False</span>\n<span class=\"gu\">---</span>\n\nThis is my awesome post.\n</pre></div>\n\n</pre>\n<blockquote>\n<p>Frontmatter
  is not required, but definitely gives you more control over your site.</p>\n</blockquote>\n<h2
  id=\"next-steps\">Next steps <a class=\"header-anchor\" href=\"#next-steps\"><svg
  ...
  1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p><em>blog starter</em></p>\n<p>The
  <a href=\"https://blog-starter.markata.dev/\">blog-starter</a> has a really great
  write\nup on how to use markata. You can see it in your brower at the\n<a href=\"https://blog-starter.markata.dev/\">link</a>
  or run it yourself <code>pipx run markata new blog</code>.</p>\n<h2 id=\"examples-gallary\">Examples
  Gallary <a class=\"header-anchor\" href=\"#examples-gallary\"><svg aria-hidden=\"true\"
  ...
  19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997 0
  0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
  1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Markata has a project
  gallery to show off sites built with markata. Please\n<a href=\"https://github.com/WaylonWalker/markata/issues/78\">submit</a>
  yours, and check\nout the <a href=\"http://markata.dev/project-gallery/\">project-gallery</a>
  for inspiration.</p>\n<h2 id=\"deploying-to-a-sub-route\">Deploying to a sub route
  <a class=\"header-anchor\" href=\"#deploying-to-a-sub-route\"><svg aria-hidden=\"true\"
  class=\"heading-permalink\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
  viewbox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M9.199
  13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
  5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
  ...
  0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
  1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p><em>gh pages</em></p>\n<p>To
  deploy a subroute, add a markata.path_prifix to your config (markata.toml).</p>\n<pre
  class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
  xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  ...
  class=\"n\">path_prefix</span><span class=\"o\">=</span><span class=\"s1\">'my-sub-route'</span>\n</pre></div>\n\n</pre>\n<h2
  id=\"source-code\">Source Code <a class=\"header-anchor\" href=\"#source-code\"><svg
  aria-hidden=\"true\" class=\"heading-permalink\" fill=\"currentColor\" focusable=\"false\"
  height=\"1em\" viewbox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
  d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
  5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
  ...
  id=\"markata-docs\">Markata Docs <a class=\"header-anchor\" href=\"#markata-docs\"><svg
  aria-hidden=\"true\" class=\"heading-permalink\" fill=\"currentColor\" focusable=\"false\"
  height=\"1em\" viewbox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
  d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
  5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
  ...
  19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997 0
  0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
  1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Not much is documented
  yet, lots of work to do on the docs. Checkout\n<a href=\"https://markata.dev/markata/lifecycle/\">LifeCycle</a>
  ...
  href=\"https://markata.dev/plugins/\">Plugins</a></li>\n<li><a href=\"https://markata.dev/color-theme/\">color
