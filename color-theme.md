---
content: "\n## Default colors\n\nThe default markata page template support the following
  colors to be configured\nin the `markata.toml` file. There are two sets of similarly
  named colors, one\nfor light theme and one for dark.  The default page template
  ...
  your favicon\n\nYour favicon should be kept in your `assets` directory, which is
  `./static` by\ndefault.  You can name the icon what you want, `icon.png` is the
  default, but\nyou will have to change your icon config in your `markata.toml` to
  use a\ndifferent value.\n\n``` toml\n[markata]\nassets_dir = \"static\"\nicon =
  \"icon.png\"\n```"
date: 0001-01-01
...
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Theming Your Markata Site</title>\n<meta
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  content=\"Theming Your Markata Site | Markata\" name=\"og:title\" property=\"og:title\"/><meta
  content=\"Theming Your Markata Site | Markata\" name=\"twitter:title\" property=\"twitter:title\"/><meta
  content=\"https://markata.dev//color-theme-og.png\" name=\"og:image\" property=\"og:image\"/><meta
  content=\"https://markata.dev//color-theme-og.png\" name=\"twitter:image\" property=\"twitter:image\"/><meta
  ...
  property=\"twitter:creator\"/><meta content=\"Theming Your Markata Site\" name=\"title\"
  property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\" property=\"generator\"/><link
  href=\"https://markata.dev//color-theme/\" rel=\"canonical\"/><meta content=\"https://markata.dev//color-theme/\"
  ...
  id=\"default-colors\">Default colors <a class=\"header-anchor\" href=\"#default-colors\"><svg
  ...
  1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>The default markata page
  template support the following colors to be configured\nin the <code>markata.toml</code>
  file. There are two sets of similarly named colors, one\nfor light theme and one
  for dark.  The default page template will set these\ncolors based on the users <code>prefers-color-scheme</code>.</p>\n<pre
  ...
  class=\"n\">color_text</span><span class=\"w\"> </span><span class=\"o\">=</span><span
  class=\"w\"> </span><span class=\"s1\">'#eefbfe'</span>\n<span class=\"n\">color_link</span><span
  class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span class=\"s1\">'#47cbff'</span><span
  class=\"w\"> </span>\n<span class=\"n\">color_accent</span><span class=\"w\"> </span><span
  class=\"o\">=</span><span class=\"w\"> </span><span class=\"s1\">'#e1bd00c9'</span>\n<span
  class=\"n\">overlay_brightness</span><span class=\"w\"> </span><span class=\"o\">=</span><span
  class=\"w\"> </span><span class=\"s1\">'.85'</span>\n\n<span class=\"n\">color_bg_light</span><span
  ...
  class=\"w\"> </span><span class=\"s1\">'#47cbff'</span><span class=\"w\"> </span>\n<span
  class=\"n\">color_accent_light</span><span class=\"w\"> </span><span class=\"o\">=</span><span
  class=\"w\"> </span><span class=\"s1\">'#ffeb00'</span>\n<span class=\"n\">overlay_brightness_light</span><span
  class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span class=\"s1\">'.95'</span>\n</pre></div>\n\n</pre>\n<h2
  id=\"pink-and-purple\">Pink and Purple <a class=\"header-anchor\" href=\"#pink-and-purple\"><svg
  aria-hidden=\"true\" class=\"heading-permalink\" fill=\"currentColor\" focusable=\"false\"
  height=\"1em\" viewbox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
  d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
  5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
  ...
  class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span class=\"s1\">'rebeccapurple'</span>\n<span
  class=\"n\">color_text</span><span class=\"w\"> </span><span class=\"o\">=</span><span
  class=\"w\"> </span><span class=\"s1\">'white'</span>\n<span class=\"n\">color_link</span><span
  class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span class=\"s1\">'aqua'</span><span
  class=\"w\"> </span>\n<span class=\"n\">color_accent</span><span class=\"w\"> </span><span
  class=\"o\">=</span><span class=\"w\"> </span><span class=\"s1\">'peachpuff'</span>\n<span
  class=\"n\">overlay_brightness</span><span class=\"w\"> </span><span class=\"o\">=</span><span
  class=\"w\"> </span><span class=\"s1\">'1.2'</span>\n</pre></div>\n\n</pre>\n<h2
  id=\"changing-your-favicon\">Changing your favicon <a class=\"header-anchor\" href=\"#changing-your-favicon\"><svg
  aria-hidden=\"true\" class=\"heading-permalink\" fill=\"currentColor\" focusable=\"false\"
  height=\"1em\" viewbox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
  d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
  5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
  ...
  19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997 0
  0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
  1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Your favicon should be
  kept in your <code>assets</code> directory, which is <code>./static</code> by\ndefault.
  \ You can name the icon what you want, <code>icon.png</code> is the default, but\nyou
  will have to change your icon config in your <code>markata.toml</code> to use a\ndifferent
  value.</p>\n<pre class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button class=\"copy\"
  ...
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"></path></g></svg></button>\n</div>\n
  \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">[markata]</span>\n<span
  class=\"n\">assets_dir</span><span class=\"w\"> </span><span class=\"o\">=</span><span
  class=\"w\"> </span><span class=\"s2\">\"static\"</span>\n<span class=\"n\">icon</span><span
  class=\"w\"> </span><span class=\"o\">=</span><span class=\"w\"> </span><span class=\"s2\">\"icon.png\"</span>\n</pre></div>\n\n</pre>\n</main>\n<footer>\xA9
  2024</footer>\n</body></html>"
published: true
slug: color-theme
