---
content: "None\n\n\n!! function <h2 id='test_post' class='admonition-title' style='margin:0;padding:.5rem
  1rem;'>test_post <em class='small'>function</em></h2>\n\n???+ source \"test_post
  ...
  function <h2 id='test_markata_init' class='admonition-title' style='margin:0;padding:.5rem
  1rem;'>test_markata_init <em class='small'>function</em></h2>\n\n???+ source \"test_markata_init
  <em class='small'>source</em>\"\n\n```python\n\n        def test_markata_init()
  -> None:\n            config = ConfigFactory().build(\n                hooks=[\n
  \                   \"markata.plugins.create_models\",\n                    \"markata.plugins.post_model\",\n
  \                   \"markata.plugins.config_model\",\n                ],\n                disabled_hooks=[],\n
  \           )\n\n            markata = Markata(config=config)\n            markata.run()\n```\n"
date: 0001-01-01
description: 'None ! ???+ source  ! ???+ source '
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Test_Post_Model.Py</title>\n<meta
  charset=\"utf-8\"/>\n<meta content=\"width=device-width, initial-scale=1\" name=\"viewport\"/>\n<meta
  content=\"None ! ???+ source  ! ???+ source \" name=\"description\"/>\n<link href=\"/static/favicon.ico\"
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  ???+ source  ! ???+ source \" name=\"og:description\" property=\"og:description\"/><meta
  content=\"None ! ???+ source  ! ???+ source \" name=\"twitter:description\" property=\"twitter:description\"/><meta
  content=\"Test_Post_Model.Py | Markata\" name=\"og:title\" property=\"og:title\"/><meta
  content=\"Test_Post_Model.Py | Markata\" name=\"twitter:title\" property=\"twitter:title\"/><meta
  content=\"https://markata.dev//tests/plugins/test-post-model-og.png\" name=\"og:image\"
  property=\"og:image\"/><meta content=\"https://markata.dev//tests/plugins/test-post-model-og.png\"
  ...
  name=\"twitter:creator\" property=\"twitter:creator\"/><meta content=\"Test_Post_Model.Py\"
  name=\"title\" property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\"
  property=\"generator\"/><link href=\"https://markata.dev//tests/plugins/test-post-model/\"
  rel=\"canonical\"/><meta content=\"https://markata.dev//tests/plugins/test-post-model/\"
  ...
  round\"></div>\n</label>\n</div>\n<section class=\"title\">\n<h1 id=\"title\">\n
  \           Test_Post_Model.Py \n            \n        </h1>\n</section>\n<main><p>None</p>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"test_post\" style=\"margin:0;padding:.5rem
  1rem;\">test_post <em class=\"small\">function</em></h2>\n<div class=\"admonition
  source is-collapsible collapsible-open\">\n<p class=\"admonition-title\">\"test_post
  ...
  <span class=\"nf\">test_post</span><span class=\"p\">()</span> <span class=\"o\">-&gt;</span>
  <span class=\"kc\">None</span><span class=\"p\">:</span>\n            <span class=\"n\">config</span>
  <span class=\"o\">=</span> <span class=\"n\">ConfigFactory</span><span class=\"p\">()</span><span
  class=\"o\">.</span><span class=\"n\">build</span><span class=\"p\">(</span><span
  class=\"n\">hooks</span><span class=\"o\">=</span><span class=\"p\">[],</span> <span
  class=\"n\">disabled_hooks</span><span class=\"o\">=</span><span class=\"p\">[])</span>\n
  \           <span class=\"n\">post</span> <span class=\"o\">=</span> <span class=\"n\">PostFactory</span><span
  class=\"p\">()</span><span class=\"o\">.</span><span class=\"n\">build</span><span
  ...
  \               <span class=\"n\">path</span><span class=\"o\">=</span><span class=\"s2\">\"pages/my-post.md\"</span><span
  class=\"p\">,</span>\n                <span class=\"n\">slug</span><span class=\"o\">=</span><span
  class=\"kc\">None</span><span class=\"p\">,</span>\n                <span class=\"n\">title</span><span
  class=\"o\">=</span><span class=\"kc\">None</span><span class=\"p\">,</span>\n            <span
  class=\"p\">)</span>\n\n            <span class=\"k\">assert</span> <span class=\"n\">post</span><span
  class=\"o\">.</span><span class=\"n\">slug</span> <span class=\"o\">==</span> <span
  class=\"s2\">\"my-post\"</span>\n            <span class=\"k\">assert</span> <span
  class=\"n\">post</span><span class=\"o\">.</span><span class=\"n\">title</span>
  <span class=\"o\">==</span> <span class=\"s2\">\"My Post\"</span>\n</pre></div>\n\n</pre>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"test_markata_init\" style=\"margin:0;padding:.5rem
  1rem;\">test_markata_init <em class=\"small\">function</em></h2>\n<div class=\"admonition
  source is-collapsible collapsible-open\">\n<p class=\"admonition-title\">\"test_markata_init
  <em class=\"small\">source</em>\"</p>\n</div>\n<pre class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button
  class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
  ...
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"></path></g></svg></button>\n</div>\n
  \       \n<div class=\"highlight\"><pre><span></span>        <span class=\"k\">def</span>
  <span class=\"nf\">test_markata_init</span><span class=\"p\">()</span> <span class=\"o\">-&gt;</span>
  <span class=\"kc\">None</span><span class=\"p\">:</span>\n            <span class=\"n\">config</span>
  <span class=\"o\">=</span> <span class=\"n\">ConfigFactory</span><span class=\"p\">()</span><span
  class=\"o\">.</span><span class=\"n\">build</span><span class=\"p\">(</span>\n                <span
  class=\"n\">hooks</span><span class=\"o\">=</span><span class=\"p\">[</span>\n                    <span
  class=\"s2\">\"markata.plugins.create_models\"</span><span class=\"p\">,</span>\n
  \                   <span class=\"s2\">\"markata.plugins.post_model\"</span><span
  class=\"p\">,</span>\n                    <span class=\"s2\">\"markata.plugins.config_model\"</span><span
  class=\"p\">,</span>\n                <span class=\"p\">],</span>\n                <span
  class=\"n\">disabled_hooks</span><span class=\"o\">=</span><span class=\"p\">[],</span>\n
  \           <span class=\"p\">)</span>\n\n            <span class=\"n\">markata</span>
  <span class=\"o\">=</span> <span class=\"n\">Markata</span><span class=\"p\">(</span><span
...
!! function <h2 id='test_post' class='admonition-title' style='margin:0;padding:.5rem 1rem;'>test_post <em class='small'>function</em></h2>

???+ source "test_post <em class='small'>source</em>"
...
!! function <h2 id='test_markata_init' class='admonition-title' style='margin:0;padding:.5rem 1rem;'>test_markata_init <em class='small'>function</em></h2>

???+ source "test_markata_init <em class='small'>source</em>"
