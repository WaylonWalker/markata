...
content: "---\n\nTests the redirects plugin\n\n---\n\n\n\n!!! function\n    <h2 id=\"set_directory\"
  class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">set_directory
  <em class=\"small\">function</em></h2>\n\n    context manager to set the directory\n\n???+
  source \"set_directory <em class='small'>source</em>\"\n    ```python\n    def set_directory(path):\n
  \       \"\"\"\n        context manager to set the directory\n        \"\"\"\n        cwd
  = Path.cwd()\n        try:\n            os.chdir(path)\n            yield\n        finally:\n
  \           os.chdir(cwd)\n    ```\n\n\n\n!!! function\n    <h2 id=\"test_redirect_exists\"
  class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">test_redirect_exists
  <em class=\"small\">function</em></h2>\n\n    ensure that the default workflow works\n\n???+
  source \"test_redirect_exists <em class='small'>source</em>\"\n    ```python\n    def
  test_redirect_exists(tmp_files: Path, old: str, new: str) -> None:\n        \"ensure
  that the default workflow works\"\n        with set_directory(tmp_files):\n            m
  ...
  function\n    <h2 id=\"test_redirect_ignore_splat\" class=\"admonition-title\" style=\"margin:
  0; padding: .5rem 1rem;\">test_redirect_ignore_splat <em class=\"small\">function</em></h2>\n\n
  \   splats cannot be supported statically, test that they are ignored\n\n???+ source
  \"test_redirect_ignore_splat <em class='small'>source</em>\"\n    ```python\n    def
  test_redirect_ignore_splat(tmp_files: Path, old: str) -> None:\n        \"splats
  cannot be supported statically, test that they are ignored\"\n        with set_directory(tmp_files):\n
  \           m = Markata()\n            redirects.save(m)\n            redirect_file
  = Path(\"markout\") / old / \"index.html\"\n            assert not redirect_file.exists()\n
  \   ```\n\n\n\n!!! function\n    <h2 id=\"test_redirect_ignore_more_params\" class=\"admonition-title\"
  style=\"margin: 0; padding: .5rem 1rem;\">test_redirect_ignore_more_params <em class=\"small\">function</em></h2>\n\n
  ...
  not redirect_file.exists()\n    ```\n\n\n\n!!! function\n    <h2 id=\"test_redirect_configure_redirect_file\"
  class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">test_redirect_configure_redirect_file
  <em class=\"small\">function</em></h2>\n\n    ensure that the redirects file can
  be configured\n\n???+ source \"test_redirect_configure_redirect_file <em class='small'>source</em>\"\n
  \   ```python\n    def test_redirect_configure_redirect_file(\n        tmp_files:
  Path, redirect_file: str, old: str, new: str\n    ) -> None:\n        \"ensure that
  the redirects file can be configured\"\n        with set_directory(tmp_files):\n
  \           m = Markata()\n            m.config[\"redirects\"] = redirect_file\n
  \           redirects.save(m)\n            redirect_html = Path(\"markout\") / old
  / \"index.html\"\n            assert redirect_html.exists()\n            assert
  (\n                f'<meta http-equiv=\"Refresh\" content=\"0; url=\\'{new}\\'\"
  />'\n                in redirect_html.read_text()\n            )\n    ```\n\n\n\n!!!
  function\n    <h2 id=\"test_redirect_custom_template\" class=\"admonition-title\"
  style=\"margin: 0; padding: .5rem 1rem;\">test_redirect_custom_template <em class=\"small\">function</em></h2>\n\n
  \   ensure the template can be configured\n\n???+ source \"test_redirect_custom_template
  ...
  \           redirects.save(m)\n            redirect_file = Path(\"markout\") / old
  / \"index.html\"\n            assert redirect_file.exists()\n            assert
  f\"{old} is now {new}\" in redirect_file.read_text()\n    ```\n\n\n\n!!! function\n
  \   <h2 id=\"test_redirect_empty\" class=\"admonition-title\" style=\"margin: 0;
  padding: .5rem 1rem;\">test_redirect_empty <em class=\"small\">function</em></h2>\n\n
  \   ensure empty redirects files work\n\n???+ source \"test_redirect_empty <em class='small'>source</em>\"\n
  \   ```python\n    def test_redirect_empty(tmp_files: Path, old: str, new: str)
  -> None:\n        \"ensure empty redirects files work\"\n        with set_directory(tmp_files):\n
  \           m = Markata()\n            redirects.save(m)\n    ```\n\n\n\n!!! function\n
  \   <h2 id=\"test_redirect_file_missing\" class=\"admonition-title\" style=\"margin:
  0; padding: .5rem 1rem;\">test_redirect_file_missing <em class=\"small\">function</em></h2>\n\n
  \   ensure missing redirects file works\n\n???+ source \"test_redirect_file_missing
  <em class='small'>source</em>\"\n    ```python\n    def test_redirect_file_missing(tmpdir:
  Path) -> None:\n        \"ensure missing redirects file works\"\n        with set_directory(tmpdir):\n
  \           m = Markata()\n            redirects.save(m)\n    ```"
date: 2025-02-14
description: "Tests the redirects plugin !!! function\n    &lt;h2 id=&quot;set_directory&quot;
  class=&quot;admonition-title&quot; style=&quot;margin: 0; padding: .5rem 1rem;&q"
html:
  index: "<!DOCTYPE html>\n<html lang=\"en\">\n<title>test_redirects.py</title>\n<meta
    charset=\"UTF-8\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"
    />\n<meta name=\"description\" content=\"Tests the redirects plugin !!! function\n
    \   &lt;h2 id=&quot;set_directory&quot; class=&quot;admonition-title&quot; style=&quot;margin:
    0; padding: .5rem 1rem;&q\" />\n <link href=\"/favicon.ico\" rel=\"icon\" type=\"image/png\"
    ...
    id=\"set_directory\" class=\"admonition-title\" style=\"margin: 0; padding: .5rem
    1rem;\">set_directory <em class=\"small\">function</em></h2>\n<p>context manager
    to set the directory</p>\n</div>\n<div class=\"admonition source is-collapsible
    collapsible-open\">\n<p class=\"admonition-title\">set_directory <em class='small'>source</em></p>\n<pre
    ...
    class=\"w\"> </span><span class=\"nf\">set_directory</span><span class=\"p\">(</span><span
    class=\"n\">path</span><span class=\"p\">):</span>\n<span class=\"w\">    </span><span
    class=\"sd\">&quot;&quot;&quot;</span>\n<span class=\"sd\">    context manager
    to set the directory</span>\n<span class=\"sd\">    &quot;&quot;&quot;</span>\n
    \   <span class=\"n\">cwd</span> <span class=\"o\">=</span> <span class=\"n\">Path</span><span
    class=\"o\">.</span><span class=\"n\">cwd</span><span class=\"p\">()</span>\n
    \   <span class=\"k\">try</span><span class=\"p\">:</span>\n        <span class=\"n\">os</span><span
    class=\"o\">.</span><span class=\"n\">chdir</span><span class=\"p\">(</span><span
    class=\"n\">path</span><span class=\"p\">)</span>\n        <span class=\"k\">yield</span>\n
    \   <span class=\"k\">finally</span><span class=\"p\">:</span>\n        <span
    class=\"n\">os</span><span class=\"o\">.</span><span class=\"n\">chdir</span><span
    class=\"p\">(</span><span class=\"n\">cwd</span><span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n\n</div>\n<div
    class=\"admonition function\">\n<p class=\"admonition-title\">Function</p>\n<h2
    id=\"test_redirect_exists\" class=\"admonition-title\" style=\"margin: 0; padding:
    .5rem 1rem;\">test_redirect_exists <em class=\"small\">function</em></h2>\n<p>ensure
    that the default workflow works</p>\n</div>\n<div class=\"admonition source is-collapsible
    ...
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">def</span><span
    class=\"w\"> </span><span class=\"nf\">test_redirect_exists</span><span class=\"p\">(</span><span
    ...
    class=\"p\">)</span>\n        <span class=\"n\">redirect_file</span> <span class=\"o\">=</span>
    <span class=\"n\">Path</span><span class=\"p\">(</span><span class=\"s2\">&quot;markout&quot;</span><span
    class=\"p\">)</span> <span class=\"o\">/</span> <span class=\"n\">old</span> <span
    class=\"o\">/</span> <span class=\"s2\">&quot;index.html&quot;</span>\n        <span
    class=\"k\">assert</span> <span class=\"n\">redirect_file</span><span class=\"o\">.</span><span
    ...
    class=\"ow\">in</span> <span class=\"n\">redirect_file</span><span class=\"o\">.</span><span
    class=\"n\">read_text</span><span class=\"p\">()</span>\n        <span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n\n</div>\n<div
    class=\"admonition function\">\n<p class=\"admonition-title\">Function</p>\n<h2
    id=\"test_redirect_ignore_splat\" class=\"admonition-title\" style=\"margin: 0;
    padding: .5rem 1rem;\">test_redirect_ignore_splat <em class=\"small\">function</em></h2>\n<p>splats
    ...
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">def</span><span
    class=\"w\"> </span><span class=\"nf\">test_redirect_ignore_splat</span><span
    class=\"p\">(</span><span class=\"n\">tmp_files</span><span class=\"p\">:</span>
    <span class=\"n\">Path</span><span class=\"p\">,</span> <span class=\"n\">old</span><span
    class=\"p\">:</span> <span class=\"nb\">str</span><span class=\"p\">)</span> <span
    class=\"o\">-&gt;</span> <span class=\"kc\">None</span><span class=\"p\">:</span>\n
    \   <span class=\"s2\">&quot;splats cannot be supported statically, test that
    ...
    class=\"p\">)</span> <span class=\"o\">/</span> <span class=\"n\">old</span> <span
    class=\"o\">/</span> <span class=\"s2\">&quot;index.html&quot;</span>\n        <span
    class=\"k\">assert</span> <span class=\"ow\">not</span> <span class=\"n\">redirect_file</span><span
    class=\"o\">.</span><span class=\"n\">exists</span><span class=\"p\">()</span>\n</pre></div>\n\n</pre>\n\n</div>\n<div
    class=\"admonition function\">\n<p class=\"admonition-title\">Function</p>\n<h2
    id=\"test_redirect_ignore_more_params\" class=\"admonition-title\" style=\"margin:
    0; padding: .5rem 1rem;\">test_redirect_ignore_more_params <em class=\"small\">function</em></h2>\n<p>status
    codes cannot be supported statically as they are issued by the server</p>\n</div>\n<div
    ...
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">def</span><span
    class=\"w\"> </span><span class=\"nf\">test_redirect_ignore_more_params</span><span
    class=\"p\">(</span><span class=\"n\">tmp_files</span><span class=\"p\">:</span>
    <span class=\"n\">Path</span><span class=\"p\">,</span> <span class=\"n\">old</span><span
    class=\"p\">:</span> <span class=\"nb\">str</span><span class=\"p\">)</span> <span
    class=\"o\">-&gt;</span> <span class=\"kc\">None</span><span class=\"p\">:</span>\n
    \   <span class=\"s2\">&quot;status codes cannot be supported statically as they
    are issued by the server&quot;</span>\n    <span class=\"k\">with</span> <span
    class=\"n\">set_directory</span><span class=\"p\">(</span><span class=\"n\">tmp_files</span><span
    ...
    \       <span class=\"k\">assert</span> <span class=\"ow\">not</span> <span class=\"n\">redirect_file</span><span
    class=\"o\">.</span><span class=\"n\">exists</span><span class=\"p\">()</span>\n</pre></div>\n\n</pre>\n\n</div>\n<div
    class=\"admonition function\">\n<p class=\"admonition-title\">Function</p>\n<h2
    id=\"test_redirect_configure_redirect_file\" class=\"admonition-title\" style=\"margin:
    0; padding: .5rem 1rem;\">test_redirect_configure_redirect_file <em class=\"small\">function</em></h2>\n<p>ensure
    that the redirects file can be configured</p>\n</div>\n<div class=\"admonition
    ...
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">def</span><span
    class=\"w\"> </span><span class=\"nf\">test_redirect_configure_redirect_file</span><span
    class=\"p\">(</span>\n    <span class=\"n\">tmp_files</span><span class=\"p\">:</span>
    <span class=\"n\">Path</span><span class=\"p\">,</span> <span class=\"n\">redirect_file</span><span
    class=\"p\">:</span> <span class=\"nb\">str</span><span class=\"p\">,</span> <span
    ...
    class=\"s2\">&quot;redirects&quot;</span><span class=\"p\">]</span> <span class=\"o\">=</span>
    <span class=\"n\">redirect_file</span>\n        <span class=\"n\">redirects</span><span
    class=\"o\">.</span><span class=\"n\">save</span><span class=\"p\">(</span><span
    class=\"n\">m</span><span class=\"p\">)</span>\n        <span class=\"n\">redirect_html</span>
    <span class=\"o\">=</span> <span class=\"n\">Path</span><span class=\"p\">(</span><span
    class=\"s2\">&quot;markout&quot;</span><span class=\"p\">)</span> <span class=\"o\">/</span>
    <span class=\"n\">old</span> <span class=\"o\">/</span> <span class=\"s2\">&quot;index.html&quot;</span>\n
    \       <span class=\"k\">assert</span> <span class=\"n\">redirect_html</span><span
    class=\"o\">.</span><span class=\"n\">exists</span><span class=\"p\">()</span>\n
    ...
    <span class=\"n\">redirect_html</span><span class=\"o\">.</span><span class=\"n\">read_text</span><span
    class=\"p\">()</span>\n        <span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n\n</div>\n<div
    class=\"admonition function\">\n<p class=\"admonition-title\">Function</p>\n<h2
    id=\"test_redirect_custom_template\" class=\"admonition-title\" style=\"margin:
    0; padding: .5rem 1rem;\">test_redirect_custom_template <em class=\"small\">function</em></h2>\n<p>ensure
    the template can be configured</p>\n</div>\n<div class=\"admonition source is-collapsible
    ...
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">def</span><span
    class=\"w\"> </span><span class=\"nf\">test_redirect_custom_template</span><span
    class=\"p\">(</span>\n    <span class=\"n\">tmp_files</span><span class=\"p\">:</span>
    <span class=\"n\">Path</span><span class=\"p\">,</span> <span class=\"n\">redirect_template</span><span
    class=\"p\">:</span> <span class=\"nb\">str</span><span class=\"p\">,</span> <span
    class=\"n\">old</span><span class=\"p\">:</span> <span class=\"nb\">str</span><span
    class=\"p\">,</span> <span class=\"n\">new</span><span class=\"p\">:</span> <span
    class=\"nb\">str</span>\n<span class=\"p\">)</span> <span class=\"o\">-&gt;</span>
    ...
    <span class=\"n\">Markata</span><span class=\"p\">()</span>\n        <span class=\"n\">m</span><span
    class=\"o\">.</span><span class=\"n\">config</span><span class=\"p\">[</span><span
    class=\"s2\">&quot;redirect_template&quot;</span><span class=\"p\">]</span> <span
    class=\"o\">=</span> <span class=\"n\">redirect_template</span>\n        <span
    class=\"n\">redirects</span><span class=\"o\">.</span><span class=\"n\">save</span><span
    class=\"p\">(</span><span class=\"n\">m</span><span class=\"p\">)</span>\n        <span
    class=\"n\">redirect_file</span> <span class=\"o\">=</span> <span class=\"n\">Path</span><span
    ...
    class=\"n\">read_text</span><span class=\"p\">()</span>\n</pre></div>\n\n</pre>\n\n</div>\n<div
    class=\"admonition function\">\n<p class=\"admonition-title\">Function</p>\n<h2
    id=\"test_redirect_empty\" class=\"admonition-title\" style=\"margin: 0; padding:
    .5rem 1rem;\">test_redirect_empty <em class=\"small\">function</em></h2>\n<p>ensure
    empty redirects files work</p>\n</div>\n<div class=\"admonition source is-collapsible
    collapsible-open\">\n<p class=\"admonition-title\">test_redirect_empty <em class='small'>source</em></p>\n<pre
    class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button class='copy' title='copy
    code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
    version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
    x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
    ...
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">def</span><span
    class=\"w\"> </span><span class=\"nf\">test_redirect_empty</span><span class=\"p\">(</span><span
    class=\"n\">tmp_files</span><span class=\"p\">:</span> <span class=\"n\">Path</span><span
    class=\"p\">,</span> <span class=\"n\">old</span><span class=\"p\">:</span> <span
    class=\"nb\">str</span><span class=\"p\">,</span> <span class=\"n\">new</span><span
    class=\"p\">:</span> <span class=\"nb\">str</span><span class=\"p\">)</span> <span
    class=\"o\">-&gt;</span> <span class=\"kc\">None</span><span class=\"p\">:</span>\n
    \   <span class=\"s2\">&quot;ensure empty redirects files work&quot;</span>\n
    \   <span class=\"k\">with</span> <span class=\"n\">set_directory</span><span
    class=\"p\">(</span><span class=\"n\">tmp_files</span><span class=\"p\">):</span>\n
    \       <span class=\"n\">m</span> <span class=\"o\">=</span> <span class=\"n\">Markata</span><span
    class=\"p\">()</span>\n        <span class=\"n\">redirects</span><span class=\"o\">.</span><span
    class=\"n\">save</span><span class=\"p\">(</span><span class=\"n\">m</span><span
    class=\"p\">)</span>\n</pre></div>\n\n</pre>\n\n</div>\n<div class=\"admonition
    function\">\n<p class=\"admonition-title\">Function</p>\n<h2 id=\"test_redirect_file_missing\"
    class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">test_redirect_file_missing
    <em class=\"small\">function</em></h2>\n<p>ensure missing redirects file works</p>\n</div>\n<div
    ...
    v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
    \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">def</span><span
    class=\"w\"> </span><span class=\"nf\">test_redirect_file_missing</span><span
    class=\"p\">(</span><span class=\"n\">tmpdir</span><span class=\"p\">:</span>
    <span class=\"n\">Path</span><span class=\"p\">)</span> <span class=\"o\">-&gt;</span>
    <span class=\"kc\">None</span><span class=\"p\">:</span>\n    <span class=\"s2\">&quot;ensure
    missing redirects file works&quot;</span>\n    <span class=\"k\">with</span> <span
    class=\"n\">set_directory</span><span class=\"p\">(</span><span class=\"n\">tmpdir</span><span
    class=\"p\">):</span>\n        <span class=\"n\">m</span> <span class=\"o\">=</span>
    <span class=\"n\">Markata</span><span class=\"p\">()</span>\n        <span class=\"n\">redirects</span><span
    class=\"o\">.</span><span class=\"n\">save</span><span class=\"p\">(</span><span
    class=\"n\">m</span><span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n\n</div>\n\n
  ...
  partial: "<article class='w-full'>\n<section class=\"title\">\n    <h1 id=\"title\">\n
    ...
    function\">\n<p class=\"admonition-title\">Function</p>\n<h2 id=\"set_directory\"
    class=\"admonition-title\" style=\"margin: 0; padding: .5rem 1rem;\">set_directory
    <em class=\"small\">function</em></h2>\n<p>context manager to set the directory</p>\n</div>\n<div
