...
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Test_Redirects.Py</title>\n<meta
  ...
  content=\"Tests the redirects plugin ! ! ! ! ! ! ! !\" name=\"description\"/>\n<link
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  name=\"og:type\" property=\"og:type\"/><meta content=\"Tests the redirects plugin
  ! ! ! ! ! ! ! !\" name=\"description\" property=\"description\"/><meta content=\"Tests
  the redirects plugin ! ! ! ! ! ! ! !\" name=\"og:description\" property=\"og:description\"/><meta
  content=\"Tests the redirects plugin ! ! ! ! ! ! ! !\" name=\"twitter:description\"
  property=\"twitter:description\"/><meta content=\"Test_Redirects.Py | Markata\"
  name=\"og:title\" property=\"og:title\"/><meta content=\"Test_Redirects.Py | Markata\"
  name=\"twitter:title\" property=\"twitter:title\"/><meta content=\"https://markata.dev//tests/plugins/test-redirects-og.png\"
  name=\"og:image\" property=\"og:image\"/><meta content=\"https://markata.dev//tests/plugins/test-redirects-og.png\"
  ...
  name=\"twitter:creator\" property=\"twitter:creator\"/><meta content=\"Test_Redirects.Py\"
  name=\"title\" property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\"
  property=\"generator\"/><link href=\"https://markata.dev//tests/plugins/test-redirects/\"
  rel=\"canonical\"/><meta content=\"https://markata.dev//tests/plugins/test-redirects/\"
  ...
  round\"></div>\n</label>\n</div>\n<section class=\"title\">\n<h1 id=\"title\">\n
  \           Test_Redirects.Py \n            \n        </h1>\n</section>\n<main><p>Tests
  the redirects plugin</p>\n<p>!! function </p><h2 class=\"admonition-title\" id=\"set_directory\"
  style=\"margin:0;padding:.5rem 1rem;\">set_directory <em class=\"small\">function</em></h2>\ncontext
  manager to set the directory\n<div class=\"admonition source is-collapsible collapsible-open\">\n<p
  ...
  \           \"\"\"</span>\n            <span class=\"n\">cwd</span> <span class=\"o\">=</span>
  <span class=\"n\">Path</span><span class=\"o\">.</span><span class=\"n\">cwd</span><span
  ...
  function </p><h2 class=\"admonition-title\" id=\"test_redirect_exists\" style=\"margin:0;padding:.5rem
  1rem;\">test_redirect_exists <em class=\"small\">function</em></h2>\nensure that
  the default workflow works\n<div class=\"admonition source is-collapsible collapsible-open\">\n<p
  class=\"admonition-title\">\"test_redirect_exists <em class=\"small\">source</em>\"</p>\n</div>\n<pre
  class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
  xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  ...
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"></path></g></svg></button>\n</div>\n
  \       \n<div class=\"highlight\"><pre><span></span>        <span class=\"k\">def</span>
  <span class=\"nf\">test_redirect_exists</span><span class=\"p\">(</span><span class=\"n\">tmp_files</span><span
  ...
  that the default workflow works\"</span>\n            <span class=\"k\">with</span>
  ...
  \                   <span class=\"sa\">f</span><span class=\"s1\">'&lt;meta http-equiv=\"Refresh\"
  ...
  class=\"p\">()</span>\n                <span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"test_redirect_ignore_splat\" style=\"margin:0;padding:.5rem
  1rem;\">test_redirect_ignore_splat <em class=\"small\">function</em></h2>\nsplats
  ...
  class=\"n\">redirect_file</span><span class=\"o\">.</span><span class=\"n\">exists</span><span
  class=\"p\">()</span>\n</pre></div>\n\n</pre>\n<p>!! function </p><h2 class=\"admonition-title\"
  id=\"test_redirect_ignore_more_params\" style=\"margin:0;padding:.5rem 1rem;\">test_redirect_ignore_more_params
  <em class=\"small\">function</em></h2>\nstatus codes cannot be supported statically
  as they are issued by the server\n<div class=\"admonition source is-collapsible
  ...
  class=\"n\">redirect_file</span><span class=\"o\">.</span><span class=\"n\">exists</span><span
  class=\"p\">()</span>\n</pre></div>\n\n</pre>\n<p>!! function </p><h2 class=\"admonition-title\"
  id=\"test_redirect_configure_redirect_file\" style=\"margin:0;padding:.5rem 1rem;\">test_redirect_configure_redirect_file
  <em class=\"small\">function</em></h2>\nensure that the redirects file can be configured\n<div
  ...
  \           <span class=\"n\">tmp_files</span><span class=\"p\">:</span> <span class=\"n\">Path</span><span
  class=\"p\">,</span> <span class=\"n\">redirect_file</span><span class=\"p\">:</span>
  <span class=\"nb\">str</span><span class=\"p\">,</span> <span class=\"n\">old</span><span
  class=\"p\">:</span> <span class=\"nb\">str</span><span class=\"p\">,</span> <span
  class=\"n\">new</span><span class=\"p\">:</span> <span class=\"nb\">str</span>\n
  \       <span class=\"p\">)</span> <span class=\"o\">-&gt;</span> <span class=\"kc\">None</span><span
  class=\"p\">:</span>\n            <span class=\"s2\">\"ensure that the redirects
  file can be configured\"</span>\n            <span class=\"k\">with</span> <span
  ...
  class=\"p\">()</span>\n                <span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"test_redirect_custom_template\"
  style=\"margin:0;padding:.5rem 1rem;\">test_redirect_custom_template <em class=\"small\">function</em></h2>\nensure
  the template can be configured\n<div class=\"admonition source is-collapsible collapsible-open\">\n<p
  class=\"admonition-title\">\"test_redirect_custom_template <em class=\"small\">source</em>\"</p>\n</div>\n<pre
  class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
  xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  ...
  \           <span class=\"n\">tmp_files</span><span class=\"p\">:</span> <span class=\"n\">Path</span><span
  class=\"p\">,</span> <span class=\"n\">redirect_template</span><span class=\"p\">:</span>
  <span class=\"nb\">str</span><span class=\"p\">,</span> <span class=\"n\">old</span><span
  class=\"p\">:</span> <span class=\"nb\">str</span><span class=\"p\">,</span> <span
  class=\"n\">new</span><span class=\"p\">:</span> <span class=\"nb\">str</span>\n
  \       <span class=\"p\">)</span> <span class=\"o\">-&gt;</span> <span class=\"kc\">None</span><span
  class=\"p\">:</span>\n            <span class=\"s2\">\"ensure the template can be
  configured\"</span>\n            <span class=\"k\">with</span> <span class=\"n\">set_directory</span><span
  class=\"p\">(</span><span class=\"n\">tmp_files</span><span class=\"p\">):</span>\n
  \               <span class=\"n\">m</span> <span class=\"o\">=</span> <span class=\"n\">Markata</span><span
  class=\"p\">()</span>\n                <span class=\"n\">m</span><span class=\"o\">.</span><span
  class=\"n\">config</span><span class=\"p\">[</span><span class=\"s2\">\"redirect_template\"</span><span
  ...
  class=\"n\">new</span><span class=\"si\">}</span><span class=\"s2\">\"</span> <span
  class=\"ow\">in</span> <span class=\"n\">redirect_file</span><span class=\"o\">.</span><span
  class=\"n\">read_text</span><span class=\"p\">()</span>\n</pre></div>\n\n</pre>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"test_redirect_empty\" style=\"margin:0;padding:.5rem
  1rem;\">test_redirect_empty <em class=\"small\">function</em></h2>\nensure empty
  redirects files work\n<div class=\"admonition source is-collapsible collapsible-open\">\n<p
  ...
  class=\"n\">redirects</span><span class=\"o\">.</span><span class=\"n\">save</span><span
  class=\"p\">(</span><span class=\"n\">m</span><span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"test_redirect_file_missing\" style=\"margin:0;padding:.5rem
  1rem;\">test_redirect_file_missing <em class=\"small\">function</em></h2>\nensure
  missing redirects file works\n<div class=\"admonition source is-collapsible collapsible-open\">\n<p
  class=\"admonition-title\">\"test_redirect_file_missing <em class=\"small\">source</em>\"</p>\n</div>\n<pre
  class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
  xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
