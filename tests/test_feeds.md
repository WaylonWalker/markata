...
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Test_Feeds.Py</title>\n<meta
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  property=\"twitter:description\"/><meta content=\"Test_Feeds.Py | Markata\" name=\"og:title\"
  property=\"og:title\"/><meta content=\"Test_Feeds.Py | Markata\" name=\"twitter:title\"
  property=\"twitter:title\"/><meta content=\"https://markata.dev//tests/test-feeds-og.png\"
  name=\"og:image\" property=\"og:image\"/><meta content=\"https://markata.dev//tests/test-feeds-og.png\"
  ...
  name=\"twitter:creator\" property=\"twitter:creator\"/><meta content=\"Test_Feeds.Py\"
  name=\"title\" property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\"
  property=\"generator\"/><link href=\"https://markata.dev//tests/test-feeds/\" rel=\"canonical\"/><meta
  content=\"https://markata.dev//tests/test-feeds/\" name=\"og:url\" property=\"og:url\"/></head>\n<body><nav>\n<a
  ...
  round\"></div>\n</label>\n</div>\n<section class=\"title\">\n<h1 id=\"title\">\n
  \           Test_Feeds.Py \n            \n        </h1>\n</section>\n<main><p>None</p>\n<p>!!
  class </p><h2 class=\"admonition-title\" id=\"DummyMarkata\" style=\"margin:0;padding:.5rem
  ...
  <span class=\"p\">{</span><span class=\"s2\">\"all-posts\"</span><span class=\"p\">:</span>
  <span class=\"p\">{</span><span class=\"s2\">\"filter\"</span><span class=\"p\">:</span>
  <span class=\"kc\">True</span><span class=\"p\">}}}</span>\n\n            <span
  class=\"k\">def</span> <span class=\"nf\">map</span><span class=\"p\">(</span><span
  ...
  id=\"test_feed_map\" style=\"margin:0;padding:.5rem 1rem;\">test_feed_map <em class=\"small\">function</em></h2>\n<div
  class=\"admonition source is-collapsible collapsible-open\">\n<p class=\"admonition-title\">\"test_feed_map
  <em class=\"small\">source</em>\"</p>\n</div>\n<pre class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button
  class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
  ...
  class=\"s2\">\"Markata\"</span><span class=\"p\">,</span> <span class=\"n\">DummyMarkata</span><span
  class=\"p\">())</span>\n            <span class=\"n\">feed</span> <span class=\"o\">=</span>
  <span class=\"n\">Feed</span><span class=\"p\">(</span><span class=\"n\">name</span><span
  class=\"o\">=</span><span class=\"s2\">\"archive\"</span><span class=\"p\">,</span>
  <span class=\"n\">config</span><span class=\"o\">=</span><span class=\"p\">{},</span>
  <span class=\"n\">posts</span><span class=\"o\">=</span><span class=\"p\">[],</span>
  <span class=\"n\">_m</span><span class=\"o\">=</span><span class=\"n\">mocked_markata</span><span
  class=\"p\">)</span>\n            <span class=\"n\">feed</span><span class=\"o\">.</span><span
  class=\"n\">map</span><span class=\"p\">()</span>\n</pre></div>\n\n</pre>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"test_feeds\" style=\"margin:0;padding:.5rem
  1rem;\">test_feeds <em class=\"small\">function</em></h2>\n<div class=\"admonition
  ...
  class=\"p\">(</span><span class=\"n\">markata</span><span class=\"p\">,</span> <span
  class=\"s2\">\"Markata\"</span><span class=\"p\">,</span> <span class=\"n\">DummyMarkata</span><span
  class=\"p\">())</span>\n            <span class=\"n\">Feeds</span><span class=\"p\">(</span><span
  class=\"n\">markata</span><span class=\"o\">=</span><span class=\"n\">mocked_markata</span><span
  class=\"p\">)</span>\n</pre></div>\n\n</pre>\n<p>!! function </p><h2 class=\"admonition-title\"
  id=\"test_feeds_iter\" style=\"margin:0;padding:.5rem 1rem;\">test_feeds_iter <em
  class=\"small\">function</em></h2>\n<div class=\"admonition source is-collapsible
  collapsible-open\">\n<p class=\"admonition-title\">\"test_feeds_iter <em class=\"small\">source</em>\"</p>\n</div>\n<pre
  ...
  \           <span class=\"k\">assert</span> <span class=\"p\">[</span><span class=\"n\">feed</span>
  ...
  <span class=\"p\">[</span><span class=\"s2\">\"all-posts\"</span><span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"test_feeds_keys\" style=\"margin:0;padding:.5rem
  1rem;\">test_feeds_keys <em class=\"small\">function</em></h2>\n<div class=\"admonition
  source is-collapsible collapsible-open\">\n<p class=\"admonition-title\">\"test_feeds_keys
  <em class=\"small\">source</em>\"</p>\n</div>\n<pre class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button
  class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
  ...
  function </p><h2 class=\"admonition-title\" id=\"test_feeds_items\" style=\"margin:0;padding:.5rem
  1rem;\">test_feeds_items <em class=\"small\">function</em></h2>\n<div class=\"admonition
  ...
  <span class=\"n\">Feeds</span><span class=\"p\">(</span><span class=\"n\">markata</span><span
  class=\"o\">=</span><span class=\"n\">mocked_markata</span><span class=\"p\">)</span>\n
  \           <span class=\"n\">iterate_feeds</span> <span class=\"o\">=</span> <span
  class=\"p\">{</span><span class=\"n\">name</span><span class=\"p\">:</span> <span
  class=\"n\">feed</span> <span class=\"k\">for</span> <span class=\"n\">name</span><span
  class=\"p\">,</span> <span class=\"n\">feed</span> <span class=\"ow\">in</span>
  <span class=\"n\">feeds</span><span class=\"o\">.</span><span class=\"n\">items</span><span
  ...
  <span class=\"p\">[</span><span class=\"s2\">\"all-posts\"</span><span class=\"p\">]</span>\n</pre></div>\n\n</pre>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"test_feeds___get_item__\" style=\"margin:0;padding:.5rem
  1rem;\">test_feeds___get_item__ <em class=\"small\">function</em></h2>\n<div class=\"admonition
  source is-collapsible collapsible-open\">\n<p class=\"admonition-title\">\"test_feeds___get_item__
  <em class=\"small\">source</em>\"</p>\n</div>\n<pre class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button
  class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
  ...
  <span class=\"n\">Feeds</span><span class=\"p\">(</span><span class=\"n\">markata</span><span
  class=\"o\">=</span><span class=\"n\">mocked_markata</span><span class=\"p\">)</span>\n\n
  \           <span class=\"n\">feeds</span><span class=\"p\">[</span><span class=\"s2\">\"all-posts\"</span><span
  class=\"p\">]</span><span class=\"o\">.</span><span class=\"n\">name</span> <span
  class=\"o\">==</span> <span class=\"s2\">\"all_posts\"</span>\n</pre></div>\n\n</pre>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"test_feeds___rich__\" style=\"margin:0;padding:.5rem
  1rem;\">test_feeds___rich__ <em class=\"small\">function</em></h2>\n<div class=\"admonition
  ...
  class=\"p\">(</span><span class=\"n\">feeds</span><span class=\"o\">.</span><span
  class=\"n\">__rich__</span><span class=\"p\">(),</span> <span class=\"n\">rich</span><span
  class=\"o\">.</span><span class=\"n\">table</span><span class=\"o\">.</span><span
  class=\"n\">Table</span><span class=\"p\">)</span>\n</pre></div>\n\n</pre>\n<p>!!
  function </p><h2 class=\"admonition-title\" id=\"test_feeds_values\" style=\"margin:0;padding:.5rem
  1rem;\">test_feeds_values <em class=\"small\">function</em></h2>\n<div class=\"admonition
  source is-collapsible collapsible-open\">\n<p class=\"admonition-title\">\"test_feeds_values
  <em class=\"small\">source</em>\"</p>\n</div>\n<pre class=\"wrapper\">\n\n<div class=\"copy-wrapper\">\n\n<button
  class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
  ...
  <span class=\"n\">Feeds</span><span class=\"p\">(</span><span class=\"n\">markata</span><span
  class=\"o\">=</span><span class=\"n\">mocked_markata</span><span class=\"p\">)</span><span
  class=\"o\">.</span><span class=\"n\">values</span><span class=\"p\">()</span>\n
  \           <span class=\"k\">assert</span> <span class=\"nb\">all</span><span class=\"p\">([</span><span
  class=\"nb\">isinstance</span><span class=\"p\">(</span><span class=\"n\">v</span><span
