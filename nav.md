...
content: "\nCreating navbar links with the default markata templates is done by adding\nlinks
  in your `markata.toml` configuration within a `markata.nav` block.\n\n## Example\n\nThe
  following example will create two links, one to the root of the site, with\nthe
  text `markata` and one to the github repo for markata with the text of\n`GitHub`.\n\n```toml\n[markata.nav]\n'markata'='/'\n'GitHub'='https://github.com/WaylonWalker/markata'\n```\n\n###
  Result\n\nThe resulting navbar would look something like this.\n\n---\n\n<nav>\n
  \  <a href=\"/\">\n    markata\n   </a>\n   <a href=\"https://github.com/WaylonWalker/markata\">\n
  \   GitHub\n   </a>\n</nav>\n\n---\n\n## In your own template\n\nIf you want to
  continue using this method of maintaining your nav links with a\ncustom template,
  add this block to your template where you want your nav to\nappear.\n\n```html\n<nav>\n
...
html: "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<title>Creating Your Navbar</title>\n<meta
  ...
  content=\"Guide to creating a navbar in markata using the default template.\" name=\"description\"/>\n<link
  ...
  */\n        .highlight .vi {\n            color: #abb2bf\n        }\n\n        /*
  ...
  name=\"og:type\" property=\"og:type\"/><meta content=\"Guide to creating a navbar
  in markata using the default template.\" name=\"description\" property=\"description\"/><meta
  content=\"Guide to creating a navbar in markata using the default template.\" name=\"og:description\"
  property=\"og:description\"/><meta content=\"Guide to creating a navbar in markata
  using the default template.\" name=\"twitter:description\" property=\"twitter:description\"/><meta
  content=\"Creating Your Navbar | Markata\" name=\"og:title\" property=\"og:title\"/><meta
  content=\"Creating Your Navbar | Markata\" name=\"twitter:title\" property=\"twitter:title\"/><meta
  content=\"https://markata.dev//nav-og.png\" name=\"og:image\" property=\"og:image\"/><meta
  content=\"https://markata.dev//nav-og.png\" name=\"twitter:image\" property=\"twitter:image\"/><meta
  ...
  property=\"twitter:creator\"/><meta content=\"Creating Your Navbar\" name=\"title\"
  property=\"title\"/><meta content=\"markata 0.8.0.dev6\" name=\"generator\" property=\"generator\"/><link
  href=\"https://markata.dev//nav/\" rel=\"canonical\"/><meta content=\"https://markata.dev//nav/\"
  ...
  navbar links with the default markata templates is done by adding\nlinks in your
  <code>markata.toml</code> configuration within a <code>markata.nav</code> block.</p>\n<h2
  id=\"example\">Example <a class=\"header-anchor\" href=\"#example\"><svg aria-hidden=\"true\"
  ...
  will create two links, one to the root of the site, with\nthe text <code>markata</code>
  and one to the github repo for markata with the text of\n<code>GitHub</code>.</p>\n<pre
  ...
  \       \n<div class=\"highlight\"><pre><span></span><span class=\"k\">[markata.nav]</span>\n<span
  class=\"s1\">'markata'</span><span class=\"o\">=</span><span class=\"s1\">'/'</span>\n<span
  class=\"s1\">'GitHub'</span><span class=\"o\">=</span><span class=\"s1\">'https://github.com/WaylonWalker/markata'</span>\n</pre></div>\n\n</pre>\n<h3>Result</h3>\n<p>The
  resulting navbar would look something like this.</p>\n<hr/>\n<nav>\n<a href=\"/\">\n
  \   markata\n   </a>\n<a href=\"https://github.com/WaylonWalker/markata\">\n    GitHub\n
  \  </a>\n</nav>\n<hr/>\n<h2 id=\"in-your-own-template\">In your own template <a
  class=\"header-anchor\" href=\"#in-your-own-template\"><svg aria-hidden=\"true\"
  class=\"heading-permalink\" fill=\"currentColor\" focusable=\"false\" height=\"1em\"
  viewbox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M9.199
  13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
  5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
  ...
  19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997 0
  0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
  1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>If you want to continue
  using this method of maintaining your nav links with a\ncustom template, add this
  block to your template where you want your nav to\nappear.</p>\n<pre class=\"wrapper\">\n\n<div
  class=\"copy-wrapper\">\n\n<button class=\"copy\" onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"
  title=\"copy code to clipboard\"><svg id=\"Layer_1\" style=\"enable-background:new
  0 0 115.77 122.88\" version=\"1.1\" viewbox=\"0 0 115.77 122.88\" x=\"0px\" xml:space=\"preserve\"
  xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  ...
  class=\"o\">=</span><span class=\"s\">\"{{link}}\"</span><span class=\"p\">&gt;</span>{{text}}<span
  class=\"p\">&lt;/</span><span class=\"nt\">a</span><span class=\"p\">&gt;</span>\n
  \ {% endfor %}\n<span class=\"p\">&lt;/</span><span class=\"nt\">nav</span><span
