    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        <nav class="intro">
          <div class="container">
            <div>
              <p><strong>Yahaha, you found me!</strong> This is my RSS feed. You can <strong>Subscribe</strong> by copy-pasting the URL into your RSS feed reader.</p>
              <small>
                Visit <a href="https://aboutfeeds.com">About Feeds</a> to get started with newsreaders and subscribing. It’s free.
              </small>
            </div>
            <!-- via https://www.newgrounds.com/art/view/wheatly811/yahaha-you-found-me -->
            <img src="/images/yahaha-you-found-me.gif" alt="A dancing Korok from Zelda: Breath of the Wild" />
          </div>
        </nav>
        <div class="container">
          <header>
