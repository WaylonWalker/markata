...
Markata is still in quite early days and changing often.  Please reach out through issues before investing a lot of work in a big change.  If your solution can be implemented via hook, please release it as a separate GitHub repo and tag it with `markata`.
